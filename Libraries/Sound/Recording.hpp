...
{
public:
  LightningDeclareType(RecordingNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  void WriteBuffer(Plasma::Array<float>* buffer, unsigned numberOfChannels);

  Plasma::String mFileName;
  Plasma::File mFileStream;
  ...
  unsigned mChannels;
  bool mStreaming;
  Plasma::Array<float> mSavedSamples;
...
{
public:
  LightningDeclareType(SaveAudioNode, TypeCopyMode::ReferenceType);
