...
{
public:
  LightningDeclareType(GeneratedWaveNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AdsrEnvelope, TypeCopyMode::ValueType);
...
private:
  typedef Plasma::Array<NoteHarmonic> HarmonicsListType;
...
{
public:
  LightningDeclareType(AdditiveSynthNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MicrophoneInputNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GranularSynthNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  // List of grains
  Plasma::Array<Grain> GrainListThreaded;
