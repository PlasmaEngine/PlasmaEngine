...
{
public:
  LightningDeclareType(SoundNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SimpleCollapseNode, TypeCopyMode::ReferenceType);

  SimpleCollapseNode(Plasma::StringParam name, unsigned ID, bool listenerDependent, bool generator) :
...
{
public:
  LightningDeclareType(OutputNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CombineNode, TypeCopyMode::ReferenceType);

  CombineNode(Plasma::StringParam name, unsigned ID);
  virtual ~CombineNode()
  {
  }
...
{
public:
  LightningDeclareType(CombineAndPauseNode, TypeCopyMode::ReferenceType);

  CombineAndPauseNode(Plasma::StringParam name, unsigned ID);
