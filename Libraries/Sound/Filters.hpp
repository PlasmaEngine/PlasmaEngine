...
private:
  int mBlockSize;
  int mSegmentCount;
  Plasma::Array<float> mStoredInputBuffer;
  int mBufferPosition;
  int mCurrentSegment;
  typedef Plasma::Array<ComplexNumber> ComplexListType;
  Plasma::Array<ComplexListType> mSegments;
  Plasma::Array<ComplexListType> mSegmentsIR;
