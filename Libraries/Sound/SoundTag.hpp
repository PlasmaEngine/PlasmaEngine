...
{
public:
  LightningDeclareType(TagObject, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<SoundInstance*, InstanceData*> InstanceDataMapType;
...
{
  LightningDeclareType(SoundTagDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SoundTag, TypeCopyMode::ReferenceType);
  SoundTag();
  ~SoundTag();
  ...
  /// If this value is greater than plasma, SoundCues with this SoundTag will only
