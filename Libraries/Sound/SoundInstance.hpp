...
{
public:
  LightningDeclareType(SoundInstanceEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SoundInstance, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::Array<TagObject*> TagListType;
  ...
  // If true, sound is ramping volume down to plasma to pause.
  bool mPausingThreaded;
  // If true, sound is ramping volume down to plasma to stop.
