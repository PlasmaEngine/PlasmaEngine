...
{
public:
  LightningDeclareType(AsyncProcessEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AsyncProcess, TypeCopyMode::ReferenceType);
...
private:
  ...
  HandleOf<Lightning::FileStreamClass> mStandardInput;
