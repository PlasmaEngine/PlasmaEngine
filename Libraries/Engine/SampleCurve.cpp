...
namespace Plasma
{
LightningDefineType(SampleCurve, builder, type)
{
  LightningBindMethod(Sample);
  LightningBindMethod(DebugSample);
  LightningBindGetterProperty(WidthMax);
  LightningBindGetterProperty(HeightMax);
}
