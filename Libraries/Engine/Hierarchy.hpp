...
{
public:
  LightningDeclareType(HierarchyEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Hierarchy, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(HierarchyComposition, TypeCopyMode::ReferenceType);
