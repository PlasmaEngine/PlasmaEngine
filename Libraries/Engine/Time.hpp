...
{
public:
  LightningDeclareType(UpdateEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TimeSpace, TypeCopyMode::ReferenceType);
  ...
  /// Gets the current frame time, or plasma if the time space is paused.
  ...
  /// Ideally this is set to a very small non-plasma value to prevent any division
  /// by plasma errors
  float mMinDt;
...
{
public:
  LightningDeclareType(TimeSystem, TypeCopyMode::ReferenceType);
