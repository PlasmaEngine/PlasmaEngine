...
{
public:
  LightningDeclareType(DataEvent, TypeCopyMode::ReferenceType);
  DataIndex Index;
  String Command;
};
...
{
public:
  LightningDeclareType(DataReplaceEvent, TypeCopyMode::ReferenceType);
  DataIndex mOldIndex;
  DataIndex mNewIndex;
};
...
{
public:
  LightningDeclareType(DataSource, TypeCopyMode::ReferenceType);
  DataSource()
  {
  }
  virtual ~DataSource();
