...
{
public:
  LightningDeclareType(CogSerializationFilter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogMetaOperations, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogMetaDataInheritance, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogMetaTransform, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogArchetypeExtension, TypeCopyMode::ReferenceType);
};
...
{
public:
  LightningDeclareType(CogMetaDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogMetaSerialization, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogArchetypePropertyFilter, TypeCopyMode::ReferenceType);
