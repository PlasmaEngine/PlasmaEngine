...
LightningDefineType(DocumentationLibrary, builder, type)
{
}
...
MethodDoc* MethodDocWithSameParams(Array<MethodDoc*>& methodList, Lightning::Function* function)
{
...
// ExceptionDoc
template <>
struct Plasma::Serialization::Trait<ExceptionDoc>
{
  enum
  {
...
// CommandDoc
template <>
struct Plasma::Serialization::Trait<CommandDoc>
{
...
{
  Plasma::Sort(mCommands.All(), CommandCompareFn);
}
...
// EventDoc
template <>
struct Plasma::Serialization::Trait<EventDoc>
{
...
// EventDocList
template <>
struct Plasma::Serialization::Trait<EventDocList>
{
...
{
  Plasma::Sort(mEvents.All(), eventCompareFn);
}
...
// PropertyDoc
template <>
struct Plasma::Serialization::Trait<PropertyDoc>
{
...
// ParameterDoc
template <>
struct Plasma::Serialization::Trait<ParameterDoc>
{
  enum
  {
    Type = StructureType::Object
...
// MethodDoc
template <>
struct Plasma::Serialization::Trait<MethodDoc>
{
...
// AttributeDocList
Plasma::AttributeDocList::~AttributeDocList()
{
...
{
  Plasma::Sort(mObjectAttributes.All(), AttributeDocCompareFn);
  Plasma::Sort(mFunctionAttributes.All(), AttributeDocCompareFn);
  Plasma::Sort(mPropertyAttributes.All(), AttributeDocCompareFn);
}

// ClassDoc
template <>
struct Plasma::Serialization::Trait<ClassDoc>
{
...
void ClassDoc::BuildMapsAndArrays()
{
  ...
  Plasma::Sort(mProperties.All(), TrimCompareFn<PropertyDoc>);
  Plasma::Sort(mMethods.All(), TrimCompareFn<MethodDoc>);
  Plasma::Sort(mEventsSent.All(), TrimCompareFn<EventDoc>);
...
void ClassDoc::CreateMethodDocFromBoundType(Lightning::Function* method, TypeReplacementMap* replacements, bool exportDoc)
{
  ...
  Lightning::Type* returnType = type->Return;
...
void DocumentationLibrary::LoadDocumentation(StringParam fileName)
{
  ...
  {
    BoundType* resourceType = LightningTypeId(Resource);
...
void DocumentationLibrary::FinalizeDocumentation(void)
{
  ...
  Plasma::Sort(mClasses.All(), TrimCompareFn<ClassDoc>);
  Plasma::Sort(mEnums.All(), TrimCompareFn<EnumDoc>);
  Plasma::Sort(mFlags.All(), TrimCompareFn<EnumDoc>);
...
ClassDoc* DocumentationLibrary::CreateClassDocFromBoundType(BoundType* type, TypeReplacementMap* replacements)
{
  ...
  {
    PlasmaPrint("Warning: type '%s' is improperly named and unreferenceable.\n", type->Name.c_str());
    return nullptr;
  }
                                                               ...
                                                               ArrayMap<String, String>& replacements)
{
  ...
  {
    dummyTypes.PushBack(Constant(LightningTypeId(Wrapper)));
    dummyTypes.PushBack(Constant(LightningTypeId(Utf8Encoding)));
  }
...
void DocumentationLibrary::LoadFromMeta()
{
  ...
  forRange (auto& boundTemplate, templateLibrary->BoundTypes.All())
  {
    ...
    templatedType->AddAttribute(Lightning::ImportDocumentation);
  }
...
String GenerateDocumentationString(StringParam name)
{
  ...
  if (!PL::gDocumentation->mClassMap.ContainsKey(name))
    return String();

  ClassDoc* classDoc = PL::gDocumentation->mClassMap[name];
