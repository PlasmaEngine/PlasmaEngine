...
{
public:
  LightningDeclareType(GamepadEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Gamepad, TypeCopyMode::ReferenceType);
  ...
  /// Speed is a value between plasma and one.
...
{
public:
  LightningDeclareType(Gamepads, TypeCopyMode::ReferenceType);
