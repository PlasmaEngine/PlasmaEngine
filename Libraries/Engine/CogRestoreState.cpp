...
Object* CogRestoreState::RestoreObject()
{
  ...
  if (object == nullptr)
  {
    ...
    object = PL::gFactory->BuildFromStream(&context, loader);
...
void CogRestoreState::StoreChildUndoIds(Cog* object)
{
  ...
  {
    UndoObjectId componentUndoId = PL::gUndoMap->GetUndoId(component);
  ...
  {
    // Store the object
    UndoObjectId undoId = PL::gUndoMap->GetUndoId(child);
...
void CogRestoreState::RestoreChildUndoIds(Cog* object, uint& childIndex)
{
  ...
  forRange (Component* component, object->GetComponents())
  {
    ...
    PL::gUndoMap->UpdateUndoId(componentUndoId, component);
  ...
  forRange (Cog& child, object->GetChildren())
  {
    ...
    PL::gUndoMap->UpdateUndoId(undoId, child);
