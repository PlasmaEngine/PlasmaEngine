...
{
public:
  LightningDeclareType(OperationQueueEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareDerivedTypeExplicit(Operation, SafeId32EventObject, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(OperationBatch, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(OperationQueue, TypeCopyMode::ReferenceType);
