...
{
public:
  LightningDeclareType(SplineEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SplineControlPoint, TypeCopyMode::ValueType);
...
{
public:
  LightningDeclareType(SplineControlPoints, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SplineBakedPoint, TypeCopyMode::ValueType);
...
{
public:
  LightningDeclareType(SplineBakedPoints, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SplineSampleData, TypeCopyMode::ValueType);
...
{
public:
  LightningDeclareType(Spline, TypeCopyMode::ReferenceType);
