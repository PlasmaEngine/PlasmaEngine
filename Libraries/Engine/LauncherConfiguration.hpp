...
{
public:
  LightningDeclareType(LauncherConfig, TypeCopyMode::ReferenceType);
  ...
  /// Used so plasma can find out how to call the version selector.
...
{
  LightningDeclareType(LauncherLegacySettings, TypeCopyMode::ReferenceType);
