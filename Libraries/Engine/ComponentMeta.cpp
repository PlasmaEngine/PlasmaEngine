...
LightningDefineType(ComponentMetaDataInheritance, builder, type)
{
}
...
void ComponentMetaDataInheritance::RebuildObject(HandleParam object)
{
  ...
  LightningTypeId(Cog)->HasInherited<MetaDataInheritance>()->RebuildObject(cog);
}

// Component Meta Operations
LightningDefineType(ComponentMetaOperations, builder, type)
{
}
...
u64 ComponentMetaOperations::GetUndoHandleId(HandleParam object)
{
  ...
  u64 componentHash = LightningVirtualTypeId(component)->Name.Hash();
...
Any ComponentMetaOperations::GetUndoData(HandleParam object)
{
  ...
  MetaOperations* cogOperations = LightningTypeId(Cog)->HasInherited<MetaOperations>();
