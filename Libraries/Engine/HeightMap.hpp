...
{
  LightningDeclareType(HeightMapEvent, TypeCopyMode::ReferenceType);
...
struct HeightPatch
{
  LightningDeclareType(HeightPatch, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(HeightMap, TypeCopyMode::ReferenceType);
