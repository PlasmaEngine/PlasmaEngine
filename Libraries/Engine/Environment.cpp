...
LightningDefineType(Environment, builder, type)
{
  ...
  LightningBindFieldProperty(mCommandLine);
  LightningBindMethod(GetParsedArgument);
  LightningBindMethod(GetEnvironmentalVariable);
}
