...
LightningDefineType(ObjectTrack, builder, type)
{
}
...
LightningDefineType(Animation, builder, type)
{
  LightningBindGetterProperty(Duration);
...
struct AnimationLoadPattern
{
  ...
  static void LoadObjectTrack(Animation& animation, uint trackId, readerType& reader)
  {
    ...
    PropertyTrack* translationTrack = MakePropertyTrack("Transform", "Translation", LightningTypeId(Vec3));
    ...
    PropertyTrack* rotationTrack = MakePropertyTrack("Transform", "Rotation", LightningTypeId(Quat));
    ...
    PropertyTrack* scaleTrack = MakePropertyTrack("Transform", "Scale", LightningTypeId(Vec3));
