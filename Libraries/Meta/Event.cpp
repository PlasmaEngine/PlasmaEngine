...
namespace Plasma
{
LightningDefineType(EventObject, builder, type)
{
}
...
LightningDefineType(Event, builder, type)
{
  PlasmaBindDocumented();
  LightningBindFieldGetterProperty(EventId);
  PlasmaBindTag(Tags::Event);
...
// ObjectEvent
LightningDefineType(ObjectEvent, builder, type)
{
  PlasmaBindDocumented();
  LightningBindFieldGetterProperty(Source);

  PlasmaBindEvent(Events::ComponentsModified, ObjectEvent);
  PlasmaBindEvent(Events::ObjectModified, ObjectEvent);
  PlasmaBindEvent(Events::ObjectStructureModified, ObjectEvent);
}
...
// connections i.e LightningEventConnections during patching
