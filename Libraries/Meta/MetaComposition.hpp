...
{
public:
  LightningDeclareType(CogComponentMeta, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaComposition, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaOwner, TypeCopyMode::ReferenceType);
