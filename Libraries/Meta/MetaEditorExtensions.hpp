...
{
public:
  LightningDeclareType(EditorPropertyExtension, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EditorIndexedStringArray, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EditorRange, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EditorSlider, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EditorRotationBasis, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaEditorResource, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaPropertyFilter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaPropertyBasicFilter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaShaderInput, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaEditorGizmo, TypeCopyMode::ReferenceType);
  String mGizmoArchetype;
};

#define PlasmaFilterBool(Member) Add(new MetaPropertyBasicFilter(new TemplateFilterBool<LightningSelf, &LightningSelf::Member>()))

#define PlasmaFilterNotBool(Member)                                                                                      \
  Add(new MetaPropertyBasicFilter(new TemplateFilterNotBool<LightningSelf, &LightningSelf::Member>()))

#define PlasmaFilterEquality(Member, MemberType, ConstantValue)                                                          \
  Add(new MetaPropertyBasicFilter(                                                                                     \
      new TemplateFilterEquality<LightningSelf, MemberType, &LightningSelf::Member, ConstantValue>()))
...
{
public:
  LightningDeclareType(MetaGroup, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaCustomUi, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaPropertyRename, TypeCopyMode::ReferenceType);
