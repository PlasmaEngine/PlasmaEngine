...
{
public:
  LightningDeclareType(ViewportMouseEvent, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ReactiveViewport, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GameWidget, TypeCopyMode::ReferenceType);
