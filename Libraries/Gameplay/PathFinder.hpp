...
{
public:
  LightningDeclareType(PathFinderRequest, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PathFinder, TypeCopyMode::ReferenceType);
  ...
  HandleOf<ArrayClass<NodeKey>> FindPathHelper(CopyOnWriteHandle<Algorithm>& algorithm,
                                               ...
                                               size_t maxIterations)
  {
    HandleOf<ArrayClass<NodeKey>> array = LightningAllocate(ArrayClass<NodeKey>);
...
{
public:
  LightningDeclareType(PathFinderBaseEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PathFinderEvent, TypeCopyMode::ReferenceType);
...
template <typename NodeKey>
LightningDefineType(PathFinderEvent<NodeKey>, builder, type)
{
  LightningBindFieldGetter(mStart);
  LightningBindFieldGetter(mGoal);
  LightningBindGetter(Path);
}
