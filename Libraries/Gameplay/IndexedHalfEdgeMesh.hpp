...
{
public:
  LightningDeclareType(IndexedHalfEdgeMeshVertexArray, TypeCopyMode::ReferenceType);
};

class IndexedHalfEdgeMeshEdgeArray : public BoundArray<IndexedHalfEdgeMesh, IndexedHalfEdge*>
{
public:
  LightningDeclareType(IndexedHalfEdgeMeshEdgeArray, TypeCopyMode::ReferenceType);
};

class IndexedHalfEdgeFaceEdgeIndexArray : public BoundArray<IndexedHalfEdgeFace, int>
{
public:
  LightningDeclareType(IndexedHalfEdgeFaceEdgeIndexArray, TypeCopyMode::ReferenceType);
};

class IndexedHalfEdgeMeshFaceArray : public BoundArray<IndexedHalfEdgeMesh, IndexedHalfEdgeFace*>
{
public:
  LightningDeclareType(IndexedHalfEdgeMeshFaceArray, TypeCopyMode::ReferenceType);
};

class IndexedHalfEdge : public SafeId32Object
{
public:
  LightningDeclareType(IndexedHalfEdge, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(IndexedHalfEdgeFace, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(IndexedHalfEdgeMesh, TypeCopyMode::ReferenceType);
