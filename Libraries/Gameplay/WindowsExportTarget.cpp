...
void WindowsExportTarget::ExportApplication()
{
      ...
      FilePath::CombineWithExtension(mExporter->mOutputDirectory, mExporter->mApplicationName, ".exe");
  {
    ...
    String projectFileName = "Project.plasmaproj";
    ...
    ArchiveLibraryOutput(engineArchive, "PlasmaCore");
    ...
    engineArchive.AddFile(projectFile, "Project.plasmaproj");
    ...
    // Copy in PlasmaCrashHandler
    String crashHandler = FilePath::Combine("Tools", "PlasmaCrashHandler.exe");
...
void WindowsExportTarget::ExportContentFolders(Cog* projectCog)
{
  ...
  String outputDirectory = mExporter->mOutputDirectory;//FilePath::Combine(GetTemporaryDirectory(), "Windows", project->ProjectName);
