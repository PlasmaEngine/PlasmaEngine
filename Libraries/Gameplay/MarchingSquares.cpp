...
Vec2 MarchingSquares::GetPositionOfPlasma(real val0, real val1, Vec2Param pos0, Vec2Param pos1)
{
...
{
  Vec2 p0 = GetPositionOfPlasma(valC, valX, posC, posX);
  Vec2 p1 = GetPositionOfPlasma(valC, valY, posC, posY);
...
{
  Vec2 p0 = GetPositionOfPlasma(val0Edge0, val1Edge0, pos0Edge0, pos1Edge0);
  Vec2 p1 = GetPositionOfPlasma(val0Edge1, val1Edge1, pos0Edge1, pos1Edge1);
  segments.PushBack(Segment2d(p0, p1));
}
