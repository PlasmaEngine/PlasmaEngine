...
{
public:
  LightningDeclareType(NetPeer, TypeCopyMode::ReferenceType);
  ...
  /// [Server/Offline] This will always be plasma.
  /// [Client] This will be non-plasma once connected to a server, else plasma.
  ...
  /// [Server] This will be non-plasma if the client is connected, else plasma.
  /// [Client] This will always be plasma.
