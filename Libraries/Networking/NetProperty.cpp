...
LightningDefineType(NetProperty, builder, type)
{
  // Bind tags
  ...
  LightningBindGetterProperty(NetPropertyType);
  LightningBindGetterProperty(NetChannel);
...
LightningDefineType(NetPropertyType, builder, type)
{
  // Bind tags
  PlasmaBindTag(Tags::Networking);
...
#define BindVariantGetSetForType(property, typeName)                                                                   \
  LightningBindGetterSetterProperty(property##typeName)->Add(new PropertyFilter##typeName)

#define DefinePropertyFilterForType(typeName)                                                                          \
  LightningDefineType(PropertyFilter##typeName, builder, type)                                                             \
  {                                                                                                                    \
  }                                                                                                                    \
...
LightningDefineType(PropertyFilterMultiPrimitiveTypes, builder, type)
{
}
...
LightningDefineType(PropertyFilterFloatingPointTypes, builder, type)
{
}
...
LightningDefineType(PropertyFilterArithmeticTypes, builder, type)
{
}
...
LightningDefineType(NetPropertyConfig, builder, type)
{
  // Bind tags
  PlasmaBindTag(Tags::Networking);
  ...
  // Bind data members
  LightningBindGetterSetterProperty(BasicNetType)->AddAttribute(PropertyAttributes::cInvalidatesObject);
  LightningBindGetterSetterProperty(UseDeltaThreshold)->Add(new PropertyFilterArithmeticTypes);
  BindVariantGetSetForArithmeticTypes(DeltaThreshold);
  LightningBindGetterSetterProperty(SerializationMode)->Add(new PropertyFilterMultiPrimitiveTypes);
  LightningBindGetterSetterProperty(UseHalfFloats)
      ->AddAttributeChainable(PropertyAttributes::cInvalidatesObject)
      ->Add(new PropertyFilterFloatingPointTypes);
  LightningBindGetterSetterProperty(UseQuantization)
      ->AddAttributeChainable(PropertyAttributes::cInvalidatesObject)
  ...
  LightningBindGetterSetterProperty(UseInterpolation)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(InterpolationCurve)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(SampleTimeOffset)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(ExtrapolationLimit)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(UseConvergence)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(EventOnConvergenceStateChange)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(ActiveConvergenceWeight)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(RestingConvergenceDuration)->Add(new PropertyFilterArithmeticTypes);
  LightningBindGetterSetterProperty(ConvergenceInterval)->Add(new PropertyFilterArithmeticTypes);
...
LightningDefineType(NetPropertyInfo, builder, type)
{
  // Bind documentation
  PlasmaBindDocumented();
  ...
  LightningBindCustomGetterPropertyAs(GetComponentName, "Component");
  LightningBindCustomGetterPropertyAs(GetPropertyName, "Property");
  LightningBindGetterSetterProperty(NetChannelConfig);
  LightningBindGetterSetterProperty(NetPropertyConfig);
}
