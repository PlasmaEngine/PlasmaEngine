...
LightningDefineType(NetChannel, builder, type)
{
  // Bind tags
  ...
  LightningBindGetterProperty(NetChannelType);
  LightningBindCustomGetterProperty(IsScheduled);
  LightningBindCustomGetterProperty(IsNapping);
  LightningBindMethod(WakeUp);
  LightningBindMethod(TakeNap);
  LightningBindGetterSetterProperty(ChangeFlag);
  LightningBindMethod(ReplicateNow);
  LightningBindGetterProperty(LastChangeTimestamp);
  LightningBindGetterProperty(LastChangeTimePassed);
  LightningBindGetterSetterProperty(Authority);

  // Bind property management
  LightningBindMethod(HasNetProperty);
  LightningBindMethod(GetNetProperty);
}
...
String NetChannel::GetCombinedNetPropertyName(Component* component, StringParam propertyName)
{
  ...
  return String::Format("%s_%s", LightningVirtualTypeId(component)->Name.c_str(), propertyName.c_str());
}
                                        ...
                                        NetPropertyConfig* netPropertyConfig)
{
  ...
  else
  {
    ...
    NativeType* nativeType = LightningTypeToBasicNativeType(property->PropertyType);
...
LightningDefineType(NetChannelType, builder, type)
{
  // Bind tags
  PlasmaBindTag(Tags::Networking);
  ...
  // Bind configuration
  LightningBindMethod(ResetConfig);
  LightningBindMethod(SetConfig);
  LightningBindGetterSetterProperty(DetectOutgoingChanges);
  LightningBindGetterSetterProperty(AcceptIncomingChanges);
  LightningBindGetterSetterProperty(EventOnOutgoingPropertyChange);
  LightningBindGetterSetterProperty(EventOnIncomingPropertyChange);
  LightningBindGetterSetterProperty(AuthorityMode);
  LightningBindGetterSetterProperty(AuthorityDefault);
  LightningBindGetterSetterProperty(AllowRelay);
  LightningBindGetterSetterProperty(AllowNapping);
  LightningBindGetterSetterProperty(AwakeDuration);
  LightningBindGetterSetterProperty(DetectionMode);
  LightningBindGetterSetterProperty(AwakeDetectionInterval);
  LightningBindGetterSetterProperty(NapDetectionInterval);
  LightningBindGetterSetterProperty(ReplicateOnOnline);
  // LightningBindGetterSetterProperty(ReplicateOnChange);
  LightningBindGetterSetterProperty(ReplicateOnOffline);
  LightningBindGetterSetterProperty(SerializationMode);
  LightningBindGetterSetterProperty(ReliabilityMode);
  LightningBindGetterSetterProperty(TransferMode);
...
LightningDefineType(NetChannelConfig, builder, type)
{
  // Bind tags
  PlasmaBindTag(Tags::Networking);
  ...
  // Bind data members
  LightningBindFieldProperty(mDetectOutgoingChanges);
  LightningBindFieldProperty(mAcceptIncomingChanges);
  LightningBindFieldProperty(mEventOnOutgoingPropertyChange);
  LightningBindFieldProperty(mEventOnIncomingPropertyChange);
  LightningBindFieldProperty(mAuthorityMode);
  LightningBindFieldProperty(mAuthorityDefault);
  LightningBindFieldProperty(mAllowRelay);
  LightningBindFieldProperty(mAllowNapping);
  LightningBindFieldProperty(mAwakeDuration);
  LightningBindFieldProperty(mDetectionMode);
  LightningBindFieldProperty(mAwakeDetectionInterval);
  LightningBindFieldProperty(mNapDetectionInterval);
  LightningBindFieldProperty(mReplicateOnOnline);
  // LightningBindFieldProperty(mReplicateOnChange);
  LightningBindFieldProperty(mReplicateOnOffline);
  LightningBindFieldProperty(mSerializationMode);
  LightningBindFieldProperty(mReliabilityMode);
  LightningBindFieldProperty(mTransferMode);
  LightningBindFieldProperty(mAccurateTimestampOnChange);
}
