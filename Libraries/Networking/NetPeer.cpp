...
LightningDefineType(NetPeer, builder, type)
{
  PlasmaBindComponent();
  ...
  // Bind host interface
  LightningBindGetterSetterProperty(LanDiscoverable);
  LightningBindGetterSetterProperty(InternetDiscoverable);
  LightningBindGetterSetterProperty(HostPortRangeStart);
  LightningBindGetterSetterProperty(HostPortRangeEnd);
  LightningBindGetterSetterProperty(HostPingInterval);
  LightningBindGetterSetterProperty(InternetHostPublishInterval);
  LightningBindGetterSetterProperty(InternetHostRecordLifetime);
  LightningBindGetterSetterProperty(InternetSameIpHostRecordLimit);
  LightningBindMethod(SubscribeToMasterServer);
  LightningBindMethod(UnsubscribeFromMasterServer);
  LightningBindMethod(GetHostByIndex);
  LightningBindOverloadedMethod(GetHostByAddress, LightningConstInstanceOverload(NetHost*, Network::Enum, const IpAddress&));
  LightningBindOverloadedMethod(GetHostByAddress, LightningConstInstanceOverload(NetHost*, const IpAddress&));
  LightningBindMethod(GetHostList);
  LightningBindMethod(DiscoverHostList);
  LightningBindMethod(ClearHostList);
  LightningBindMethod(ClearHostLists);
  LightningBindMethod(RefreshHost);
  LightningBindMethod(RefreshHostList);
  LightningBindMethod(CancelHostRequests);

  // Bind peer interface
  LightningBindGetterProperty(Info)->Add(new EditInGameFilter);
  LightningBindCustomGetterProperty(IsOpen)->Add(new EditInGameFilter);
  LightningBindOverloadedMethod(Open, LightningInstanceOverload(bool, Role::Enum, uint, uint));
  LightningBindOverloadedMethod(Open, LightningInstanceOverload(bool, Role::Enum, uint));
  LightningBindOverloadedMethod(Open, LightningInstanceOverload(bool, Role::Enum));
  LightningBindOverloadedMethod(OpenClient, LightningInstanceOverload(bool, uint, uint));
  LightningBindOverloadedMethod(OpenClient, LightningInstanceOverload(bool, uint));
  LightningBindOverloadedMethod(OpenClient, LightningInstanceOverload(bool));
  LightningBindOverloadedMethod(OpenServer, LightningInstanceOverload(bool, uint));
  LightningBindOverloadedMethod(OpenServer, LightningInstanceOverload(bool));
  LightningBindOverloadedMethod(OpenOffline, LightningInstanceOverload(bool));
  LightningBindMethod(Close);
  LightningBindGetterProperty(NetPeerId)->Add(new EditInGameFilter);
  LightningBindGetterProperty(Ipv4Address)->Add(new EditInGameFilter);
  LightningBindGetterProperty(Ipv4Host)->Add(new EditInGameFilter);
  LightningBindGetterProperty(Ipv4Port)->Add(new EditInGameFilter);
  LightningBindGetterProperty(NetObjectCount)->Add(new EditInGameFilter);
  LightningBindGetterProperty(NetUserCount)->Add(new EditInGameFilter);
  LightningBindGetterProperty(NetSpaceCount)->Add(new EditInGameFilter);
  LightningBindGetterSetterProperty(FrameFillWarning);
  LightningBindGetterSetterProperty(FrameFillSkip);

  // Bind link interface
  LightningBindGetterProperty(LinkCount)->Add(new EditInGameFilter);
  LightningBindOverloadedMethod(ConnectLink, LightningInstanceOverload(bool, const IpAddress&, EventBundle*));
  LightningBindOverloadedMethod(ConnectLink, LightningInstanceOverload(bool, const IpAddress&, Event*));
  LightningBindOverloadedMethod(ConnectLink, LightningInstanceOverload(bool, const IpAddress&));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, const IpAddress&, EventBundle*));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, const IpAddress&, Event*));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, const IpAddress&));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, NetPeerId, EventBundle*));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, NetPeerId, Event*));
  LightningBindOverloadedMethod(DisconnectLink, LightningInstanceOverload(bool, NetPeerId));
  LightningBindOverloadedMethod(DisconnectAllLinks, LightningInstanceOverload(uint, EventBundle*));
  LightningBindOverloadedMethod(DisconnectAllLinks, LightningInstanceOverload(uint, Event*));
  LightningBindOverloadedMethod(DisconnectAllLinks, LightningInstanceOverload(uint));
  LightningBindMethod(GetLinkCreationDirection);
  LightningBindMethod(GetLinkStatus);
  LightningBindMethod(GetLinkState);
  LightningBindMethod(GetLinkIpAddress);
  LightningBindMethod(GetOurIpAddressFromLink);
  LightningBindMethod(GetLinkInternetProtocol);
  LightningBindMethod(GetLinkNetPeerId);
  ...
  LightningBindGetter(Users);
  LightningBindGetterProperty(UserCount)->Add(new EditInGameFilter);
  LightningBindOverloadedMethod(RemoveUser, LightningInstanceOverload(bool, Cog*, EventBundle*));
  LightningBindOverloadedMethod(RemoveUser, LightningInstanceOverload(bool, Cog*, Event*));
  LightningBindOverloadedMethod(RemoveUser, LightningInstanceOverload(bool, Cog*));

  LightningBindGetterSetterProperty(InternetHostListTimeout);
  LightningBindGetterSetterProperty(BasicHostInfoTimeout);
  LightningBindGetterSetterProperty(ExtraHostInfoTimeout);

  // Bind replication interface
  LightningBindMethod(GetNetSpace);
  LightningBindMethod(GetNetObject);
...
void NetPeer::HandlePendingRequests()
{
  ...
  for (uint i = 0; i < mPendingRequests.Size();)
  {
    ...
    case NetRequestType::Connect:
    {
      ...
      netConnectRequestData.mEventBundleData = PlasmaMove(netRequest.mOurRequestBundle.GetBitStream());
...
bool NetPeer::ReceiveUserAddRequest(NetPeerId theirNetPeerId, const IpAddress& theirIpAddress, const Message& message)
{
  ...
  theirRequestBundle = PlasmaMove(netUserAddRequestData.mEventBundleData);
                                               ...
                                               NetUserId theirNetUserId)
{
  ...
  (*returnOurResponseBundle) = PlasmaMove(event.mReturnOurResponseBundle.GetBitStream());
                                     ...
                                     EventBundle* ourRequestBundle)
{
  ...
  theirResponseBundle = PlasmaMove(netUserAddResponseData.mEventBundleData);
                                       ...
                                       const Message& message)
{
  ...
  EventBundle theirRequestBundle(static_cast<GameSession*>(GetOwner()));
  theirRequestBundle = PlasmaMove(netUserRemoveRequestData.mEventBundleData);
...
bool NetPeer::ReceiveLevelLoadStarted(NetPeerId theirNetPeerId, const IpAddress& theirIpAddress, const Message& message)
{
  ...
  if (netLevelLoadStartedData.mLevelResourceId != 0)
  {
    // Get level resource
    Level* level =
        static_cast<Level*>(PL::gResources->GetResource((ResourceId)netLevelLoadStartedData.mLevelResourceId));
    if (!level) // Unable?
    {
...
bool NetPeer::ValidateNetEvent(StringParam netEventId, Event* netEvent, TransmissionDirection::Enum direction)
{
  ...
  BoundType* dispatchedEventType = LightningVirtualTypeId(netEvent);
...
// Using Archetype "ResourceId:Name" String as ReplicaType? (Easier to debug)
  ...
  if (!archetypeResourceIdName.Empty())
  {
    ...
    archetype = static_cast<Archetype*>(PL::gResources->GetResourceByName(archetypeResourceIdName));
  }
...
// Using Archetype ResourceId u64 as ReplicaType? (Much more efficient)
  ...
  if (archetypeResourceId != 0)
  {
    ...
    archetype = static_cast<Archetype*>(PL::gResources->GetResource(archetypeResourceId));
  }
...
void NetPeer::ClientOnConnectRequest(ReplicatorLink* link, ConnectRequestData& connectRequestData)
{
  ...
  event.mOurRequestBundle = PlasmaMove(netConnectRequestData.mEventBundleData);
...
Pair<bool, BitStream> NetPeer::ServerOnConnectRequest(ReplicatorLink* link, ConnectRequestData& connectRequestData)
{
  ...
  event.mTheirIpAddress = link->GetLink()->GetTheirIpAddress();
  event.mTheirRequestBundle = PlasmaMove(netConnectRequestData.mEventBundleData);
...
bool NetPeer::ProcessReceivedCustomMessage(PeerLink* link, Message& message)
{
  ...
  // else let net peer decide what to do with the message.
    ...
    case LinkEventMessageType::Receipt:
    {
      ...
      {
        // PlasmaPrint("Non-Master Server: Got receipt, but broke out because no one
      ...
      {
        // PlasmaPrint("Master server: Disconnecting from peer.\n");
...
void NetPeer::UpdatePublishInterval(UpdateEvent* event)
{
  ...
  if (mPublishElapsedTime >= mInternetHostPublishInterval)
  {
    ...
    netHostPublishData.mBasicHostInfo = PlasmaMove(event.mReturnHostInfo.GetBitStream());
    ...
    forRange (auto ipAddress, mMasterServerSubscriptions.All())
    {
      ...
      // PlasmaPrint("Publishing my server %s to the master server %s\n",
...
bool NetPeer::HandlePing(IpAddress const& theirIpAddress, NetHostPingData& netHostPingData)
{
  ...
  pingBundle = PlasmaMove(netHostPingData.mEventBundleData);
                                         ...
                                         Guid const& thierProjectGuid)
{
  ...
  if (recordExists)
  {
    ...
    record->mLifetime = 0;
    record->mBasicHostInfo = PlasmaMove(EventBundle(basicHostInfo).GetBitStream());

    // PlasmaPrint("Updated host record for %s.\n",
  ...
  {
    Plasma::String justIp = theirIpAddress.GetHost();
    ...
    newRecord->mBasicHostInfo = PlasmaMove(basicHostInfo.GetBitStream());
    newRecord->mProjectGuid = thierProjectGuid;

    // PlasmaPrint("Added new host record for %s.\n",
    // theirIpAddress.GetString().c_str() );
...
void NetPeer::RemoveNetHostRecord(Guid const& projectGuid, IpAddress const& netHostRecordIp)
{
  ...
  Plasma::String justIp = netHostRecordIp.GetHost();
...
void NetPeer::ReceiveHostPublish(IpAddress const& theirIpAddress, Message& message)
{
  ...
  basicHostInfo = PlasmaMove(netHostPublishData.mBasicHostInfo);
