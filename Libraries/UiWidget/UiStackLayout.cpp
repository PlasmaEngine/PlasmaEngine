...
LightningDefineType(UiStackLayout, builder, type)
{
  PlasmaBindDocumented();
  PlasmaBindComponent();
  PlasmaBindInterface(UiLayout);
  LightningBindGetterSetterProperty(StackDirection);
  LightningBindGetterSetterProperty(Spacing);
}
