...
public:
  /// Meta Initialization.
  LightningDeclareType(UiTransformUpdateEvent, TypeCopyMode::ReferenceType);
...
public:
  ...
  /// Meta Initialization.
  LightningDeclareType(UiWidgetCastResultsRange, TypeCopyMode::ValueType);
...
public:
  ...
  /// Meta Initialization.
  LightningDeclareType(UiWidget, TypeCopyMode::ReferenceType);
