...
Verify(): Runs the function and generates an error if the function returns non
          plasma. When diagnostic disabled the function call will remain but the
...
#define AlwaysErrorIf(Expression, ...)                                                                                 \
  ...
  {                                                                                                                    \
    ...
    if ((Expression) && ::Plasma::ErrorSignaler::SignalError(                                                            \
                            ::Plasma::ErrorSignaler::Error, #Expression, __FILE__, __LINE__, __ignore, ##__VA_ARGS__))   \
      PlasmaDebugBreak();                                                                                                \
...
#  define WarnIf(Expression, ...)                                                                                      \
    ...
    {                                                                                                                  \
      static bool __ignore = false;                                                                                    \
      if ((Expression) &&                                                                                              \
          ::Plasma::ErrorSignaler::SignalError(                                                                          \
              ::Plasma::ErrorSignaler::Warning, #Expression, __FILE__, __LINE__, __ignore, ##__VA_ARGS__))               \
        PlasmaDebugBreak();                                                                                              \
    } while (gConditionalFalseConstant)
...
#  define Warn(...)                                                                                                    \
    ...
    {                                                                                                                  \
      static bool __ignore = false;                                                                                    \
      if (::Plasma::ErrorSignaler::SignalError(                                                                          \
              ::Plasma::ErrorSignaler::Warning, "", __FILE__, __LINE__, __ignore, ##__VA_ARGS__))                        \
        PlasmaDebugBreak();                                                                                              \
    } while (gConditionalFalseConstant)
...
#  define FileErrorIf(Expression, file, Line, ...)                                                                     \
    ...
    {                                                                                                                  \
      static bool __ignore = false;                                                                                    \
      if ((Expression) && ::Plasma::ErrorSignaler::SignalError(                                                          \
                              ::Plasma::ErrorSignaler::FileError, #Expression, file, Line, __ignore, ##__VA_ARGS__))     \
        PlasmaDebugBreak();                                                                                              \
