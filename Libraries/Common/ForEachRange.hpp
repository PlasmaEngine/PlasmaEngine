...
#define PlasmaForRangeHelper(value, rangeName, rangeExpr, rangePostPop, rangePrePop)                                     \
...
// With auto this is much easier to define
#define PlasmaForRangeReferenceHelper(value, rangeName, rangeExpr, rangePostPop, rangePrePop)                            \
  if (bool __continueLoop = true)                                                                                      \
...
#define forRange(value, rangeExpr) PlasmaForRangeHelper(value, __rangeT, (rangeExpr).All(), __rangeT.PopFront(), )
#define forRangeRef(value, rangeExpr)                                                                                  \
  PlasmaForRangeReferenceHelper(value, __rangeT, (rangeExpr).All(), __rangeT.PopFront(), )
...
#define PlasmaForRangeVar(value, rangeName, rangeExpr)                                                                   \
  PlasmaForRangeHelper(value, rangeName, (rangeExpr).All(), VoidReturn(), if (PopFront(rangeName)))
#define PlasmaForRangeRefVar(value, rangeName, rangeExpr)                                                                \
  PlasmaForRangeReferenceHelper(value, rangeName, (rangeExpr).All(), VoidReturn(), if (PopFront(rangeName)))
