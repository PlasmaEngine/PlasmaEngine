...
struct PlasmaShared IntVector3
{
  IntVector3(void)
  {
  }
...
/// Binary Operators (integers)
PlasmaShared IntVector3 operator*(int lhs, IntVec3Param rhs);

/// Returns a vector with absolute valued elements of the given vector.
PlasmaShared IntVector3 Abs(IntVec3Param vec);

/// Returns the component-wise minimum vector of the two vectors.
PlasmaShared IntVector3 Min(IntVec3Param lhs, IntVec3Param rhs);

/// Returns the component-wise maximum vector of the two vectors.
PlasmaShared IntVector3 Max(IntVec3Param lhs, IntVec3Param rhs);

/// Compute the dot product of two vectors.
PlasmaShared int Dot(IntVec3Param lhs, IntVec3Param rhs);
