...
PlasmaShared Matrix2 operator*(real lhs, Mat2Param rhs);
PlasmaShared Matrix2 Multiply(Mat2Param lhs, Mat2Param rhs);
PlasmaShared Vector2 Multiply(Mat2Param lhs, Vec2Param rhs);
