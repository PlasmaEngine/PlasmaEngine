...
class PlasmaShared Heap : public Graph
{
public:
...
class PlasmaSharedTemplate TypedAllocator : public Memory::StandardMemory
{
...
class PlasmaSharedTemplate ReservedSizeAllocator : public Memory::StandardMemory
{
...
template <typename NodeType>
class PlasmaSharedTemplate MemsetPlasmaTypedAllocator : public TypedAllocator<NodeType>
{
public:
  MemsetPlasmaTypedAllocator() : mNode(Memory::GetGlobalHeap())
  {
  }

  MemsetPlasmaTypedAllocator(cstr name) : mNode(Memory::GetNamedHeap(name))
  {
  }

  MemsetPlasmaTypedAllocator(NodeType* manager) : mNode(manager)
  {
  }
...
typedef MemsetPlasmaTypedAllocator<Memory::Heap> MemsetPlasmaDefaultAllocator;
