...
PlasmaShared String BuildString(StringRange a, StringRange b);
PlasmaShared String BuildString(StringRange a, StringRange b, StringRange c);
PlasmaShared String BuildString(StringRange a, StringRange b, StringRange c, StringRange d);
PlasmaShared String BuildString(StringRange a, StringRange b, StringRange c, StringRange d, StringRange e);
PlasmaShared String BuildString(StringRange a, StringRange b, StringRange c, StringRange d, StringRange e, StringRange f);
PlasmaShared String
BuildString(StringRange a, StringRange b, StringRange c, StringRange d, StringRange e, StringRange f, StringRange g);
PlasmaShared String BuildString(StringRange** ranges, uint count);

PlasmaShared String StringJoin(Array<String>& strings, StringParam joinToken);

/// Extension of ByteBuffer for building strings. Has
/// stream operators overloaded so it can act as a replacement
/// for io streams.
class PlasmaShared StringBuilder : public ByteBuffer
{
public:
