...
inline R_ENABLE_IF(!is_scalar<T>::value, Bits) BitStream::Measure(const T& value)
{
  ...
  return Plasma::Measure(const_cast<T&>(value));
}
                   ...
                   Bits) BitStream::MeasureQuantized(R minValue_, R maxValue_, R quantum_)
{
  ...
  // (Quantum should be non-plasma and positive)
  Assert(quantum_ > 0);
...
{
  // Invoke user-defined function
  return Plasma::MeasureQuantized(minValue_, maxValue_, quantum_);
}
...
{
  // Invoke user-defined function
  return Plasma::Serialize(direction, *this, value);
}
...
{
  // Invoke user-defined function
  return Plasma::SerializeQuantized(direction, *this, value_, minValue_, maxValue_, quantum_);
}
...
{
  // Invoke user-defined function
  return Plasma::Serialize(SerializeDirection::Write, *this, const_cast<T&>(value));
}
...
{
  // Invoke user-defined function
  return Plasma::SerializeQuantized(
...
{
  // Invoke user-defined function
  return Plasma::Serialize(SerializeDirection::Read, *const_cast<BitStream*>(this), value);
}
