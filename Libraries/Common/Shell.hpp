...
PlasmaShared HashMap<uint, String>& GetUsageNames();

class PlasmaShared PlatformAxis
{
public:
  String mName;
  uint mOffset;
...
class PlasmaShared PlatformButton
{
public:
  String mName;
  uint mOffset;
...
class PlasmaShared PlatformInputDevice
{
public:
...
public:
  ...
  void (*mOnPaste)(ClipboardData& data, Shell* shell);

  void* mUserData;

  PlasmaDeclarePrivateData(Shell, 128);
};
...
public:
  ...
  PlasmaDeclarePrivateData(ShellWindow, 64);
};
