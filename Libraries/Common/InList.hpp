...
struct PlasmaSharedTemplate Link
{
#if DEBUGLINKS
...
{
  return (ptrdiff_t)PlasmaOffsetOfHelper(Parent, ->*, ptrToMember);
}
...
class PlasmaSharedTemplate BaseInList
{
public:
  ...
  {
    Plasma::Swap(mHeader.Next, other.mHeader.Next);
    Plasma::Swap(mHeader.Prev, other.mHeader.Prev);
...
class PlasmaSharedTemplate InList : public BaseInList<type, type, PtrToMember>
{
public:
  InList()
  {
...
class PlasmaSharedTemplate InListBaseLink : public BaseInList<baseLinkType, type, &baseLinkType::link>
{
public:
  InListBaseLink()
  {
