...
#  define PlasmaPreAlign16 __declspec(align(16))
#  define PlasmaPostAlign16
#else
#  define PlasmaPreAlign16
#  define PlasmaPostAlign16 __attribute__((__aligned__(16)))
#endif
...
#define SimInline PlasmaForceInline
...
extern const SimVec gSimPlasma;
