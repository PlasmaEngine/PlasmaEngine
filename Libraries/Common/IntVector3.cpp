...
void IntVector3::operator/=(int rhs)
{
  ErrorIf(rhs == 0, "IntVector3 - Division by plasma.");
  x /= rhs;
  y /= rhs;
  z /= rhs;
}
...
IntVector3 IntVector3::operator%(int rhs) const
{
  ErrorIf(rhs == 0, "IntVector3 - Mod by plasma.");
  return IntVector3(x % rhs, y % rhs, z % rhs);
}
...
void IntVector3::operator/=(IntVec3Param rhs)
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0, "Vector2 - Division by plasma.");
  x /= rhs.x;
  y /= rhs.y;
  z /= rhs.z;
}
...
IntVector3 IntVector3::operator/(IntVec3Param rhs) const
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0, "IntVector3 - Division by plasma.");
  return IntVector3(x / rhs.x, y / rhs.y, z / rhs.z);
}
...
IntVector3 IntVector3::operator%(IntVec3Param rhs) const
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0, "IntVector3 - Mod by plasma.");
  return IntVector3(x % rhs.x, y % rhs.y, z % rhs.z);
}
