...
private:
  ...
  Plasma::Array<BakedData> mArcLengthTable;
};

struct PlasmaShared PiecewiseFunction
{
  struct ControlPoint;
  ...
  /// This will invalidate the baked curve.
  void SetControlPoints(Plasma::Array<ControlPoint>& controlPoints);
  ...
  Plasma::Array<ControlPoint> mControlPoints;
