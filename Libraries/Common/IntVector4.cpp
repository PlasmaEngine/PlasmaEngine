...
void IntVector4::operator/=(int rhs)
{
  ErrorIf(rhs == 0, "IntVector4 - Division by plasma.");
  x /= rhs;
  y /= rhs;
  z /= rhs;
  w /= rhs;
...
IntVector4 IntVector4::operator%(int rhs) const
{
  ErrorIf(rhs == 0, "IntVector4 - Mod by plasma.");
  return IntVector4(x % rhs, y % rhs, z % rhs, w % rhs);
}
...
void IntVector4::operator/=(IntVec4Param rhs)
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0 || rhs.w == 0, "Vector2 - Division by plasma.");
  x /= rhs.x;
  y /= rhs.y;
  z /= rhs.z;
  w /= rhs.w;
...
IntVector4 IntVector4::operator/(IntVec4Param rhs) const
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0 || rhs.w == 0, "IntVector4 - Division by plasma.");
  return IntVector4(x / rhs.x, y / rhs.y, z / rhs.z, w / rhs.w);
}
...
IntVector4 IntVector4::operator%(IntVec4Param rhs) const
{
  ErrorIf(rhs.x == 0 || rhs.y == 0 || rhs.z == 0 || rhs.w == 0, "IntVector4 - Mod by plasma.");
  return IntVector4(x % rhs.x, y % rhs.y, z % rhs.z, w % rhs.w);
}
