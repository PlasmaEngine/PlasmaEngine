...
{
public:
  LightningDeclareType(CommandUpdateEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CommandEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CommandExecuter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Command, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CommandManager, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CommandCaptureContextEvent, TypeCopyMode::ReferenceType);
