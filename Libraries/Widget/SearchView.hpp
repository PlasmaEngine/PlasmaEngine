...
{
public:
  LightningDeclareType(SearchViewEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AlternateSearchCompletedEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SearchViewElement, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SearchView, TypeCopyMode::ReferenceType);
