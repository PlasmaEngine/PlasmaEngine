...
{
  LightningDeclareType(ContextMenuEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContextMenuEntry, TypeCopyMode::ReferenceType);

  ContextMenuEntry(StringParam name = String(), StringParam icon = String(), bool readOnly = false);
  virtual ~ContextMenuEntry();

  // Context Menu Entry Interface (for use in lightning and C++)
...
{
public:
  LightningDeclareType(ContextMenuEntryDivider, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContextMenuEntryCommand, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContextMenuEntryMenu, TypeCopyMode::ReferenceType);
...
{
public:
  typedef ContextMenuItem LightningSelf;
...
{
public:
  typedef ContextMenu LightningSelf;
  ...
  void AddDivider();
  void AddPlasmaContextMenu(StringParam menuName);
...
{
public:
  LightningDeclareType(MenuBarItem, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MenuBar, TypeCopyMode::ReferenceType);
...
#define ConnectMenu(menu, optionName, function, readOnly)                                                              \
  {                                                                                                                    \
    ...
    ConnectThisTo(entry, Plasma::Events::MenuItemSelected, function);                                                    \
  }

template <typename ContextType>
ContextType* Context::Get()
{
  BoundType* type = LightningTypeId(ContextType);
