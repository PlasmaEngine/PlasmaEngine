...
{
public:
  LightningDeclareType(ListBox, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ComboBox, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(StringComboBox, TypeCopyMode::ReferenceType);
