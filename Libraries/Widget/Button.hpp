...
{
public:
  LightningDeclareType(ButtonBase, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TextButton, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(IconButton, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ToggleIconButton, TypeCopyMode::ReferenceType);
