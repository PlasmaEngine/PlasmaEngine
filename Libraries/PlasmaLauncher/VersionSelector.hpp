...
public:
  ...
  /// Given a path to a local '.plasmatemplate' file, install the template project
  ...
  // downloads location)
  void FindOnDiskTemplates(PlasmaBuild* selectedBuild);
  ...
  // more so.
  WarningLevel::Enum CheckVersionForProject(PlasmaBuild* standalone,
