...
void StreamedVertexBuffer::Initialize()
{
  ...
  glVertexAttribPointer(
      VertexSemantic::Uv, 2, GL_FLOAT, GL_FALSE, sizeof(StreamedVertex), (void*)PlasmaOffsetOf(StreamedVertex, mUv));
...
void OpenglRenderer::DrawStatic(ViewNode& viewNode, FrameNode& frameNode)
{
  ...
  if (textureData != nullptr)
  {
    ...
    SetShaderParameter(ShaderInputType::Texture, "MiscData.HeightMapWeights", &textureSlot);
  }
