...
// is plasma uses the last error.
Plasma::String ToErrorString(uint errorCode = 0);
void FillWindowsErrorStatus(Plasma::Status& status, const char* windowsFunctionName = nullptr);
