...
public:
  ...
  /// Returns true if the message is a part of a message channel (has a non-plasma
...
struct MoveWithoutDestructionOperator<Message>
{
  ...
  {
    new (dest) Message(PlasmaMove(*source));
  }
};
...
struct MoveWithoutDestructionOperator<OutMessage>
{
  ...
  {
    new (dest) OutMessage(PlasmaMove(*source));
  }
};
...
struct MoveWithoutDestructionOperator<FragmentedMessage>
{
  ...
  {
    new (dest) FragmentedMessage(PlasmaMove(*source));
  }
};
