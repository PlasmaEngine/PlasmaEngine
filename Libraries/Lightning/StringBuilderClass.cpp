...
Rune::Rune(const Plasma::Rune plasmaRune) : mValue(plasmaRune)
{
}
...
LightningDefineType(StringRangeExtended, builder, type)
{
  ...
  builder.AddBoundGetterSetter(
      type, "Current", LightningTypeId(Rune), nullptr, &StringRangeExtended::Current, MemberOptions::None);
  ...
  LightningFullBindMethod(builder, type, &StringRangeExtended::CompareTo, LightningNoOverload, "CompareTo", nullptr)
      ->Description = LightningDocumentString("Compares this StringRange to the given StringRange and returns an "
  ...
  LightningFullBindMethod(builder, type, &StringRangeExtended::ToLower, LightningNoOverload, "ToLower", nullptr)->Description =
      LightningDocumentString("Returns a copy of the string that has been converted to lowercase.");
  builder
      .AddBoundFunction(
  ...
  LightningFullBindMethod(builder, type, &StringRangeExtended::ToUpper, LightningNoOverload, "ToUpper", nullptr)->Description =
      LightningDocumentString("Returns a copy of the string that has been converted to uppercase.");
  ...
  builder
      .AddBoundFunction(type,
                        ...
                        iteratorType,
                        FunctionOptions::None)
      ->Description = LightningDocumentString("Finds the iterator from a rune index (the 'character' index). WARNING: "
...
void StringRangeExtended::SetResultStringSplitRange(Call& call,
                                                    ExceptionReport& report,
                                                    StringParam strRef,
                                                    const Plasma::StringSplitRange& result)
{
  Handle rangeHandle =
      call.GetState()->AllocateHeapObject(LightningTypeId(StringSplitRangeExtended), report, HeapFlags::ReferenceCounted);
...
{
  Handle rangeHandle = call.GetState()->AllocateDefaultConstructedHeapObject(
      LightningTypeId(RuneIterator), report, HeapFlags::ReferenceCounted);
...
LightningDefineType(StringSplitRangeExtended, builder, type)
{
  ...
  builder.AddBoundFunction(
      type, "MoveNext", &StringSplitRangeExtended::MoveNext, ParameterArray(), LightningTypeId(void), MemberOptions::None);
  builder.AddBoundGetterSetter(type,
                               ...
                               MemberOptions::None);
  builder.AddBoundGetterSetter(
      type, "IsNotEmpty", LightningTypeId(Boolean), nullptr, &StringSplitRangeExtended::IsNotEmpty, MemberOptions::None);
}
