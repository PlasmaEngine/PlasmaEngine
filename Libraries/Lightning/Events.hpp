...
// This class is specialized for C++ static and member and Lightning delegates (can
...
public:
  ...
  // 'LightningDefineEventDelegateHelpers' to automatically implement these virtual
  // methods
...
template <typename ClassType, typename EventType>
PlasmaSharedTemplate void EventConnect(EventHandler* sender,
...
// A class that represents the 'Events' class within Lightning code (for binding
// purposes)
