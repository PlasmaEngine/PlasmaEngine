    ...
    LibraryBuilder& builder, BoundType* classBoundType, StringRange name, StringRange spaceDelimitedNames, void (*)())
{
  ...
  return builder.AddBoundFunction(
      classBoundType, name, boundFunction, parameters, LightningTypeId(void), FunctionOptions::Static);
}
// BeginBound
    ...
    LibraryBuilder& builder, BoundType* classBoundType, StringRange name, StringRange spaceDelimitedNames, Return (*)())
{
  ...
  ParseParameterArrays(parameters, spaceDelimitedNames);
  return builder.AddBoundFunction(
      classBoundType, name, boundFunction, parameters, LightningTypeId(Return), FunctionOptions::Static);
}
// BeginBound
                            ...
                            void (Class::*)())
{
  ...
  ParseParameterArrays(parameters, spaceDelimitedNames);
  return builder.AddBoundFunction(
      classBoundType, name, boundFunction, parameters, LightningTypeId(void), FunctionOptions::None);
}
// BeginBound
                            ...
                            Return (Class::*)())
{
  ...
  ParseParameterArrays(parameters, spaceDelimitedNames);
  return builder.AddBoundFunction(
      classBoundType, name, boundFunction, parameters, LightningTypeId(Return), FunctionOptions::None);
}
// BeginBound
