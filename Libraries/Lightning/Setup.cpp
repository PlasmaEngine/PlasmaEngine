...
LightningSetup::LightningSetup(SetupFlags::Type flags)
{
  ...
  // to LightningStartup However, if the user defines 'LightningDisableDocumentation',
      ...
      else if (run)
      {
        ...
        if (programType != nullptr)
        {
          Function* mainFunction =
              programType->FindFunction("Main", Array<Type*>(), LightningTypeId(int), FindMemberOptions::None);
