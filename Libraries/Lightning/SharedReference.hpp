...
#pragma once
#ifndef LIGHTNING_SHARED_REFERENCE_HPP
#  define LIGHTNING_SHARED_REFERENCE_HPP

namespace Lightning
{
// A standard deletion policy
template <typename Type>
class PlasmaSharedTemplate StandardDelete
{
public:
...
template <typename Type>
class PlasmaSharedTemplate ArrayDelete
{
public:
  void operator()(Type* object)
  {
...
class PlasmaShared NormalPolicy
{
public:
  template <typename RefType>
  void AddLinkToList(RefType* ref)
...
class PlasmaShared VirtualType
{
public:
  virtual ~VirtualType()
  {
...
// 'LightningRefLink(YourClass);' member, which is intrusively
...
class PlasmaSharedTemplate Ref
{
public:
  // Type-defines
  ...
  // Move constructor
  Ref(Plasma::MoveReference<Ref> move)
  {
    Ref& other = *move;
  ...
  // Move assignment
  Ref& operator=(Plasma::MoveReference<Ref> move)
  {
    Ref& other = *move;
    this->Deletor = other.Deletor;
    this->Mode = other.Mode;
...
class PlasmaSharedTemplate RefLink
{
public:
  // Type-defines
...
#  define LightningRefLink(type)                                                                                           \
  public:                                                                                                              \
    typedef ::Lightning::RefLink<const type> RefLinkType;                                                                  \
...
#  define LightningDebuggableReferencer()                                                                                  \
