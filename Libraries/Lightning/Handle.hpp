...
// Enable this to add extra debugging support (for Lightning internal use, such as
// working on the compiler) Warning: This will make Lightning run significantly
// slower
