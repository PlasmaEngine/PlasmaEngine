...
#pragma once
#ifndef LIGHTNING_DOCUMENTATION_HPP
#  define LIGHTNING_DOCUMENTATION_HPP

namespace Lightning
{
// Represents a parameter in a function
class PlasmaShared DocumentationParameter
{
public:
...
class PlasmaShared DocumentationFunction
{
public:
  // Destructor
...
class PlasmaShared DocumentationProperty
{
public:
  // Constructor
...
class PlasmaShared DocumentationType
{
public:
  // Destructor
  ~DocumentationType();
...
class PlasmaShared DocumentationLibrary
{
public:
  // Destructor
...
// Represents an entire library built by our documentation engine
class PlasmaShared DocumentationModule
{
public:
  // Destructor
  ~DocumentationModule();
...
class PlasmaShared RstBuilder : public StringBuilderExtended
{
public:
