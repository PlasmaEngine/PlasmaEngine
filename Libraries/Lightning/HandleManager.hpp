...
public:
  ...
  // be deleted by Lightning This function may destroy the object, but should NOT do
  // so via Lightning calls such as Delete on the Handle
...
// the memory and continue. However, often times Lightning objects inherit from C++
