...
// parsed Lightning code may depend upon
...
// able to be used by the Lightning scripts Note: None of the code from the library
...
// order is actually important to Lightning
