...
// user thrown, etc)
LightningDeclareEvent(PreUnhandledException, ExceptionEvent);
...
// The types of fatal errors that can occur inside of Lightning (non recoverable
// errors)
...
public:
  ...
  // call to Lightning, and reset to the previous after the call)
...
public:
  ...
  // If the static field memory does not exist, it will be created and plasmaed
...
// function that is bound to Lightning
...
// A helper for allocating a type within Lightning using the current executable
// state
#  define LightningAllocate(T, ...) (LS::ExecutableState::GetCallingState()->AllocateDefaultConstructed<T>(__VA_ARGS__))
#  define LightningAllocateUntyped(...)                                                                                    \
    (LS::ExecutableState::GetCallingState()->AllocateDefaultConstructedHeapObject(__VA_ARGS__))

template <>
LightningCallHelperSpecialization(Any*, Any* const&);
template <>
LightningCallHelperSpecialization(Any, const Any&);
template <>
LightningCallHelperSpecialization(Any&, Any&);
template <>
LightningCallHelperSpecialization(const Any*, const Any* const&);
template <>
LightningCallHelperSpecialization(const Any&, const Any&);

template <>
LightningCallHelperSpecialization(Handle*, Handle* const&);
template <>
LightningCallHelperSpecialization(Handle, const Handle&);
template <>
LightningCallHelperSpecialization(Handle&, Handle&);
template <>
LightningCallHelperSpecialization(const Handle*, const Handle* const&);
template <>
LightningCallHelperSpecialization(const Handle&, const Handle&);

template <>
LightningCallHelperSpecialization(Delegate*, Delegate* const&);
template <>
LightningCallHelperSpecialization(Delegate, const Delegate&);
template <>
LightningCallHelperSpecialization(Delegate&, Delegate&);
template <>
LightningCallHelperSpecialization(const Delegate*, const Delegate* const&);
template <>
LightningCallHelperSpecialization(const Delegate&, const Delegate&);

template <typename T>
LightningCallHelperTemplateSpecialization(HandleOf<T>*, HandleOf<T>* const&);
template <typename T>
LightningCallHelperTemplateSpecialization(HandleOf<T>, const HandleOf<T>&);
template <typename T>
LightningCallHelperTemplateSpecialization(HandleOf<T>&, HandleOf<T>&);
template <typename T>
LightningCallHelperTemplateSpecialization(const HandleOf<T>*, const HandleOf<T>* const&);
template <typename T>
LightningCallHelperTemplateSpecialization(const HandleOf<T>&, const HandleOf<T>&);
