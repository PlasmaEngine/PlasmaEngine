...
namespace Lightning
{
LightningDefineType(Function, builder, type)
{
  type->HandleManager = LightningManagerId(PointerManager);
  LightningFullBindField(builder, type, &Function::FunctionType, "Type", PropertyBinding::Get);
  LightningFullBindMethod(builder, type, &Function::CreateDelegate, LightningNoOverload, "CreateDelegate", "instance");
  LightningFullBindMethod(builder, type, &Function::Invoke, LightningNoOverload, "Invoke", "instance, arguments");
}
