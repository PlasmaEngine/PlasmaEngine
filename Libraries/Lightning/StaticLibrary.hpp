...
public:
  ...
  // Whether we can currently build types or not (used in LightningTypeId and
  // Binding)
...
#  define LightningDeclareStaticLibraryInternals(Name, Namespace, ...)                                                     \
    ...
    Name() : LS::StaticLibrary(#Name, Namespace)                                                                       \
    {                                                                                                                  \
      LightningDependency(LS::Core) __VA_ARGS__                                                                            \
    }                                                                                                                  \
    ...
    static LS::LibraryRef GetLibrary()                                                                                 \
    {                                                                                                                  \
      return GetInstance().StaticLibrary::GetLibrary();                                                                \
    }                                                                                                                  \
    static LS::LibraryBuilder* GetBuilder()                                                                            \
    {                                                                                                                  \
    ...
    void SetupBinding(LS::LibraryBuilder& builder) override;
...
#  define LightningDeclareStaticLibrary(Name, Namespace, Linkage, ...)                                                     \
    class Linkage Name : public LS::StaticLibrary                                                                      \
    {                                                                                                                  \
    public:                                                                                                            \
...
#  define LightningNoNamespace LS::String()
...
#  define LightningDefineStaticLibrary(Name)                                                                               \
    ...
    void Name::SetupBinding(LS::LibraryBuilder& builder)
