...
#pragma once
#ifndef LIGHTNING_RANDOM_HPP
#  define LIGHTNING_RANDOM_HPP

namespace Lightning
{
/// Contains utility functions for random generation
class PlasmaShared Random
{
public:
  LightningDeclareType(Random, TypeCopyMode::ReferenceType);
  ...
  Lightning::Quaternion Quaternion();
