...
namespace Events
{
LightningDeclareEvent(CollectSpecializationConstants, SpecializationConstantEvent);
} // namespace Events

class SpecializationConstantEvent : public Lightning::EventData
{
public:
  LightningDeclareType(SpecializationConstantEvent, Lightning::TypeCopyMode::ReferenceType);
