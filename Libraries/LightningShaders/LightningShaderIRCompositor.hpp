...
class LightningShaderIRCompositor : public ShaderCompilationErrors
{
public:
  ...
  struct FragmentDescriptionMap : public OrderedHashMap<ShaderIRTypeMeta*, ShaderFragmentDescription*>
  {
    ...
    LightningRefLink(FragmentDescriptionMap);
  ...
  struct ShaderStageDescription
  {
    ...
    /// The generated lightning shader string.
    String mShaderCode;
    /// The name of the generated lightning class.
    String mClassName;
    ...
    Lightning::Ref<FragmentDescriptionMap> mFragmentDescriptions;
  };
  ...
  void GenerateLightningComposite(StageLinkingInfo* currentStage,
                              ShaderStageDescription& stageResults,
                              ShaderIRAttributeList& extraAttributes);
  void GenerateBasicLightningComposite(StageLinkingInfo* currentStage,
                                   ShaderStageDescription& stageResults,
                                   ShaderIRAttributeList& extraAttributes);
  void GenerateGeometryLightningComposite(StageLinkingInfo* currentStage,
                                      ShaderStageDescription& stageResults,
                                      ShaderIRAttributeList& extraAttributes);
  void GenerateComputeLightningComposite(StageLinkingInfo* currentStage,
                                     ShaderStageDescription& stageResults,
                                     ShaderIRAttributeList& extraAttributes);
...
{
public:
  LightningShaderIRCompositor* mCompositor;
  LightningShaderIRCompositor::StageLinkingInfo* mStageLinkingInfo;
