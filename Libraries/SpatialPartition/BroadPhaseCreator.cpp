...
LightningDefineTemplateType(DynamicBroadphasePropertyExtension, builder, type)
{
}

LightningDefineTemplateType(StaticBroadphasePropertyExtension, builder, type)
{
}

BroadPhaseLibrary::BroadPhaseLibrary()
{
  ErrorIf(PL::gBroadPhaseLibrary != nullptr, "Cannot instantiate two Libraries.");
  PL::gBroadPhaseLibrary = this;
