...
namespace Plasma
{
LightningDefineType(BaseCastFilter, builder, type)
{
  PlasmaBindDocumented();

  LightningBindGetterSetterProperty(IgnoreStatic);
  LightningBindGetterSetterProperty(IgnoreDynamic);
  LightningBindGetterSetterProperty(IgnoreKinematic);
  LightningBindGetterSetterProperty(IgnoreGhost);
  LightningBindGetterSetterProperty(IgnoreChildren);
}
