...
private:
  ...
  // void ValidateComposition(LightningShaderGenerator& generator,
  // LightningFragmentInfo& info, FragmentType::Enum fragmentType);
  void OnRunTranslation(Event* e);
  void OnScriptDisplayChanged(Event* e);

  LightningShaderIRLibraryRef BuildShaderLibrary(LightningShaderGenerator& generator,
