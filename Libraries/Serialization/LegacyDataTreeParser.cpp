...
DataNode* ReadField(DataTreeContext& c, Tokenizer& tokenizer, TempToken token, DataNode* parent)
{
  ...
  if (typeName == "float")
    typeName = LightningTypeId(float)->Name;
  else if (typeName == "bool")
    typeName = LightningTypeId(bool)->Name;
  else if (typeName == "uint")
    typeName = LightningTypeId(int)->Name;
  else if (typeName == "Vec2")
    typeName = LightningTypeId(Vec2)->Name;
  else if (typeName == "Vec3")
    typeName = LightningTypeId(Vec3)->Name;
  else if (typeName == "Vec4")
    typeName = LightningTypeId(Vec4)->Name;
  else if (typeName == "Quat")
    typeName = LightningTypeId(Quat)->Name;
