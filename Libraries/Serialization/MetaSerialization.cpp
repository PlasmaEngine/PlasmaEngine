...
// Meta Serialization
LightningDefineType(MetaSerialization, builder, type)
{
}
                                                   ...
                                                   Serializer& serializer)
{
  ...
  if (serializer.Start(propertyType, fieldName, StructureType::Object))
  {
    ...
    if (object.IsNull() && serializer.GetMode() == SerializerMode::Loading)
    {
      ...
      {
        object = LightningAllocateUntyped(propertyType);
...
void MetaSerialization::SerializeObject(AnyParam object, Serializer& serializer)
{
  ...
  if (Object* plasmaObject = handle.Get<Object*>())
    plasmaObject->Serialize(serializer);
  else
...
LightningDefineType(EnumMetaSerialization, builder, type)
{
}
...
LightningDefineTemplateType(PrimitiveMetaSerialization<Integer>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Integer2>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Integer3>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Integer4>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<String>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Boolean>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Real>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Real2>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Real3>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Real4>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Mat2>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Mat3>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Mat4>, builder, type)
{
}

LightningDefineTemplateType(PrimitiveMetaSerialization<Quat>, builder, type)
{
}

// String Serialization
LightningDefineType(MetaStringSerialization, builder, type)
{
}
...
LightningDefineType(SerializationFilter, builder, type)
{
}
  ...
  else
  {
    ...
    while (serializer.GetPolymorphic(componentNode))
    {
      ...
      if (componentType)
      {
        ...
        if (component.IsNull())
        {
          component = LightningAllocateUntyped(componentType);
