...
LightningDefineType(FlowEffect, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindSetup(SetupMode::DefaultSerialization);
  PlasmaBindDocumented();

  LightningBindGetterSetterProperty(LocalForce)->PlasmaSerialize(true);
  LightningBindGetterSetterProperty(AttractToFlowCenter)->PlasmaSerialize(false);
  LightningBindGetterSetterProperty(FlowSpeed)->PlasmaSerialize(real(10));
  LightningBindGetterSetterProperty(MaxFlowForce)->PlasmaSerialize(real(10));
  LightningBindGetterSetterProperty(FlowDirection)->PlasmaSerialize(Vec3(0, 1, 0));
  LightningBindGetterProperty(WorldFlowDirection);
  LightningBindGetterSetterProperty(AttractSpeed)->PlasmaSerialize(real(5));
  LightningBindGetterSetterProperty(MaxAttractForce)->PlasmaSerialize(real(50));
}
