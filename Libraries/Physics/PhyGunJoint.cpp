...
LightningDefineType(PhyGunJoint, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindGetterSetter(TargetPoint);
  LightningBindGetterSetter(LocalPoint);
  LightningBindGetterSetter(WorldPoint);
  LightningBindGetterSetter(TargetRotation);
