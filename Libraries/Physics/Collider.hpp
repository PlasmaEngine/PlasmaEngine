...
{
public:
  LightningDeclareType(Collider, TypeCopyMode::ReferenceType);
  ...
  /// but the translation is assumed to be plasma) inertia tensor from the passed
  /// in mass.
