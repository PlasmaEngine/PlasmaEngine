...
LightningDefineType(UniversalJoint, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindGetterSetterProperty(LocalAxis0OfBodyA);
  LightningBindGetterSetterProperty(LocalAxis1OfBodyA);
  LightningBindGetterSetterProperty(LocalAxis0OfBodyB);
  LightningBindGetterSetterProperty(LocalAxis1OfBodyB);
}
