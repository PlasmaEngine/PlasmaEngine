...
{
  LightningDeclareType(PhysicsCar, TypeCopyMode::ReferenceType);
  ...
  {
    LightningDeclareType(CarWheelRef, TypeCopyMode::ReferenceType);
  ...
  {
    LightningDeclareType(CarWheelArray, TypeCopyMode::ReferenceType);
