...
private:
  ...
  static const size_t InvalidIndex = Plasma::Array<Edge>::InvalidIndex;

  void AddEdge(unsigned p0, unsigned p1);

  Plasma::Array<CSOVertex> mVertices;
  Plasma::Array<Edge> mEdges;
  Plasma::Array<Face> mFaces;
  unsigned mIndexClosest;
  float mDistClosest;

  Plasma::Array<unsigned> mVisibleFaces;
