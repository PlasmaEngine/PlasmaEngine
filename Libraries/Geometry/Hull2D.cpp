...
void DrawPoint(Vec2Param point, const ByteColor& color)
{
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::Circle(p, cCircleAxis, cPointRadius).Color(color).OnTop(true));
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::Line(circlePoints[0], circlePoints[1]).Color(color).OnTop(true));
  Plasma::gDebugDraw->Add(Plasma::Debug::Line(circlePoints[2], circlePoints[3]).Color(color).OnTop(true));
}
...
void DrawLine(Vec2Param start, Vec2Param end, const ByteColor& color)
{
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::Line(a, b).Color(color).OnTop(true));
}
...
void Hull2D::DebugBuildStep(void)
{
  ...
  case 0:
  {
    Plasma::Sort(mPoints.All(), LessThanX);
    ++mDebugStep;
...
void Hull2D::Draw(void) const
{
  ...
  for (uint i = 0; i < pointCount; ++i)
  {
    ...
    Plasma::gDebugDraw->Add(Plasma::Debug::Line(thisPoint, nextPoint).Color(color).OnTop(true));
  }
  ...
  if (mUsingDebug)
  {
    ...
    Plasma::gDebugDraw->Add(Plasma::Debug::Line(start, end).Color(Color::Yellow).OnTop(true));
