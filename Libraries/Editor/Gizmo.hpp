...
public:
  /// Meta Initialization.
  LightningDeclareType(GizmoEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GizmoRayTestEvent, TypeCopyMode::ReferenceType);
  /// Constructor.
  GizmoRayTestEvent();
...
public:
  /// Meta Initialization.
  LightningDeclareType(Gizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(GizmoSpace, TypeCopyMode::ReferenceType);
