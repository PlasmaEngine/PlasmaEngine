...
{
public:
  typedef AnimationButton LightningSelf;
...
{
public:
  typedef AnimationSelector LightningSelf;
...
{
public:
  typedef AnimationToolBox LightningSelf;
...
{
public:
  typedef PlayControls LightningSelf;
...
{
public:
  typedef AnimationControls LightningSelf;
