...
public:
  /// Meta
  LightningDeclareType(HeightMapSubTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(HeightManipulationTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(RaiseLowerTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(SmoothSharpenTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(FlattenTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(CreateDestroyTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta
  LightningDeclareType(WeightPainterTool, TypeCopyMode::ReferenceType);
...
{
public:
  typedef HeightMapMouseCapture LightningSelf;
...
public:
  /// Meta Initialization.
  LightningDeclareType(HeightMapTool, TypeCopyMode::ReferenceType);
