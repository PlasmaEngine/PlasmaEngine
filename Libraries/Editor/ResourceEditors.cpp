...
LightningDefineType(ResourceEditors, builder, type)
{
}
...
{
  Editors[LightningTypeId(Archetype)] = EditArchetype;
  Editors[LightningTypeId(Level)] = EditLevel;
  Editors[LightningTypeId(DocumentResource)] = EditDocumentResource;
  Editors[LightningTypeId(SampleCurve)] = EditSampleCurve;
  Editors[LightningTypeId(ColorGradient)] = EditColorGradient;
  Editors[LightningTypeId(CollisionTable)] = EditCollisionTable;
  Editors[LightningTypeId(ResourceTable)] = EditResourceTable;
  Editors[LightningTypeId(MultiConvexMesh)] = EditMultiConvexMesh;
  Editors[LightningTypeId(Animation)] = EditAnimation;
  Editors[LightningTypeId(SpriteSource)] = EditSpriteSource;
}
