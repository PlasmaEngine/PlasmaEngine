...
// Declare the meta
LightningDefineType(GridDraw, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindFieldProperty(mCellSize);
  LightningBindFieldProperty(mLines);
  LightningBindFieldProperty(mHighlightInterval);

  LightningBindFieldProperty(mGridColor);
  LightningBindFieldProperty(mGridHighlight);
  LightningBindFieldProperty(mHalfCellOffset);
  LightningBindFieldProperty(mDrawAxisOrigins);
  LightningBindFieldProperty(mAlwaysDrawInEditor);
  LightningBindFieldProperty(mDrawInGame);
  LightningBindFieldProperty(mFollowEditorCamera);
}
