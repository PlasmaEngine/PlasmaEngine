...
{
public:
  SurfaceImpl(Plasma::Widget* widget);
  ...
  void MakeViewNode(Plasma::PrimitiveType::Enum primitive, StringParam textureName);
  void MakeViewNode(Plasma::PrimitiveType::Enum primitive, Plasma::Texture* texture);

  Plasma::Widget* mWidget;

  Plasma::ViewBlock* mViewBlock;
  Plasma::FrameBlock* mFrameBlock;
  Plasma::ViewNode* mViewNode;
  Plasma::Vec4 mColor;
  Plasma::WidgetRect mClipRect;
  Plasma::WidgetRect mBaseRect;
