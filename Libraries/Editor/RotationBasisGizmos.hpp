...
{
public:
  LightningDeclareType(RotationBasisGizmoInitializationEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RotationBasisGizmoAabbQueryEvent, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(RotationBasisGizmoMetaTransform, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RotationBasisGizmo, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(OrientationBasisGizmo, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PhysicsCarWheelBasisGizmo, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RevoluteBasisGizmo, TypeCopyMode::ReferenceType);
