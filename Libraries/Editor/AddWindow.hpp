...
{
public:
  LightningDeclareType(PostAddResourceEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AddResourceWindow, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ResourceTypeSearch, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ResourceTemplateSearch, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ResourceTemplateDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ImportButton, TypeCopyMode::ReferenceType);
