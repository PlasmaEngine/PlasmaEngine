...
{
public:
  LightningDeclareType(SpringSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(DragSelectSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SelectorSpringSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PointMassSelectorSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AnchoringSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PointSelectorSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpringSelectorSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpringCreatorSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RopeCreatorSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpringPointProxy, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpringPointProxyProperty, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpringTools, TypeCopyMode::ReferenceType);
