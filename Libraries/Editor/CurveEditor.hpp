...
public:
  /// Typedefs
  typedef CurveEditor LightningSelf;
...
{
public:
  typedef CurveEditorToolbar LightningSelf;
...
private:
  friend class Plasma::CurveEditor;
...
public:
  /// Meta Initialization.
  LightningDeclareType(Draggable, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ControlPoint, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(Tangent, TypeCopyMode::ReferenceType);
