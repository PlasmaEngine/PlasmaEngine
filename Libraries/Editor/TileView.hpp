...
{
public:
  LightningDeclareType(TileViewEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TileViewWidget, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TileView, TypeCopyMode::ReferenceType);
