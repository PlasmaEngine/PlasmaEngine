...
public:
  /// Meta Initialization.
  LightningDeclareType(TranslateGizmoUpdateEvent, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ScaleGizmoUpdateEvent, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(RotateGizmoUpdateEvent, TypeCopyMode::ReferenceType);
...
///   but only on non-plasma drag-axis(axes) values.
/// </param>
...
///   non-plasma drag-axis(axes) values.
/// </param>
...
public:
  /// Meta Initialization.
  LightningDeclareType(SimpleGizmoBase, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(SquareGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ArrowGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(RingGizmoEvent, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(RingGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(TranslateGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ScaleGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(RotateGizmo, TypeCopyMode::ReferenceType);
