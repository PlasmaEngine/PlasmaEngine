...
{
public:
  LightningDeclareType(TextEditorEvent, TypeCopyMode::ReferenceType);
  char Added;
};
...
DeclareEnum7(Lexer, Text, Cpp, Python, Console, Shader, Lightning, SpirV);
...
{
public:
  LightningDeclareType(TextEditor, TypeCopyMode::ReferenceType);
