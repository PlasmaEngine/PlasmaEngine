...
{
public:
  LightningDeclareType(SpriteFrame, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpritePreview, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpriteSourceEditor, TypeCopyMode::ReferenceType);
