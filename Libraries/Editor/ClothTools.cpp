...
LightningDefineType(SpringSubTool, builder, type)
{
...
LightningDefineType(DragSelectSubTool, builder, type)
{
}
...
void DragSelectSubTool::OnMouseDragMove(ViewportMouseEvent* e)
{
  ...
  // can't cast a frustum of plasma size
...
LightningDefineType(SelectorSpringSubTool, builder, type)
{
}
...
LightningDefineType(PointMassSelectorSubTool, builder, type)
{
}
...
LightningDefineType(AnchoringSubTool, builder, type)
{
  LightningBindFieldProperty(mDrawAnchoredPoints);
  LightningBindFieldProperty(mAnchoredPointMassColor);
}
...
LightningDefineType(PointSelectorSubTool, builder, type)
{
}
...
LightningDefineType(SpringSelectorSubTool, builder, type)
{
}
...
LightningDefineType(SpringCreatorSubTool, builder, type)
{
}
...
LightningDefineType(RopeCreatorSubTool, builder, type)
{
  LightningBindFieldProperty(mNumberOfLinks);
}
...
LightningDefineType(SpringPointProxy, builder, type)
{
  type->HandleManager = LightningManagerId(PointerManager);

  LightningBindGetterSetterProperty(Fixed);
  LightningBindGetterSetterProperty(Anchor);
  LightningBindGetterSetterProperty(Mass);
}
...
LightningDefineType(SpringPointProxyProperty, builder, type)
{
  type->HandleManager = LightningManagerId(PointerManager);
}
...
LightningDefineType(SpringTools, builder, type)
{
  ...
  LightningBindGetterSetterProperty(CurrentSubToolType)->AddAttribute(PropertyAttributes::cInvalidatesObject);
  LightningBindFieldProperty(mCurrentSubTool);
}
