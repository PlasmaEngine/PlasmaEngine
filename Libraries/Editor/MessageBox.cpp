...
LightningDefineType(MessageBoxEvent, builder, type)
{
}
...
MessageBox* MessageBox::Show(StringParam caption, StringParam text, const cstr buttons[])
{
  ...
  Composite* composite = PL::gEditor->GetRootWidget();
...
Plasma::MessageBox* MessageBox::Show(Composite* parent, StringParam caption, StringParam text, Array<String>& buttons)
{
  MessageBox* dialog = new MessageBox(parent, caption, text, buttons);
