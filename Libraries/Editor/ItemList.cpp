...
// Item Selector
LightningDefineType(ItemList, builder, type)
{
}
...
void ItemList::Sort()
{
  ...
  Plasma::Sort(mSortedItems.All(), SortItem());
...
// Weighted Composite
LightningDefineType(WeightedComposite, builder, type)
{
}
...
// Item Group
LightningDefineType(ItemGroup, builder, type)
{
}
...
void ItemGroup::Sort()
{
  ...
  // Sort our array
  Plasma::Sort(mItems.All(), SortGroup());
...
// Item
LightningDefineType(Item, builder, type)
{
}
