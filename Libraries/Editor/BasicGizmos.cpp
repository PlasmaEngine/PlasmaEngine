...
LightningDefineType(TranslateGizmoUpdateEvent, builder, type)
{
  LightningBindFieldProperty(mGizmoWorldTranslation);
}
...
LightningDefineType(ScaleGizmoUpdateEvent, builder, type)
{
  LightningBindFieldProperty(mGizmoWorldScale);
}
...
LightningDefineType(RotateGizmoUpdateEvent, builder, type)
{
  LightningBindFieldProperty(mGizmoRotation);
  LightningBindFieldProperty(mGizmoWorldRotationAxis);
}
...
LightningDefineType(SimpleGizmoBase, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindSetup(SetupMode::DefaultSerialization);
  PlasmaBindTag(Tags::Gizmo);
  PlasmaBindDocumented();

  PlasmaBindDependency(Transform);
  PlasmaBindDependency(Gizmo);

  LightningBindFieldProperty(mMouseInput);
  LightningBindFieldProperty(mPickingPriority);
  LightningBindFieldProperty(mColor);
  LightningBindFieldProperty(mHoverColor);
  LightningBindFieldProperty(mViewScaled);
  LightningBindFieldProperty(mUseParentAsViewScaleOrigin);
  LightningBindFieldProperty(mDrawOnTop);
}
...
LightningDefineType(SquareGizmo, builder, type)
{
  PlasmaBindComponent();
  LightningBindFieldProperty(mSize);
  LightningBindFieldProperty(mSnapDistance);
  LightningBindFieldProperty(mViewAligned);
  LightningBindFieldProperty(mBordered);
  LightningBindFieldProperty(mFilled);
}
...
LightningDefineType(ArrowGizmo, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindFieldProperty(mHeadType);
  LightningBindFieldProperty(mDualHeads);
  LightningBindFieldProperty(mFilledHeads);
  LightningBindFieldProperty(mLineDrawWidth);
}
...
LightningDefineType(RingGizmoEvent, builder, type)
{
  LightningBindFieldProperty(mWorldRotation);
  LightningBindFieldProperty(mWorldRotationAxis);
  LightningBindFieldProperty(mRadiansAroundAxis);
  LightningBindFieldProperty(mDeltaRadiansAroundAxis);
...
LightningDefineType(RingGizmo, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindFieldProperty(mBackShade);
  LightningBindFieldProperty(mViewAligned);

  LightningBindFieldProperty(mGrabArrowColor);
  LightningBindFieldProperty(mGrabArrowLength);
  LightningBindFieldProperty(mGrabArrowHeadSize);
  LightningBindFieldProperty(mGrabArrowViewScaled);
  LightningBindFieldProperty(mGrabArrowOnTop);

  PlasmaBindEvent(Events::RingGizmoModified, RingGizmoEvent);
}
...
LightningDefineType(TranslateGizmo, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindSetup(SetupMode::DefaultSerialization);
  PlasmaBindTag(Tags::Gizmo);
  ...
  PlasmaBindEvent(Events::TranslateGizmoModified, TranslateGizmoUpdateEvent);

  LightningBindFieldProperty(mUpdateMode);
  LightningBindGetterSetterProperty(Snapping);
  LightningBindFieldProperty(mSnapMode);
  LightningBindFieldProperty(mSnapDistance);
}
...
LightningDefineType(ScaleGizmo, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindSetup(SetupMode::DefaultSerialization);
  PlasmaBindTag(Tags::Gizmo);
  ...
  PlasmaBindEvent(Events::ScaleGizmoModified, ScaleGizmoUpdateEvent);
...
LightningDefineType(RotateGizmo, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindSetup(SetupMode::DefaultSerialization);
  PlasmaBindTag(Tags::Gizmo);
  ...
  PlasmaBindEvent(Events::RotateGizmoModified, RotateGizmoUpdateEvent);

  LightningBindGetterSetterProperty(Snapping);
  LightningBindFieldProperty(mSnapAngle);
}
