...
LightningDefineType(GizmoRayTestEvent, builder, type)
{
}
...
LightningDefineType(GizmoEvent, builder, type)
{
  LightningBindGetterProperty(Gizmo);
  LightningBindFieldGetter(mSource);
...
LightningDefineType(Gizmo, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindFieldProperty(mForwardEventsToChildren);
  LightningBindGetterProperty(EditingObject);
  LightningBindGetterProperty(MouseOver);

  PlasmaBindEvent(Events::MouseEnterGizmo, GizmoEvent);
  PlasmaBindEvent(Events::MouseEnterGizmoHierarchy, GizmoEvent);
  PlasmaBindEvent(Events::MouseExitGizmo, GizmoEvent);
  PlasmaBindEvent(Events::MouseExitGizmoHierarchy, GizmoEvent);
...
LightningDefineType(GizmoSpace, builder, type)
{
  PlasmaBindComponent();
  PlasmaBindEvent(Events::GizmoTargetSet, ObjectEvent);
