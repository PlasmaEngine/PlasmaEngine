...
{
public:
  LightningDeclareType(TileEditor2DSubTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TileEditor2DDrawTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TileEditor2DSelectTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(TileEditor2D, TypeCopyMode::ReferenceType);
