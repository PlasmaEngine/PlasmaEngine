...
{
public:
  typedef CollisionMatrixItem LightningSelf;
...
{
public:
  typedef CollisionGroupLabel LightningSelf;
...
{
public:
  typedef CollisionTableMatrix LightningSelf;
...
{
public:
  typedef CollisionTableEditor LightningSelf;
