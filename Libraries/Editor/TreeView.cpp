...
LightningDefineType(TreeEvent, builder, type)
{
}

LightningDefineType(TreeViewHeaderAddedEvent, builder, type)
{
}
...
LightningDefineType(TreeRow, builder, type)
{
}
...
void TreeRow::OnMetaDrop(MetaDropEvent* event)
{
  ...
  // Dropped on the Row
  if (event->Instance.StoredType->IsA(LightningTypeId(TreeRow)))
  {
    // Do not drop on self
...
LightningDefineType(TreeView, builder, type)
{
}
...
void TreeView::ShowRow(DataIndex& index)
{
  ...
  Plasma::TreeRow* dataRow = FindRowByIndex(index);
