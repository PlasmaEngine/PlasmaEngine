...
{
public:
  LightningDeclareType(TextUpdatedEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(FormattedInPlaceText, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(InPlaceTextEditor, TypeCopyMode::ReferenceType);
...
public:
  ...
  /// Meta Initialization.
  LightningDeclareType(ValueEditorFactory, TypeCopyMode::ReferenceType);
