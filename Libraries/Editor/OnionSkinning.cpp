...
void OnionSkinning::Update()
{
  ...
  bool translationApplied = ApplyTrack(LightningTypeId(Transform), "Translation");
  ...
  ApplyTrack(LightningTypeId(Transform), "Rotation");
  ApplyTrack(LightningTypeId(Transform), "Scale");
}
