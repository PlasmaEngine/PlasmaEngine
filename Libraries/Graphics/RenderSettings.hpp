...
{
public:
  LightningDeclareType(ShaderInputs, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GraphicsBlendSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GraphicsDepthSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GraphicsRenderSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ColorTargetMrt, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(BlendSettingsMrt, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MultiRenderTarget, TypeCopyMode::ReferenceType);
