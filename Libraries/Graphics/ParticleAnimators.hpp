...
{
public:
  LightningDeclareType(LinearParticleAnimator, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleWander, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleColorAnimator, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleAttractor, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleTwister, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleCollisionPlane, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleCollisionHeightmap, TypeCopyMode::ReferenceType);
