...
LightningDefineType(ResourceListEvent, builder, type)
{
...
LightningDefineType(RenderGroupList, builder, type)
{
...
LightningDefineType(ChildRenderGroupList, builder, type)
{
}
...
LightningDefineType(MaterialList, builder, type)
{
  PlasmaBindDocumented();
