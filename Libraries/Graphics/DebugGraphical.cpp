...
namespace Plasma
{
    LightningDefineType(DebugGraphical, builder, type)
    {
    ...
    LightningDefineType(DebugGraphicalPrimitive, builder, type)
    {
        PlasmaBindComponent();
        type->AddAttribute(ObjectAttributes::cHidden);
    }
    ...
    void DebugGraphicalPrimitive::ExtractViewData(ViewNode& viewNode, ViewBlock& viewBlock, FrameBlock& frameBlock)
    {
        ...
        viewNode.mLastLocalToView = Mat4::cIdentity;
        ...
        forRange(Debug::Vertex& vertex, vertices.All())
        {
            ...
            streamed.mPosition = TransformPoint(viewBlock.mWorldToView, vertex.mPosition);
    ...
    LightningDefineType(DebugGraphicalThickLine, builder, type)
    {
        PlasmaBindComponent();
        type->AddAttribute(ObjectAttributes::cHidden);
    }
    ...
    LightningDefineType(DebugGraphicalText, builder, type)
    {
        PlasmaBindComponent();
        type->AddAttribute(ObjectAttributes::cHidden);
    }
    ...
    void DebugGraphicalText::ExtractViewData(ViewNode& viewNode, ViewBlock& viewBlock, FrameBlock& frameBlock)
    {
        ...
        forRange(Debug::DebugDrawObjectAny& debugObject, mDebugObjects.All())
        {
            Debug::Text* debugText = static_cast<Debug::Text*>(&*debugObject);
            ...
            if (debugText->GetViewAligned())
                rotation = ToMatrix3(viewBlock.mWorldToView).Transposed();
            ...
            Mat4 localToView =
                ...
                Math::BuildTransform(debugText->mPosition, rotation, Vec3(1, 1, 1) * viewScale);
