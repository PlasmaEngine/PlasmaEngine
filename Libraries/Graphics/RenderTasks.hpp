...
{
public:
  LightningDeclareType(GraphicalRangeInterface, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SubRenderGroupPass, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RenderTasksEvent, TypeCopyMode::ReferenceType);
