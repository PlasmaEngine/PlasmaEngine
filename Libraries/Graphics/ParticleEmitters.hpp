...
{
public:
  LightningDeclareType(SphericalParticleEmitter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(BoxParticleEmitter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MeshParticleEmitter, TypeCopyMode::ReferenceType);
