...
PlasmaLightningShaderGlslBackend::PlasmaLightningShaderGlslBackend()
{
  mTargetVersion = 150;
  mTargetGlslEs = false;
}

String PlasmaLightningShaderGlslBackend::GetExtension()
{
  return "glsl";
}

bool PlasmaLightningShaderGlslBackend::RunTranslationPass(ShaderTranslationPassResult& inputData,
...
String PlasmaLightningShaderGlslBackend::GetErrorLog()
{
  return mErrorLog;
}
