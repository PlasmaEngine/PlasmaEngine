...
{
public:
  LightningDeclareType(KeyFrameEvent, TypeCopyMode::ReferenceType);
  KeyFrame* mKeyFrame;
};
...
{
public:
  LightningDeclareType(TrackEvent, TypeCopyMode::ReferenceType);
  TrackNode* mTrack;
};
...
{
public:
  LightningDeclareType(TrackNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RichAnimation, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RichAnimationBuilder, TypeCopyMode::ReferenceType);
