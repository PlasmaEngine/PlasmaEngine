...
{
public:
  LightningDeclareType(ContentComponent, TypeCopyMode::ReferenceType);
  ContentComponent(){};
...
{
public:
  LightningDeclareType(ContentMetaComposition, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContentComposition, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(BuilderComponent, TypeCopyMode::ReferenceType);
  // ContentComponent Interface
