...
{
public:
  LightningDeclareType(ContentCopyright, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContentHistory, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContentNotes, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ContentEditorOptions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ResourceTemplate, TypeCopyMode::ReferenceType);
