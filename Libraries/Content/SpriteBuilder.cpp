...
LightningDefineType(SpriteSourceBuilder, builder, type)
{
  PlasmaBindDependency(ImageContent);

  LightningBindFieldProperty(OriginX);
  LightningBindFieldProperty(OriginY);

  LightningBindFieldProperty(Looping);

  LightningBindFieldProperty(Sampling);
  LightningBindFieldProperty(PixelsPerUnit);

  LightningBindGetterSetterProperty(Fill);
...
LightningDefineType(SpriteData, builder, type)
{
