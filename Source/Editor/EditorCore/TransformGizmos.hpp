...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectTransformGizmoEvent, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectTransformGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectTranslateGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectScaleGizmo, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectRotateGizmo, TypeCopyMode::ReferenceType);
