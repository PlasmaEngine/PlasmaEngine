...
{
public:
  LightningDeclareType(ItemList, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(WeightedComposite, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ItemGroup, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Item, TypeCopyMode::ReferenceType);
