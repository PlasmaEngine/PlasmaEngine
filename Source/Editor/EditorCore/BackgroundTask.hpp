...
{
public:
  LightningDeclareType(BackgroundTaskEvent, TypeCopyMode::ReferenceType);
...
protected:
  ...
  /// Sends a given event to the PL::gBackgroundTasks object on the main thread.
...
{
public:
  typedef BackgroundTask LightningSelf;
  /// Constructor.
...
public:
  // Meta Initialization
  LightningDeclareType(BackgroundTasks, TypeCopyMode::ReferenceType);
