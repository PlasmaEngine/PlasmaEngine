...
{
public:
  LightningDeclareType(MultiConvexMeshPoint, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(MultiConvexMeshPropertyViewInfo, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MultiConvexMeshEditor, TypeCopyMode::ReferenceType);
