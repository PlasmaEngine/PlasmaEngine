...
{
public:
  typedef SearchableResourceTextBox LightningSelf;
...
{
public:
  typedef WeightedTableBar LightningSelf;
...
{
public:
  typedef ResourceWeightedTableView LightningSelf;
...
{
public:
  typedef ResourceTableTreeView LightningSelf;
...
{
public:
  typedef ResourceTableEditor LightningSelf;
