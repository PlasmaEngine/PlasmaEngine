...
LightningDefineType(CogCommand, builder, type)
{
}
...
LightningDefineType(CogCommandManager, builder, type)
{
}
...
Space* CogCommandManager::GetSpace()
{
  ...
  {
    if (PL::gEditor->mEditGame != nullptr)
    {
    ...
    {
      mCommandSpace = PL::gFactory->CreateSpace(CoreArchetypes::DefaultSpace, CreationFlags::Default, nullptr);
    }
  }
