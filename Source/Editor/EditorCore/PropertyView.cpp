...
LightningDefineType(PropertyView, builder, type)
{
  LightningBindOverloadedMethod(SetObject, LightningInstanceOverload(void, Object*));
  LightningBindMethod(Refresh);
  LightningBindMethod(Invalidate);
  LightningBindMethod(ActivateAutoUpdate);
}
