...
public:
  ...
  /// Meta Initialization.
  LightningDeclareType(SelectTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(CreationTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ObjectConnectingTool, TypeCopyMode::ReferenceType);
...
public:
  /// Meta Initialization.
  LightningDeclareType(ParentingTool, TypeCopyMode::ReferenceType);
