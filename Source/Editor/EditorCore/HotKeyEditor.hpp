...
{
public:
  LightningDeclareType(HotKeyCommands, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(HotKeyEditor, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(HotKeyBinding, TypeCopyMode::ReferenceType);
