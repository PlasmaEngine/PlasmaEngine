...
{
public:
  LightningDeclareType(TreeEvent, TypeCopyMode::ReferenceType);
  TreeRow* Row;
};
...
{
  LightningDeclareType(TreeViewHeaderAddedEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TreeRow, TypeCopyMode::ReferenceType);
...
{
public:
  typedef ColumnHeader LightningSelf;
...
{
public:
  typedef ColumnResizer LightningSelf;
...
{
public:
  LightningDeclareType(TreeView, TypeCopyMode::ReferenceType);
