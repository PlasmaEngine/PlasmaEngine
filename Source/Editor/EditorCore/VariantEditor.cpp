...
// Initialization
LightningDefineType(TextUpdatedEvent, builder, type)
{
  LightningBindField(mChangeAccepted);
}

Plasma::Object* TextUpdatedEvent::GetSource()
{
  return mSource;
}

LightningDefineType(FormattedInPlaceText, builder, type)
{
  LightningBindDefaultCopyDestructor();
}

LightningDefineType(InPlaceTextEditor, builder, type)
{
}
...
{
  if (variant.StoredType == LightningTypeId(FormattedInPlaceText))
  {
...
{
public:
  typedef ResourceDisplay LightningSelf;
...
{
public:
  typedef IconDisplay LightningSelf;
...
{
public:
  typedef BooleanEditor LightningSelf;
...
LightningDefineType(ValueEditorFactory, builder, type)
{
}
