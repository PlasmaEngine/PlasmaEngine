...
{
public:
  LightningDeclareType(ValueEvent, TypeCopyMode::ReferenceType);
  Any NewValue;
  uint UserData;
};
...
{
public:
  LightningDeclareType(ObjectPollEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(DirectProperty, TypeCopyMode::ReferenceType);
