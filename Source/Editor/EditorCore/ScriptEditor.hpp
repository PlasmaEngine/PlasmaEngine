...
{
public:
  LightningDeclareType(DocumentEditor, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AutoCompletePopUp, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CallTipPopUp, TypeCopyMode::ReferenceType);
...
{
public:
  typedef ScriptEditor LightningSelf;
  typedef DocumentEditor LightningBase;
  ...
  void HideToolTip();
  bool GetCompletePlasmaConnectInfo(String& eventNameOut, String& indentOut, int& functionPositionOut);
  bool CanCompletePlasmaConnect();
  bool AutoCompletePlasmaConnect();
