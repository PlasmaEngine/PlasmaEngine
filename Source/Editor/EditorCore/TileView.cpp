...
LightningDefineType(TileViewWidget, builder, type)
{
}

LightningDefineType(TileView, builder, type)
{
}

LightningDefineType(TileViewEvent, builder, type)
{
}
...
Plasma::TileViewWidget* TileView::FindTileByIndex(DataIndex& index)
{
