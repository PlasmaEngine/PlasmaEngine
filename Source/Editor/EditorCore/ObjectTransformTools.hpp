...
{
public:
  LightningDeclareType(ToolGizmoEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GizmoCreator, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectTransformTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectTranslateTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectScaleTool, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectRotateTool, TypeCopyMode::ReferenceType);
