...
#include "Core/Engine/ThreadDispatch.hpp"
#include "Core/Engine/Tweakables.hpp"
#include "Core/Engine/SystemObjectManager.hpp"
...
LightningDefineType(BackgroundTaskEvent, builder, type)
{
}
...
{
  PL::gDispatch->Dispatch(PL::gBackgroundTasks, eventId, e);
}
...
LightningDefineType(BackgroundTasks, builder, type)
{
