...
class LinkInbox
{
  ...
  /// Channel Data
  InMessageChannel mCustomDefaultChannel;   /// Incoming default (plasma) custom message channel
  InMessageChannel mProtocolDefaultChannel; /// Incoming default (plasma) protocol
                                            /// message channel
  ArraySet<InMessageChannel> mChannels;     /// Incoming (non-plasma) message channels
