...
LightningDefineType(BitStreamExtended, builder, type)
{
  ...
  LightningBindMethod(MeasureBoolean);

  LightningBindMethod(MeasureInteger);
  LightningBindMethod(MeasureDoubleInteger);
  LightningBindMethod(MeasureInteger2);
  LightningBindMethod(MeasureInteger3);
  LightningBindMethod(MeasureInteger4);

  LightningBindMethod(MeasureReal);
  LightningBindMethod(MeasureDoubleReal);
  LightningBindMethod(MeasureReal2);
  LightningBindMethod(MeasureReal3);
  LightningBindMethod(MeasureReal4);
  LightningBindMethod(MeasureQuaternion);

  LightningBindOverloadedMethod(MeasureString, LightningStaticOverload(Bits));
  LightningBindOverloadedMethod(MeasureString, LightningStaticOverload(Bits, StringParam));

  // Bind measure half operations
  LightningBindMethod(MeasureRealHalf);
  LightningBindMethod(MeasureReal2Half);
  LightningBindMethod(MeasureReal3Half);
  LightningBindMethod(MeasureReal4Half);

  // Bind measure quantized operations
  LightningBindOverloadedMethod(MeasureIntegerQuantized, LightningStaticOverload(Bits, int, int));
  LightningBindOverloadedMethod(MeasureIntegerQuantized, LightningStaticOverload(Bits, int, int, int));

  LightningBindOverloadedMethod(MeasureDoubleIntegerQuantized, LightningStaticOverload(Bits, s64, s64));
  LightningBindOverloadedMethod(MeasureDoubleIntegerQuantized, LightningStaticOverload(Bits, s64, s64, s64));

  LightningBindOverloadedMethod(MeasureInteger2Quantized,
                            LightningStaticOverload(Bits, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(
      MeasureInteger2Quantized,
      LightningStaticOverload(Bits, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(MeasureInteger3Quantized,
                            LightningStaticOverload(Bits, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(
      MeasureInteger3Quantized,
      LightningStaticOverload(Bits, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(MeasureInteger4Quantized,
                            LightningStaticOverload(Bits, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(
      MeasureInteger4Quantized,
      LightningStaticOverload(Bits, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));

  LightningBindOverloadedMethod(MeasureRealQuantized, LightningStaticOverload(Bits, float, float));
  LightningBindOverloadedMethod(MeasureRealQuantized, LightningStaticOverload(Bits, float, float, float));

  LightningBindOverloadedMethod(MeasureDoubleRealQuantized, LightningStaticOverload(Bits, double, double));
  LightningBindOverloadedMethod(MeasureDoubleRealQuantized, LightningStaticOverload(Bits, double, double, double));

  LightningBindOverloadedMethod(MeasureReal2Quantized,
                            LightningStaticOverload(Bits, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(
      MeasureReal2Quantized,
      LightningStaticOverload(Bits, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(MeasureReal3Quantized,
                            LightningStaticOverload(Bits, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(
      MeasureReal3Quantized,
      LightningStaticOverload(Bits, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(MeasureReal4Quantized,
                            LightningStaticOverload(Bits, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(
      MeasureReal4Quantized,
      LightningStaticOverload(Bits, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));

  // Bind write operations
  LightningBindMethod(WriteBoolean);

  LightningBindMethod(WriteInteger);
  LightningBindMethod(WriteDoubleInteger);
  LightningBindMethod(WriteInteger2);
  LightningBindMethod(WriteInteger3);
  LightningBindMethod(WriteInteger4);

  LightningBindMethod(WriteReal);
  LightningBindMethod(WriteDoubleReal);
  LightningBindMethod(WriteReal2);
  LightningBindMethod(WriteReal3);
  LightningBindMethod(WriteReal4);
  LightningBindMethod(WriteQuaternion);

  LightningBindMethod(WriteString);

  // Bind write half operations
  LightningBindMethod(WriteRealHalf);
  LightningBindMethod(WriteReal2Half);
  LightningBindMethod(WriteReal3Half);
  LightningBindMethod(WriteReal4Half);

  // Bind write quantized operations
  LightningBindOverloadedMethod(WriteIntegerQuantized, LightningInstanceOverload(void, int, int, int));
  LightningBindOverloadedMethod(WriteIntegerQuantized, LightningInstanceOverload(void, int, int, int, int));

  LightningBindOverloadedMethod(WriteDoubleIntegerQuantized, LightningInstanceOverload(void, s64, s64, s64));
  LightningBindOverloadedMethod(WriteDoubleIntegerQuantized, LightningInstanceOverload(void, s64, s64, s64, s64));

  LightningBindOverloadedMethod(
      WriteInteger2Quantized,
      LightningInstanceOverload(void, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(
      WriteInteger2Quantized,
      LightningInstanceOverload(
          void, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(
      WriteInteger3Quantized,
      LightningInstanceOverload(void, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(
      WriteInteger3Quantized,
      LightningInstanceOverload(
  ...
  LightningBindOverloadedMethod(
      ...
      LightningInstanceOverload(void, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(
      WriteInteger4Quantized,
      LightningInstanceOverload(
          void, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));

  LightningBindOverloadedMethod(WriteRealQuantized, LightningInstanceOverload(void, float, float, float));
  LightningBindOverloadedMethod(WriteRealQuantized, LightningInstanceOverload(void, float, float, float, float));

  LightningBindOverloadedMethod(WriteDoubleRealQuantized, LightningInstanceOverload(void, double, double, double));
  LightningBindOverloadedMethod(WriteDoubleRealQuantized, LightningInstanceOverload(void, double, double, double, double));

  LightningBindOverloadedMethod(
      WriteReal2Quantized,
      LightningInstanceOverload(void, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(
      WriteReal2Quantized,
      LightningInstanceOverload(
  ...
  LightningBindOverloadedMethod(
      WriteReal3Quantized,
      LightningInstanceOverload(void, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(
      WriteReal3Quantized,
      LightningInstanceOverload(
  ...
  LightningBindOverloadedMethod(
      WriteReal4Quantized,
      LightningInstanceOverload(void, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(
      WriteReal4Quantized,
      LightningInstanceOverload(
  ...
  LightningBindMethod(CanReadBoolean);

  LightningBindMethod(CanReadInteger);
  LightningBindMethod(CanReadDoubleInteger);
  LightningBindMethod(CanReadInteger2);
  LightningBindMethod(CanReadInteger3);
  LightningBindMethod(CanReadInteger4);

  LightningBindMethod(CanReadReal);
  LightningBindMethod(CanReadDoubleReal);
  LightningBindMethod(CanReadReal2);
  LightningBindMethod(CanReadReal3);
  LightningBindMethod(CanReadReal4);
  LightningBindMethod(CanReadQuaternion);

  LightningBindMethod(CanReadString);

  // Bind can-read half operations
  LightningBindMethod(CanReadRealHalf);
  LightningBindMethod(CanReadReal2Half);
  LightningBindMethod(CanReadReal3Half);
  LightningBindMethod(CanReadReal4Half);

  // Bind can-read quantized operations
  LightningBindOverloadedMethod(CanReadIntegerQuantized, LightningConstInstanceOverload(bool, int, int));
  LightningBindOverloadedMethod(CanReadIntegerQuantized, LightningConstInstanceOverload(bool, int, int, int));

  LightningBindOverloadedMethod(CanReadDoubleIntegerQuantized, LightningConstInstanceOverload(bool, s64, s64));
  LightningBindOverloadedMethod(CanReadDoubleIntegerQuantized, LightningConstInstanceOverload(bool, s64, s64, s64));

  LightningBindOverloadedMethod(CanReadInteger2Quantized,
                            LightningConstInstanceOverload(bool, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(
      CanReadInteger2Quantized,
      LightningConstInstanceOverload(bool, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(CanReadInteger3Quantized,
                            LightningConstInstanceOverload(bool, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(
      CanReadInteger3Quantized,
      LightningConstInstanceOverload(bool, const Math::IntVector3&, const Math::IntVector3&, const Math::IntVector3&));

  LightningBindOverloadedMethod(CanReadInteger4Quantized,
                            LightningConstInstanceOverload(bool, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(
      CanReadInteger4Quantized,
      LightningConstInstanceOverload(bool, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));

  LightningBindOverloadedMethod(CanReadRealQuantized, LightningConstInstanceOverload(bool, float, float));
  LightningBindOverloadedMethod(CanReadRealQuantized, LightningConstInstanceOverload(bool, float, float, float));

  LightningBindOverloadedMethod(CanReadDoubleRealQuantized, LightningConstInstanceOverload(bool, double, double));
  LightningBindOverloadedMethod(CanReadDoubleRealQuantized, LightningConstInstanceOverload(bool, double, double, double));

  LightningBindOverloadedMethod(CanReadReal2Quantized,
                            LightningConstInstanceOverload(bool, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(
      CanReadReal2Quantized,
      LightningConstInstanceOverload(bool, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(CanReadReal3Quantized,
                            LightningConstInstanceOverload(bool, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(
      CanReadReal3Quantized,
      LightningConstInstanceOverload(bool, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(CanReadReal4Quantized,
                            LightningConstInstanceOverload(bool, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(
      CanReadReal4Quantized,
      LightningConstInstanceOverload(bool, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));

  // Bind read operations
  LightningBindMethod(ReadBoolean);

  LightningBindMethod(ReadInteger);
  LightningBindMethod(ReadDoubleInteger);
  LightningBindMethod(ReadInteger2);
  LightningBindMethod(ReadInteger3);
  LightningBindMethod(ReadInteger4);

  LightningBindMethod(ReadReal);
  LightningBindMethod(ReadDoubleReal);
  LightningBindMethod(ReadReal2);
  LightningBindMethod(ReadReal3);
  LightningBindMethod(ReadReal4);
  LightningBindMethod(ReadQuaternion);

  LightningBindMethod(ReadString);

  // Bind read half operations
  LightningBindMethod(ReadRealHalf);
  LightningBindMethod(ReadReal2Half);
  LightningBindMethod(ReadReal3Half);
  LightningBindMethod(ReadReal4Half);

  // Bind read quantized operations
  LightningBindOverloadedMethod(ReadIntegerQuantized, LightningConstInstanceOverload(int, int, int));
  LightningBindOverloadedMethod(ReadIntegerQuantized, LightningConstInstanceOverload(int, int, int, int));

  LightningBindOverloadedMethod(ReadDoubleIntegerQuantized, LightningConstInstanceOverload(s64, s64, s64));
  LightningBindOverloadedMethod(ReadDoubleIntegerQuantized, LightningConstInstanceOverload(s64, s64, s64, s64));

  LightningBindOverloadedMethod(
      ReadInteger2Quantized,
      LightningConstInstanceOverload(Math::IntVector2, const Math::IntVector2&, const Math::IntVector2&));
  LightningBindOverloadedMethod(
      ReadInteger2Quantized,
      LightningConstInstanceOverload(
          Math::IntVector2, const Math::IntVector2&, const Math::IntVector2&, const Math::IntVector2&));

  LightningBindOverloadedMethod(
      ReadInteger3Quantized,
      LightningConstInstanceOverload(Math::IntVector3, const Math::IntVector3&, const Math::IntVector3&));
  LightningBindOverloadedMethod(
      ReadInteger3Quantized,
      LightningConstInstanceOverload(
  ...
  LightningBindOverloadedMethod(
      ...
      LightningConstInstanceOverload(Math::IntVector4, const Math::IntVector4&, const Math::IntVector4&));
  LightningBindOverloadedMethod(
      ReadInteger4Quantized,
      LightningConstInstanceOverload(
          Math::IntVector4, const Math::IntVector4&, const Math::IntVector4&, const Math::IntVector4&));

  LightningBindOverloadedMethod(ReadRealQuantized, LightningConstInstanceOverload(float, float, float));
  LightningBindOverloadedMethod(ReadRealQuantized, LightningConstInstanceOverload(float, float, float, float));

  LightningBindOverloadedMethod(ReadDoubleRealQuantized, LightningConstInstanceOverload(double, double, double));
  LightningBindOverloadedMethod(ReadDoubleRealQuantized, LightningConstInstanceOverload(double, double, double, double));

  LightningBindOverloadedMethod(ReadReal2Quantized,
                            LightningConstInstanceOverload(Math::Vector2, const Math::Vector2&, const Math::Vector2&));
  LightningBindOverloadedMethod(
      ReadReal2Quantized,
      LightningConstInstanceOverload(Math::Vector2, const Math::Vector2&, const Math::Vector2&, const Math::Vector2&));

  LightningBindOverloadedMethod(ReadReal3Quantized,
                            LightningConstInstanceOverload(Math::Vector3, const Math::Vector3&, const Math::Vector3&));
  LightningBindOverloadedMethod(
      ReadReal3Quantized,
      LightningConstInstanceOverload(Math::Vector3, const Math::Vector3&, const Math::Vector3&, const Math::Vector3&));

  LightningBindOverloadedMethod(ReadReal4Quantized,
                            LightningConstInstanceOverload(Math::Vector4, const Math::Vector4&, const Math::Vector4&));
  LightningBindOverloadedMethod(
      ReadReal4Quantized,
      LightningConstInstanceOverload(Math::Vector4, const Math::Vector4&, const Math::Vector4&, const Math::Vector4&));

  // Bind bitstream methods
  LightningBindMethod(GetBitCapacity);
  LightningBindMethod(GetByteCapacity);

  LightningBindMethod(GetBitsWritten);
  LightningBindMethod(GetBytesWritten);

  LightningBindMethod(GetBitsUnwritten);
  LightningBindMethod(GetBytesUnwritten);

  LightningBindMethod(GetBitsRead);
  LightningBindMethod(GetBytesRead);

  LightningBindMethod(GetBitsUnread);
  LightningBindMethod(GetBytesUnread);

  LightningBindMethod(IsEmpty);
  LightningBindMethod(Reserve);
  LightningBindMethod(Clear);

  // LightningBindMethod(Unwrite);
  LightningBindMethod(SetBitsWritten);
  LightningBindMethod(SetBytesWritten);
  LightningBindMethod(ClearBitsWritten);

  LightningBindMethod(Unread);
  LightningBindMethod(SetBitsRead);
  LightningBindMethod(SetBytesRead);
  LightningBindMethod(ClearBitsRead);
...
bool BitStreamExtended::WriteEvent(Event* event)
{
  ...
  // Get event type
  BoundType* eventType = LightningVirtualTypeId(event);
  if (!eventType)
  {
    Assert(false);
    return false;
  ...
  forRange (Property* property, properties)
  {
    ...
    if (property->HasAttribute(PropertyAttributes::cNetProperty))
    {
      ...
      // Is Cog type?
      if (property->PropertyType == LightningTypeId(Cog))
      {
      ...
      // Is CogPath type?
      else if (property->PropertyType == LightningTypeId(CogPath))
      {
        // Get cog path value
