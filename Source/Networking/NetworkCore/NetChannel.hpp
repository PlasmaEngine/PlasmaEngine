...
{
public:
  LightningDeclareType(NetChannel, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(NetChannelType, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(NetChannelConfig, TypeCopyMode::ReferenceType);
