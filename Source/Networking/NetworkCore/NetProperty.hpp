...
{
public:
  LightningDeclareType(NetProperty, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(NetPropertyType, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(NetPropertyConfig, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(NetPropertyInfo, TypeCopyMode::ReferenceType);
...
#define DeclarePropertyFilterForType(typeName)                                                                         \
  ...
  {                                                                                                                    \
  public:                                                                                                              \
    LightningDeclareType(PropertyFilter##typeName, TypeCopyMode::ReferenceType);                                           \
...
{
public:
  LightningDeclareType(PropertyFilterMultiPrimitiveTypes, TypeCopyMode::ReferenceType);
  bool Filter(Member* prop, HandleParam instance) override;
};
...
{
public:
  LightningDeclareType(PropertyFilterFloatingPointTypes, TypeCopyMode::ReferenceType);
  bool Filter(Member* prop, HandleParam instance) override;
};
...
{
public:
  LightningDeclareType(PropertyFilterArithmeticTypes, TypeCopyMode::ReferenceType);
  bool Filter(Member* prop, HandleParam instance) override;
};
