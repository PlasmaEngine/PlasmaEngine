...
LightningDefineType(RevoluteJoint, builder, type)
{
  PlasmaBindComponent();
  ...
  //BindAngleAccessors();
  LightningBindGetterSetterProperty(LocalBasisA)->Add(new EditorRotationBasis("RevoluteJointBasisGizmo", "EditorRevoluteGizmoName", 0b01));
  LightningBindGetterSetterProperty(LocalBasisB)->Add(new EditorRotationBasis("RevoluteJointBasisGizmo", "EditorRevoluteGizmoName", 0b10));
  LightningBindGetterSetterProperty(WorldBasis)->Add(new EditorRotationBasis("RevoluteJointBasisGizmo", "EditorRevoluteGizmoName", 0b11));
  LightningBindGetterSetterProperty(FrameOfReference);

  LightningBindMethod(SetWorldFrame);
}
