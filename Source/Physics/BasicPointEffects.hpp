...
{
public:
  LightningDeclareType(BasicPointEffect, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PointForceEffect, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PointGravityEffect, TypeCopyMode::ReferenceType);
