...
{
  LightningDeclareType(CastFilterEvent, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(CastFilter, TypeCopyMode::ReferenceType);
...
struct CastResult
{
  LightningDeclareType(CastResult, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CastResults, TypeCopyMode::ReferenceType);
