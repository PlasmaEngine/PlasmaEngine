...
LightningDefineType(CapsuleCollider, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindGetterSetterProperty(ScalingMode);

  LightningBindGetter(WorldRadius);
  LightningBindGetter(WorldCylinderHeight);
}
