...
#define BindAnchorAccessors(defaults)                                                                                  \
  LightningBindGetterSetterProperty(LocalPointA)->PlasmaSerialize(defaults);                                                 \
  LightningBindGetterSetterProperty(LocalPointB)->PlasmaSerialize(defaults);                                                 \
  LightningBindMethod(SetWorldPoints);                                                                                     \
...
#define BindAxisAccessors(defaults)                                                                                    \
  LightningBindGetterSetterProperty(LocalAxisA)->PlasmaSerialize(defaults);                                                  \
  LightningBindGetterSetterProperty(LocalAxisB)->PlasmaSerialize(defaults);                                                  \
  LightningBindGetterSetterProperty(WorldAxis);
...
#define BindAngleAccessors()                                                                                           \
  LightningBindGetterSetterProperty(LocalBasisA);                                                                          \
  LightningBindGetterSetterProperty(LocalBasisB);
