...
struct SweepResult
{
  LightningDeclareType(SweepResult, TypeCopyMode::ReferenceType);
  ...
  Cog* GetOtherObject();
  /// The amount of overlap with this object. Will typically be plasma unless the
...
{
public:
  LightningDeclareType(PhysicsSpace, TypeCopyMode::ReferenceType);
