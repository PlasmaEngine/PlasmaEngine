...
LightningDefineType(BaseCollisionEvent, builder, type)
{
  ...
  LightningBindGetterProperty(IsGhost);
...
LightningDefineType(CollisionGroupEvent, builder, type)
{
  ...
  LightningBindGetterProperty(TypeAName);
  LightningBindGetterProperty(TypeBName);
  LightningBindGetterProperty(FirstPoint);
...
LightningDefineType(PreSolveEvent, builder, type)
{
  ...
  LightningBindGetterSetter(Restitution);
  LightningBindGetterSetter(Friction);
