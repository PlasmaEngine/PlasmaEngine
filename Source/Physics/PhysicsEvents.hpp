...
{
public:
  LightningDeclareType(BaseCollisionEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CollisionEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CollisionGroupEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PreSolveEvent, TypeCopyMode::ReferenceType);
