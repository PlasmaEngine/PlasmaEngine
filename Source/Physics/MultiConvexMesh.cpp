...
LightningDefineType(SubConvexMesh, builder, type)
{
  ...
  LightningBindGetter(Indices);
  LightningBindGetter(TriangleIndices);

  LightningBindField(mMesh);
  LightningBindFieldGetter(mValid);
}
...
LightningDefineType(MultiConvexMesh, builder, type)
{
  ...
  LightningBindGetter(Modified);
  LightningBindGetter(Valid);
  LightningBindMethod(Validate);
  LightningBindMethod(UpdateAndNotifyIfModified);
  LightningBindGetter(Vertices);
  LightningBindGetter(SubMeshes);
