...
LightningDefineType(MeshCollider, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindGetterSetterProperty(PhysicsMesh);
  LightningBindFieldProperty(mDrawEdges);
  LightningBindFieldProperty(mDrawFaces);
  LightningBindFieldProperty(mDrawFaceNormals);
}
