...
LightningDefineType(ContactPoint, builder, type)
{
  ...
  LightningBindGetterProperty(LocalPoint);
  LightningBindGetterProperty(OtherLocalPoint);
  LightningBindGetterProperty(WorldPoint);
  LightningBindGetterProperty(WorldNormalTowardsOther);
  LightningBindGetterProperty(NormalImpulse);
  LightningBindGetterProperty(FrictionImpulse);
  LightningBindGetterProperty(ComplexImpulse);
  LightningBindGetterProperty(Penetration);
  LightningBindGetterProperty(RelativeVelocity);
