...
{
  LightningDeclareType(CollisionStartBlock, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(CollisionPersistedBlock, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(CollisionEndBlock, TypeCopyMode::ReferenceType);
