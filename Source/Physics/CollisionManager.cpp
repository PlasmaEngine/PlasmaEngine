...
struct InternalImplementation
{
  ...
  // at the moment)
  Plasma::ShapeArrayLookup<Sphere> mSphereLookups;
  Plasma::ShapeArrayLookup<Aabb> mAabbLookups;
  Plasma::ShapeArrayLookup<Triangle> mTriangleLookups;

  // cast functions
  Plasma::CastArrayLookup<Ray> mRayCastLookup;
  Plasma::CastArrayLookup<Segment> mSegmentCastLookup;
  Plasma::CastArrayLookup<Aabb> mAabbCastLookup;
  Plasma::CastArrayLookup<Sphere> mSphereCastLookup;
  Plasma::CastArrayLookup<Frustum> mFrustumCastLookup;

  // specific shape overlap tests
  Plasma::OverlapArrayLookup<Vec3> mPointOverlapLookups;
  Plasma::OverlapArrayLookup<Aabb> mAabbOverlapLookups;

  // table lookups (two colliders) for boolean and manifold versions
  Plasma::CollisionTableLookup mCollisionTable;
  Plasma::OverlapTableLookup mOverlapTable;
};
