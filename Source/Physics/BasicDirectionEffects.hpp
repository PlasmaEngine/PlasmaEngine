...
{
public:
  LightningDeclareType(BasicDirectionEffect, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ForceEffect, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GravityEffect, TypeCopyMode::ReferenceType);
