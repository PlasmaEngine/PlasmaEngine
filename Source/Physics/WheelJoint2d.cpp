...
LightningDefineType(WheelJoint2d, builder, type)
{
  PlasmaBindComponent();
  ...
  BindAngleAccessors();
  LightningBindGetterSetterProperty(ShockAxis)->PlasmaSerialize(Vec3::cYAxis);
  // @MetaSerialization: Property needs to cause rescans
  LightningBindGetterSetterProperty(WorldShockAxis);
}
