...
LightningDefineType(GearJoint, builder, type)
{
  PlasmaBindComponent();
  ...
  LightningBindGetterSetterProperty(Ratio);
  LightningBindGetterSetterProperty(Constant);

  LightningBindGetterSetterProperty(JointAPath);
  LightningBindGetterSetterProperty(JointBPath);
  LightningBindGetterSetter(JointA);
  LightningBindGetterSetter(JointB);
}
