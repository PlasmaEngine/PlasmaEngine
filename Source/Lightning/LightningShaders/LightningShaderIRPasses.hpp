...
class BaseSpirVOptimizerPass : public LightningShaderIRTranslationPass
{
public:
...
/// validator.
class SpirVValidatorPass : public LightningShaderIRTranslationPass
{
public:
  SpirVValidatorPass();
...
struct SpirVFileWriterPass : public LightningShaderIRTranslationPass
{
