...
{
public:
  LightningShaderIRFunction* mFunction;
  LightningShaderIROp* mSelfParam;
  BasicBlock* mBlock;
};
...
public:
  LightningShaderIRFunction* mFunction;
  BasicBlock* mBlock;
  ILightningShaderIR* mDefaultVertexId;
  LightningShaderIROp* mOutputDataInstance;
};
...
struct ShaderInterfaceField
{
  ...
  LightningShaderIRType* mFieldType;
  ...
  LightningShaderIRType* mOriginalFieldType;
...
struct ShaderInterfaceType
{
  ...
  virtual LightningShaderIROp* GetFieldPointerByIndex(size_t index,
...
struct ShaderInterfaceStruct : public ShaderInterfaceType
{
  ...
  LightningShaderIROp* GetFieldPointerByIndex(size_t index,
                                          EntryPointGeneration* entryPointGeneration,
                                          BasicBlock* block,
  ...
  LightningShaderIROp* GetFieldPointerByIndex(LightningShaderIROp* instance,
                                          size_t index,
                                          EntryPointGeneration* entryPointGeneration,
                                          BasicBlock* block,
...
struct ShaderInterfaceGlobals : public ShaderInterfaceType
{
  ...
  Array<ShaderInterfaceField> mFields;
  Array<LightningShaderIRType*> mFieldTypes;
  Array<LightningShaderIROp*> mFieldInstances;
};
...
struct ShaderInterfaceStructArray : public ShaderInterfaceStruct
{
  ...
  LightningShaderIROp* GetPointerByIndex(ILightningShaderIR* index,
...
{
  GeometryStageInfo(LightningSpirVFrontEnd* translator, LightningShaderIRType* shaderType, Lightning::GenericFunctionNode* node);

  LightningShaderIRType* mShaderType;
  LightningShaderIRType* mInputStreamType;
  LightningShaderIRType* mOutputStreamType;
  LightningShaderIRType* mInputVertexType;
  LightningShaderIRType* mOutputVertexType;
  Lightning::GeometryStreamUserData* mInputStreamUserData;
  Lightning::GeometryStreamUserData* mOutputStreamUserData;
  // All output streams used by the entry point.
  // Each one of these needs to generate late-bound 'Append' functions.
  Array<LightningShaderIRType*> mOutputStreamTypes;
};
...
public:
  ...
  void DeclareVertexInterface(LightningSpirVFrontEnd* translator,
                              Lightning::GenericFunctionNode* node,
                              LightningShaderIRFunction* function,
                              LightningSpirVFrontEndContext* context);
  void DeclareGeometryInterface(LightningSpirVFrontEnd* translator,
                                Lightning::GenericFunctionNode* node,
                                LightningShaderIRFunction* function,
                                LightningSpirVFrontEndContext* context);
  void DeclarePixelInterface(LightningSpirVFrontEnd* translator,
                             Lightning::GenericFunctionNode* node,
                             LightningShaderIRFunction* function,
                             LightningSpirVFrontEndContext* context);
  void DeclareComputeInterface(LightningSpirVFrontEnd* translator,
                               Lightning::GenericFunctionNode* node,
                               LightningShaderIRFunction* function,
                               LightningSpirVFrontEndContext* context);
  ...
  struct GeometryInOutTypeInfo
  {
    ...
    ILightningShaderIR* mArraySize;
  };

  // Returns the self variable instance.
  void CreateEntryPointFunction(Lightning::GenericFunctionNode* node,
                                LightningShaderIRFunction* function,
                                LightningShaderIROp*& selfVarOp,
                                BasicBlock*& entryPointBlock);
  void BuildBasicEntryPoint(Lightning::GenericFunctionNode* node,
                            LightningShaderIRFunction* function,
                            LightningShaderIRFunction* copyInputsFn,
                            LightningShaderIRFunction* copyOutputsFn);
  LightningShaderIRFunction* CreateGlobalsInitializerFunction(Lightning::GenericFunctionNode* node);
  EntryPointHelperFunctionData GenerateCopyHelper(LightningShaderIRFunction* userMainFn, StringParam name);

  // Geometry Shader Stage helpers
  EntryPointHelperFunctionData GenerateGeometryCopyHelper(LightningShaderIRFunction* userMainFn,
                                                          StringParam name,
                                                          LightningShaderIRType* inputStreamType,
                                                          LightningShaderIROp*& inputStreamVar);
  void WriteGeometryStageInterface(LightningShaderIRFunction* function,
                                   GeometryStageInfo& stageInfo,
                                   EntryPointInfo* entryPointInfo,
                                   EntryPointHelperFunctionData& copyInputsData,
                                   LightningShaderIROp* copyInputsStreamVar);
  void CollectGeometryStreamTypes(LightningShaderIRFunction* function, GeometryStageInfo& stageInfo);
  ...
  LightningShaderIRFunction* CloneAppendFn(LightningShaderIRFunction* originalAppendFn);
  ...
  void CollectInterfaceVariables(LightningShaderIRFunction* function,
                                 ShaderInterfaceInfo& interfaceInfo,
                                 ShaderStage::Enum shaderStage);
  void CollectInputInterfaceVariables(LightningShaderIRFunction* function,
                                      ShaderInterfaceInfo& interfaceInfo,
                                      LightningShaderIRType* type,
                                      ShaderStage::Enum shaderStage);
  void CollectOutputInterfaceVariables(LightningShaderIRFunction* function,
                                       ShaderInterfaceInfo& interfaceInfo,
                                       LightningShaderIRType* type,
                                       ShaderStage::Enum shaderStage);
  void CollectUniformInterfaceVariables(LightningShaderIRFunction* function,
                                        ShaderInterfaceInfo& interfaceInfo,
                                        LightningShaderIRType* type,
                                        ShaderStage::Enum shaderStage);
  ...
  InterfaceInfoGroup* ProcessBuiltIn(LightningShaderIRFunction* function,
                                     ShaderInterfaceInfo& interfaceInfo,
                                     ShaderStage::Enum shaderStage,
                                     ...
                                     spv::StorageClass storageClass,
                                     StringParam name);
  InterfaceInfoGroup* ProcessUniformBlock(LightningShaderIRFunction* function,
                                          ShaderInterfaceInfo& interfaceInfo,
                                          ShaderIRFieldMeta* fieldMeta,
                                          ShaderIRAttribute* attribute,
                                          HashMap<ShaderFieldKey, UniformBufferDescription*>& mapping);
  ...
  void AddMemberTypeDecorations(LightningShaderIRType* memberType,
  ...
  void FindAndDecorateGlobals(LightningShaderIRType* currentType, EntryPointInfo* entryPointInfo);
  ...
  Lightning::BoundType* ConvertInterfaceType(Lightning::BoundType* inputType);
  ...
  // class will be used.
  LightningShaderIROp* FindField(ShaderFieldKey& fieldKey,
