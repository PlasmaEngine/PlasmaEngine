...
public:
  ...
  /// targets, etc...)
  virtual void SetSettings(LightningShaderSpirVSettingsRef& settings) = 0;
  ...
  virtual bool Translate(Lightning::SyntaxTree& syntaxTree,
                         LightningShaderIRProject* project,
                         LightningShaderIRLibrary* library) = 0;

  // An intrusive reference count for memory handling
  LightningRefLink(BaseShaderIRTranslator);
};
