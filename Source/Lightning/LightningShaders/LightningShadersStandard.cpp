...
namespace Lightning
{
	...
	LightningDefineEnum(Plasma::ImageDimension);
	LightningDefineEnum(Plasma::ImageDepthMode);
	LightningDefineEnum(Plasma::ImageArrayedMode);
	LightningDefineEnum(Plasma::ImageMultiSampledMode);
	LightningDefineEnum(Plasma::ImageSampledMode);
	LightningDefineEnum(Plasma::ImageFormat);
	LightningDefineEnum(Plasma::ImageOperands);
...
LightningDefineStaticLibrary(ShaderIntrinsicsLibrary)
{
  ...
  LightningInitializeExternalTypeAs(Plasma::ImageDimension::Enum, "ImageDimension");
  LightningInitializeExternalTypeAs(Plasma::ImageDepthMode::Enum, "ImageDepthMode");
  LightningInitializeExternalTypeAs(Plasma::ImageArrayedMode::Enum, "ImageArrayedMode");
  LightningInitializeExternalTypeAs(Plasma::ImageMultiSampledMode::Enum, "ImageMultiSampledMode");
  LightningInitializeExternalTypeAs(Plasma::ImageSampledMode::Enum, "ImageSampledMode");
  LightningInitializeExternalTypeAs(Plasma::ImageFormat::Enum, "ImageFormat");
  LightningInitializeExternalTypeAs(Plasma::ImageOperands::Enum, "ImageOperands");
