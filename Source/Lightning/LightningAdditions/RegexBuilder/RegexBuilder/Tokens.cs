...
namespace RegexBuilder
{
	...
	class Tokens
	{
		...
		const String DirectoryBase = @"..\..\..\..\Project\Lightning\";
		...
		private void OutputHpp()
		{
			...
			output.AppendLine(@"#ifndef LIGHTNING_GRAMMAR_CONSTANTS_HPP");
			output.AppendLine(@"#define LIGHTNING_GRAMMAR_CONSTANTS_HPP");
			output.AppendLine(@"");
			output.AppendLine(@"namespace Lightning");
			output.AppendLine(@"{");
			...
			output.AppendLine(@"");
			output.AppendLine(@"    // Get a list of keywords used by Lightning (typically provided for syntax highlighting)");
			output.AppendLine(@"    // If you need a list of words separated by spaces, you can use Lightning::JoinStrings");
			...
			output.AppendLine(@"");
			output.AppendLine(@"    // Get a list of keywords reserved by Lightning (these may not be used, but do nothing)");
