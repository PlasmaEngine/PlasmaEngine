#pragma once
#ifndef LIGHTNING_FILE_STREAM_HPP
#define LIGHTNING_FILE_STREAM_HPP
...
namespace Lightning
{
  ...
  class PlasmaShared FileStreamClass : public IStreamClass
  {
  public:
    LightningDeclareType(FileStreamClass, TypeCopyMode::ReferenceType);
