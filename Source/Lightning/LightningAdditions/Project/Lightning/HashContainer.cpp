...
namespace Lightning
{
  ...
  )
  {
    ...
    BoundType* pairRangeType = builder.InstantiateTemplate("HashMapRange", LightningConstants(keyType, valueType), Module()).Type;
    BoundType* keyRangeType = builder.InstantiateTemplate("HashMapKeyRange", LightningConstants(keyType), Module()).Type;
    BoundType* valueRangeType = builder.InstantiateTemplate("HashMapValueRange", LightningConstants(valueType), Module()).Type;
    ...
    LightningFullBindDestructor(builder, containerType, AnyHashMap);
    LightningFullBindConstructor(builder, containerType, AnyHashMap, nullptr);
  ...
  )
  {
    ...
    LightningFullBindDestructor(builder, rangeType, AnyHashMapRange);
    LightningFullBindConstructor(builder, rangeType, AnyHashMapRange, nullptr);
    ...
    if (templateTypes.Size() == 2)
    {
      ...
      currentType = builder.InstantiateTemplate("KeyValue", LightningConstants(keyType, valueType), Module()).Type;
    }
    else
    {
    ...
    LightningFullBindMethod(builder, rangeType, &AnyHashMapRange::MoveNext, LightningNoOverload, "MoveNext", LightningNoNames);
    LightningFullBindMethod(builder, rangeType, &AnyHashMapRange::Reset, LightningNoOverload, "Reset", LightningNoNames);
    LightningFullBindGetterSetter(builder, rangeType, &AnyHashMapRange::IsEmpty, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEmpty");
    LightningFullBindGetterSetter(builder, rangeType, &AnyHashMapRange::IsNotEmpty, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsNotEmpty");
  ...
  )
  {
    ...
    LightningFullBindDestructor(builder, keyValueType, AnyKeyValue);
