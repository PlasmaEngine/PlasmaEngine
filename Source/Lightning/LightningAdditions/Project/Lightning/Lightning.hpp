...
namespace Lightning
{
  ...
  // The user can define 'LightningDisableDocumentation' globally to disable all processing of documentation strings in Lightning (freeing up memory)
  ...
  // If the user disabled documentation at compile-time...
    ...
    // Defines a documentation string and allows users to easily disable documentation via globally defining 'LightningDisableDocumentation'
    ...
    #define LightningDocument(Member, DocumentationString) static Lightning::String Member##Documentation() { return Lightning::String(); }
  #else
    // Defines a documentation string and allows users to easily disable documentation via globally defining 'LightningDisableDocumentation'
