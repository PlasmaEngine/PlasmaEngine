...
namespace Lightning
{
  ...
  {
    type->CopyMode = PL::TypeCopyMode::ReferenceType;
  ...
  #define LightningDefineRange(RangeType)                                                                                                                       \
    LightningDefineExternalBaseType(RangeType, Lightning::TypeCopyMode::ReferenceType, builder, type)                                                                  \
    {                                                                                                                                                       \
      LightningBindDefaultCopyDestructor();                                                                                                                     \
      LightningFullBindGetterSetter(builder, type, &Lightning::RangeAdapter<LightningSelf>::All,         LightningNoOverload, LightningNoSetter, LightningNoOverload, "All"        );  \
      LightningFullBindGetterSetter(builder, type, &Lightning::RangeAdapter<LightningSelf>::Current,     LightningNoOverload, LightningNoSetter, LightningNoOverload, "Current"    );  \
      LightningFullBindGetterSetter(builder, type, &Lightning::RangeAdapter<LightningSelf>::IsNotEmpty,  LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsNotEmpty" );  \
      LightningFullBindGetterSetter(builder, type, &Lightning::RangeAdapter<LightningSelf>::IsEmpty,     LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEmpty"    );  \
      LightningFullBindMethod      (builder, type, &Lightning::RangeAdapter<LightningSelf>::MoveNext,    LightningNoOverload, "MoveNext", LightningNoNames);                       \
    }
