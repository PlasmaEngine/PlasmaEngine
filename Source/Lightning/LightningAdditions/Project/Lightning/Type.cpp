...
{
  //***************************************************************************
  LightningDefineExternalBaseType(Members::Enum, TypeCopyMode::ValueType, builder, type)
  {
    LightningFullBindEnum(builder, type, SpecialType::Flags);
    LightningFullBindEnumValue(builder, type, Members::Instance,                "Instance");
    LightningFullBindEnumValue(builder, type, Members::Static,                  "Static");
    LightningFullBindEnumValue(builder, type, Members::Inherited,               "Inherited");
    LightningFullBindEnumValue(builder, type, Members::Extension,               "Extension");
    LightningFullBindEnumValue(builder, type, Members::InstanceStatic,          "InstanceStatic");
    LightningFullBindEnumValue(builder, type, Members::InheritedInstanceStatic, "InheritedInstanceStatic");
    LightningFullBindEnumValue(builder, type, Members::InheritedInstance,       "InheritedInstance");
    LightningFullBindEnumValue(builder, type, Members::InheritedStatic,         "InheritedStatic");
    LightningFullBindEnumValue(builder, type, Members::All,                     "All");
  }

  //***************************************************************************
  LightningDefineType(Type, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);
    LightningFullBindMethod(builder, type, &Type::IsA, LightningNoOverload, "IsA", "baseType");
    LightningFullBindMethod(builder, type, &Type::IsCastableTo, LightningNoOverload, "IsCastableTo", "toType");
    LightningFullBindMethod(builder, type, &Type::IsRawCastableTo, LightningNoOverload, "IsRawCastableTo", "toType");

    LightningFullBindGetterSetter(builder, type, &Type::ToString, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Name");

    LightningFullBindGetterSetter(builder, type, &Type::IsHandle, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsHandle");
    LightningFullBindGetterSetter(builder, type, &Type::IsValue, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsValue");
    LightningFullBindGetterSetter(builder, type, &Type::IsDelegate, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsDelegate");
    LightningFullBindGetterSetter(builder, type, &Type::IsEnum, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEnum");
    LightningFullBindGetterSetter(builder, type, &Type::IsFlags, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsFlags");
    LightningFullBindGetterSetter(builder, type, &Type::IsEnumOrFlags, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEnumOrFlags");
    LightningFullBindGetterSetter(builder, type, &Type::IsAny, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsAny");

    LightningFullBindField(builder, type, &BoundType::SourceLibrary, "Library", PropertyBinding::Get);
  }
  
  //***************************************************************************
  LightningDefineType(AnyType, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);
  }
  
  //***************************************************************************
  LightningDefineType(IndirectionType, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);
    LightningFullBindField(builder, type, &IndirectionType::ReferencedType, "ReferencedType", PropertyBinding::Get);
  }
  
  //***************************************************************************
  LightningDefineType(DelegateType, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);

    LightningFullBindGetterSetter(builder, type, &DelegateType::GetSignatureString, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Signature");
    LightningFullBindGetterSetter(builder, type, &DelegateType::GetParameters, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Parameters");
    LightningFullBindField(builder, type, &DelegateType::Return, "Return", PropertyBinding::Get);
  }
  
  //***************************************************************************
  LightningDefineType(DelegateParameter, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);
    LightningFullBindField(builder, type, &DelegateParameter::Name, "Name", PropertyBinding::Get);
    LightningFullBindField(builder, type, &DelegateParameter::ParameterType, "Type", PropertyBinding::Get);
  }

  //***************************************************************************
  LightningDefineType(BoundType, builder, type)
  {
    type->HandleManager = LightningManagerId(PointerManager);
    LightningFullBindField(builder, type, &BoundType::BaseType, "BaseType", PropertyBinding::Get);
    LightningFullBindField(builder, type, &BoundType::TemplateBaseName, "TemplateBaseName", PropertyBinding::Get);
    LightningFullBindField(builder, type, &BoundType::Native, "IsNative", PropertyBinding::Get);
    LightningFullBindGetterSetter(builder, type, &BoundType::IsTypeOrBaseNative, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsTypeOrBaseNative");
    
    LightningFullBindField(builder, type, &BoundType::Destructor, "Destructor", PropertyBinding::Get);
    LightningFullBindField(builder, type, &BoundType::PreConstructor, "PreConstructor", PropertyBinding::Get);

    LightningFullBindMethod(builder, type, &BoundType::InstantiatePreConstructedObject, LightningNoOverload, "InstantiatePreConstructedObject", LightningNoNames);

    LightningFullBindGetterSetter(builder, type, &BoundType::GetGetterSetters,      (MemberRange<GetterSetter>  (BoundType::*)()), LightningNoSetter, LightningNoOverload, "GetterSetters");
    LightningFullBindGetterSetter(builder, type, &BoundType::GetFields,             (MemberRange<Field>         (BoundType::*)()), LightningNoSetter, LightningNoOverload, "Fields");
    LightningFullBindGetterSetter(builder, type, &BoundType::GetProperties,         (MemberRange<Property>      (BoundType::*)()), LightningNoSetter, LightningNoOverload, "Properties");
    LightningFullBindGetterSetter(builder, type, &BoundType::GetFunctions,          (MemberRange<Function>      (BoundType::*)()), LightningNoSetter, LightningNoOverload, "Functions");
    LightningFullBindGetterSetter(builder, type, &BoundType::GetMembers,            (MemberRange<Member>        (BoundType::*)()), LightningNoSetter, LightningNoOverload, "Members");
    LightningFullBindGetterSetter(builder, type, &BoundType::GetDefaultConstructor, (Function*                  (BoundType::*)()), LightningNoSetter, LightningNoOverload, "DefaultConstructor");

    LightningFullBindMethod(builder, type, &BoundType::GetGetterSetters,      (MemberRange<GetterSetter>  (BoundType::*)(Members::Enum)),                             "GetGetterSetters",       "options");
    LightningFullBindMethod(builder, type, &BoundType::GetProperties,         (MemberRange<Property>      (BoundType::*)(Members::Enum)),                             "GetProperties",          "options");
    LightningFullBindMethod(builder, type, &BoundType::GetFields,             (MemberRange<Field>         (BoundType::*)(Members::Enum)),                             "GetFields",              "options");
    LightningFullBindMethod(builder, type, &BoundType::GetFunctions,          (MemberRange<Function>      (BoundType::*)(Members::Enum)),                             "GetFunctions",           "options");
    LightningFullBindMethod(builder, type, &BoundType::GetFunctions,          (MemberRange<Function>      (BoundType::*)(StringParam, Members::Enum)),                "GetFunctions",           "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetMembers,            (MemberRange<Member>        (BoundType::*)(Members::Enum)),                             "GetMembers",             "options");
    LightningFullBindMethod(builder, type, &BoundType::GetGetterSetter,       (GetterSetter*              (BoundType::*)(StringParam)),                               "GetGetterSetter",        "name");
    LightningFullBindMethod(builder, type, &BoundType::GetGetterSetter,       (GetterSetter*              (BoundType::*)(StringParam, Members::Enum)),                "GetGetterSetter",        "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetGetterSetter,       (GetterSetter*              (BoundType::*)(StringParam, Type*, Members::Enum)),         "GetGetterSetter",        "name, declaredType, options");
    LightningFullBindMethod(builder, type, &BoundType::GetProperty,           (Property*                  (BoundType::*)(StringParam)),                               "GetProperty",            "name");
    LightningFullBindMethod(builder, type, &BoundType::GetProperty,           (Property*                  (BoundType::*)(StringParam, Members::Enum)),                "GetProperty",            "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetProperty,           (Property*                  (BoundType::*)(StringParam, Type*, Members::Enum)),         "GetProperty",            "name, declaredType, options");
    LightningFullBindMethod(builder, type, &BoundType::GetField,              (Field*                     (BoundType::*)(StringParam)),                               "GetField",               "name");
    LightningFullBindMethod(builder, type, &BoundType::GetField,              (Field*                     (BoundType::*)(StringParam, Members::Enum)),                "GetField",               "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetField,              (Field*                     (BoundType::*)(StringParam, Type*, Members::Enum)),         "GetField",               "name, declaredType, options");
    LightningFullBindMethod(builder, type, &BoundType::GetFunction,           (Function*                  (BoundType::*)(StringParam)),                               "GetFunction",            "name");
    LightningFullBindMethod(builder, type, &BoundType::GetFunction,           (Function*                  (BoundType::*)(StringParam, Members::Enum)),                "GetFunction",            "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetFunction,           (Function*                  (BoundType::*)(StringParam, DelegateType*, Members::Enum)), "GetFunction",            "name, signatureType, options");
    LightningFullBindMethod(builder, type, &BoundType::GetMember,             (Member*                    (BoundType::*)(StringParam)),                               "GetMember",              "name");
    LightningFullBindMethod(builder, type, &BoundType::GetMember,             (Member*                    (BoundType::*)(StringParam, Members::Enum)),                "GetMember",              "name, options");
    LightningFullBindMethod(builder, type, &BoundType::GetMember,             (Member*                    (BoundType::*)(StringParam, Type*, Members::Enum)),         "GetMember",              "name, declaredType, options");
    LightningFullBindMethod(builder, type, &BoundType::GetDefaultConstructor, (Function*                  (BoundType::*)(bool)),                                      "GetDefaultConstructor",  "inherited");
    LightningFullBindMethod(builder, type, &BoundType::GetConstructor,        (Function*                  (BoundType::*)(DelegateType*, bool)),                       "GetConstructor",         "signatureType, inherited");
  }
  ...
  bool Type::IsSame(Type* a, Type* b)
  {
    ...
    ErrorIf(result && LightningVirtualTypeId(a) != LightningVirtualTypeId(b),
  ...
  bool Type::IsRawSame(Type* a, Type* b)
  {
    ...
    Type* aType = LightningVirtualTypeId(a);
    Type* bType = LightningVirtualTypeId(b);
  ...
  bool Type::BoundIsA(BoundType* type, BoundType* base)
  {
    ...
    while (type != nullptr)
    {
      ...
      PlasmaTodo("Using the names of the BoundType to compare isn't technically correct");
  ...
  BoundType::BoundType(BoundTypeAssertFn nativeBindingAssert) :
    ...
    Size(0),
    HandleManager(LightningManagerId(HeapManager)),
  ...
  {
    // When a BoundType is created via native binding in C++, e.g. LightningTypeId(X), we want the user
  ...
  BoundType::~BoundType()
  {
    // This will only be set if this represents a native type bound with LightningDefineType, etc
    ...
    LightningForEach(SendsEvent* sendsEvent, this->SendsEvents)
    {
      delete sendsEvent;
    }
  }
  ...
  Function* BoundType::GetConstructor(DelegateType* type, bool inherited)
  {
    ...
    LightningForEach(Function* constructor, *constructors)
    {
  ...
  Function* BoundType::GetDefaultConstructor(const FunctionArray* constructors)
  {
    ...
    for (size_t i = 0; i < constructors->Size(); ++i)
    {
      ...
      ErrorIf(constructor->FunctionType->Return != LightningTypeId(void),
