...
namespace Lightning
{
  ...
  {
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectories, (String (*)(StringParam, StringParam)), "CombineDirectories", "dir0, dir1")->Description = FilePathClass::CombineDirectoriesDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectories, (String (*)(StringParam, StringParam, StringParam)), "CombineDirectories", "dir0, dir1, dir2")->Description = FilePathClass::CombineDirectoriesDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectories, (String (*)(StringParam, StringParam, StringParam, StringParam)), "CombineDirectories", "dir0, dir1, dir2, dir3")->Description = FilePathClass::CombineDirectoriesDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectories, (String (*)(StringParam, StringParam, StringParam, StringParam, StringParam)), "CombineDirectories", "dir0, dir1, dir2, dir3, dir4")->Description = FilePathClass::CombineDirectoriesDocumentation();

    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectoriesAndFile, (String (*)(StringParam, StringParam)), "CombineDirectoriesAndFile", "dir0, fileName")->Description = FilePathClass::CombineDirectoriesAndFileDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectoriesAndFile, (String (*)(StringParam, StringParam, StringParam)), "CombineDirectoriesAndFile", "dir0, dir1, fileName")->Description = FilePathClass::CombineDirectoriesAndFileDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectoriesAndFile, (String (*)(StringParam, StringParam, StringParam, StringParam)), "CombineDirectoriesAndFile", "dir0, dir1, dir2, fileName")->Description = FilePathClass::CombineDirectoriesAndFileDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::CombineDirectoriesAndFile, (String (*)(StringParam, StringParam, StringParam, StringParam, StringParam)), "CombineDirectoriesAndFile", "dir0, dir1, dir2, dir3, fileName")->Description = FilePathClass::CombineDirectoriesAndFileDocumentation();
    ...
    //Function* combineFunction = builder.AddBoundFunction(type, "Combine", &FilePathClass::Combine, OneParameter(arrayOfStrings, "parts"), LightningTypeId(String), FunctionOptions::Static);
    //combineFunction->Description = CombineDocumentation();

    LightningFullBindGetterSetter(builder, type, &FilePathClass::GetDirectorySeparator, LightningNoOverload, LightningNoSetter, LightningNoOverload, "DirectorySeparator")->Description = FilePathClass::DirectorySeparatorDocumentation();

    LightningFullBindMethod(builder, type, &FilePathClass::ChangeExtension, LightningNoOverload, "ChangeExtension", LightningNoNames)->Description = FilePathClass::ChangeExtensionDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetExtensionWithDot, LightningNoOverload, "GetExtensionWithDot", LightningNoNames)->Description = FilePathClass::GetExtensionWithDotDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetExtensionWithoutDot, LightningNoOverload, "GetExtensionWithoutDot", LightningNoNames)->Description = FilePathClass::GetExtensionWithoutDotDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetFileNameWithExtension, LightningNoOverload, "GetFileNameWithExtension", LightningNoNames)->Description = FilePathClass::GetFileNameWithExtensionDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetFileNameWithoutExtension, LightningNoOverload, "GetFileNameWithoutExtension", LightningNoNames)->Description = FilePathClass::GetFileNameWithoutExtensionDocumentation();

    LightningFullBindMethod(builder, type, &FilePathClass::AddTrailingDirectorySeparator, LightningNoOverload, "AddTrailingDirectorySeparator", LightningNoNames)->Description = FilePathClass::AddTrailingDirectorySeparatorDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::RemoveTrailingDirectorySeparator, LightningNoOverload, "RemoveTrailingDirectorySeparator", LightningNoNames)->Description = FilePathClass::RemoveTrailingDirectorySeparatorDocumentation();

    LightningFullBindMethod(builder, type, &FilePathClass::GetDirectoryPath, LightningNoOverload, "GetDirectoryPath", LightningNoNames)->Description = FilePathClass::GetDirectoryPathDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetDirectoryName, LightningNoOverload, "GetDirectoryName", LightningNoNames)->Description = FilePathClass::GetDirectoryNameDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetCanonicalizedPathFromAbsolutePath, LightningNoOverload, "GetCanonicalizedPathFromAbsolutePath", LightningNoNames)->Description = FilePathClass::GetCanonicalizedPathFromAbsolutePathDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::GetComparablePathFromAbsolutePath, LightningNoOverload, "GetComparablePathFromAbsolutePath", LightningNoNames)->Description = FilePathClass::GetComparablePathFromAbsolutePathDocumentation();
    LightningFullBindMethod(builder, type, &FilePathClass::IsRelative, LightningNoOverload, "IsRelative", LightningNoNames)->Description = FilePathClass::IsRelativeDocumentation();
    ...
    LightningFullBindGetterSetter(builder, type, &FilePathClass::GetExecutableFile, LightningNoOverload, LightningNoSetter, LightningNoOverload, "ExecutableFile")->Description = FilePathClass::ExecutableFileDocumentation();
  }
