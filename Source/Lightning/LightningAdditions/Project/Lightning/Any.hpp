...
namespace Lightning
{
  ...
  public:
    ...
    template <typename T>
    Any(const T& value, ExecutableState* state = nullptr, P_DISABLE_IF((Plasma::is_base_of<Type, typename Plasma::remove_pointer<typename Plasma::remove_const_and_volatile<T>::type>::type>::value)))
    {
