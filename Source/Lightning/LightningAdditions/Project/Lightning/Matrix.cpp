...
namespace Lightning
{
  ...
  void CreateMatrixTypes(LibraryBuilder& builder)
  {
    ...
    for (size_t typeIndex = 0; typeIndex < Core::MaxMatrixElementTypes; ++typeIndex)
    {
      for (size_t sizeY = Core::MinMatrixComponents; sizeY <= Core::MaxMatrixComponents; ++sizeY)
      {
        for (size_t sizeX = Core::MinMatrixComponents; sizeX <= Core::MaxMatrixComponents; ++sizeX)
        {
          ...
          // BoundType created elsewhere for Real2x2/Real3x3/Real4x4 for PlasmaLightning binding
    ...
    String invertDescription = LightningDocumentString("Computes the inverse of the given matrix if it exists. Undefined if the matrix is uninvertible");
    ...
    String transposeDescription = LightningDocumentString("Returns the transposed matrix. A transposed matrix is one where all rows are turned into columns, i.e. A^T[j][i] = A[i][j]");
    for (size_t typeIndex = 0; typeIndex < Core::MaxMatrixElementTypes; ++typeIndex)
    {
      for (size_t sizeY = Core::MinMatrixComponents; sizeY <= Core::MaxMatrixComponents; ++sizeY)
      {
    ...
    String matrixMultiplyDescription = LightningDocumentString("Multiplies the two matrices together. Matrix multiplication is in right-to-left order, "
    ...
    for (size_t matrixSize = Core::MinMatrixComponents; matrixSize <= Core::MaxMatrixComponents; ++matrixSize)
    {
      ...
      f->ComplexUserData.WriteObject(transformUserData);
      f->Description = LightningDocumentString("Multiplies the given vector as a point while performing the homogeneous division");
      ...
      f->ComplexUserData.WriteObject(transformUserData);
      f->Description = LightningDocumentString("Multiplies the given vector as a point without performing the homogeneous division");
    ...
    {
      // Real2x2
      LightningFullBindMethod(builder, core.MathType, Math::Matrix2::GenerateScale, LightningNoOverload, "GenerateScaleMatrix2x2", "scale")
        ->Description = LightningDocumentString("Generates a two-dimensional scale matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix2::GenerateRotation, LightningNoOverload, "GenerateRotationMatrix2x2", "radians")
        ->Description = LightningDocumentString("Generates a two-dimensional rotation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix2::GenerateTransform, LightningNoOverload, "GenerateTransformMatrix2x2", "radians, scale")
        ->Description = LightningDocumentString("Generates a two-dimensional transform.");

      // Real3x3
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateScale, (Real3x3 (*)(Real2Param)), "GenerateScaleMatrix3x3", "scale")
          ->Description = LightningDocumentString("Generates a two-dimensional scale matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateScale, (Real3x3(*)(Real3Param)), "GenerateScaleMatrix3x3", "scale")
        ->Description = LightningDocumentString("Generates a three-dimensional scale matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateRotation, (Real3x3(*)(Real)), "GenerateRotationMatrix3x3", "radians")
        ->Description = LightningDocumentString("Generates a two-dimensional rotation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateRotation, (Real3x3(*)(Real3Param, Real)), "GenerateRotationMatrix3x3", "axis, radians")
        ->Description = LightningDocumentString("Generates a three-dimensional rotation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateTranslation, (Real3x3(*)(Real2Param)), "GenerateTranslationMatrix3x3", "translation")
        ->Description = LightningDocumentString("Generates a two-dimensional translation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateTransform, (Real3x3(*)(Real2Param, Real, Real2Param)), "GenerateTransformMatrix3x3", "translation, radians, scale")
        ->Description = LightningDocumentString("Generates a two-dimensions transform.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateTransform, (Real3x3(*)(Real3x3Param, Real3Param)), "GenerateTransformMatrix3x3", "rotation, scale")
        ->Description = LightningDocumentString("Generates a three-dimensions transform.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix3::GenerateTransform, (Real3x3(*)(QuaternionParam, Real3Param)), "GenerateTransformMatrix3x3", "rotation, scale")
        ->Description = LightningDocumentString("Generates a three-dimensions transform.");

      // Real3x3
      LightningFullBindMethod(builder, core.MathType, Math::Matrix4::GenerateScale, (Real4x4(*)(Real3Param)), "GenerateScaleMatrix4x4", "scale")
        ->Description = LightningDocumentString("Generates a three-dimensional scale matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix4::GenerateRotation, (Real4x4(*)(Real3Param, Real)), "GenerateRotationMatrix4x4", "axis, radians")
        ->Description = LightningDocumentString("Generates a three-dimensional rotation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix4::GenerateTranslation, (Real4x4(*)(Real3Param)), "GenerateTranslationMatrix4x4", "translation")
        ->Description = LightningDocumentString("Generates a three-dimensional translation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix4::GenerateTransform, (Real4x4(*)(Real3Param, QuaternionParam, Real3Param)), "GenerateTransformMatrix4x4", "translation, rotation, scale")
        ->Description = LightningDocumentString("Generates a three-dimensional translation matrix.");
      LightningFullBindMethod(builder, core.MathType, Math::Matrix4::GenerateTransform, (Real4x4(*)(Real3Param, Real3x3Param, Real3Param)), "GenerateTransformMatrix4x4", "translation, rotation, scale")
        ->Description = LightningDocumentString("Generates a three-dimensional translation matrix.");
    }
  }
