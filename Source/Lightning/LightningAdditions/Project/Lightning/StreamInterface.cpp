...
namespace Lightning
{
  ...
  LightningDefineType(IEncoding, builder, type)
  {
    ...
    LightningFullBindGetterSetter(builder, type, &IEncoding::GetAscii, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Ascii");
    LightningFullBindGetterSetter(builder, type, &IEncoding::GetUtf8, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Utf8");
  }
  ...
  LightningDefineType(IStreamClass, builder, type)
  {
    ...
    LightningFullBindGetterSetter(builder, type, &IStreamClass::GetCapabilities, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Capabilities");
    LightningFullBindGetterSetter(builder, type, &IStreamClass::GetPosition, LightningNoOverload, &IStreamClass::SetPosition, LightningNoOverload, "Position");
    LightningFullBindGetterSetter(builder, type, &IStreamClass::GetCount, LightningNoOverload, &IStreamClass::SetCount, LightningNoOverload, "Count");
    
    LightningFullBindMethod(builder, type, &IStreamClass::Seek, LightningNoOverload, "Seek", "position, origin")->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::Write, (Integer (IStreamClass::*)(ArrayClass<Byte>&, Integer, Integer)), "Write", "data, byteStart, byteCount")->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::WriteByte, LightningNoOverload, "WriteByte", nullptr)->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::Read, (Integer (IStreamClass::*)(ArrayClass<Byte>&, Integer, Integer)), "Read", "data, byteStart, byteCount")->IsVirtual = true;
    ...
    LightningFullBindMethod(builder, type, &IStreamClass::Write, (Integer (IStreamClass::*)(ArrayClass<Byte>&)), "Write", "data");
    LightningFullBindMethod(builder, type, &IStreamClass::WriteText, (Integer (IStreamClass::*)(StringParam, IEncoding&)), "WriteText", "text, sourceStreamEncoding")->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::WriteText, (Integer (IStreamClass::*)(StringParam)), "WriteText", "text")->IsVirtual = true;
    //LightningFullBindMethod(builder, type, &IStreamClass::Read, (ArrayClass<Byte> (IStreamClass::*)(Integer)), "Read", "byteCount");
    LightningFullBindMethod(builder, type, &IStreamClass::ReadLine, (String (IStreamClass::*)(IEncoding&)), "ReadLine", nullptr)->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::ReadLine, (String (IStreamClass::*)()), "ReadLine", nullptr)->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::ReadAllText, (String (IStreamClass::*)(IEncoding&)), "ReadAllText", nullptr)->IsVirtual = true;
    LightningFullBindMethod(builder, type, &IStreamClass::ReadAllText, (String (IStreamClass::*)()), "ReadAllText", nullptr)->IsVirtual = true;
  }
