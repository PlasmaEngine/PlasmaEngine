...
namespace Lightning
{
  ...
  //***************************************************************************
  LightningCodeBuilder::LightningCodeBuilder() :
    Indentation(0),
    Line(1),
    Character(1)
  {
  ...
  //***************************************************************************
  void LightningCodeBuilder::WriteKeywordOrSymbolSpaceStyle(Grammar::Enum token, SpaceStyle::Enum specific, SpaceStyle::Enum globalDefault)
  {
  ...
  //***************************************************************************
  LightningCodeBuilder::ScopeStyle::ScopeStyle() :
