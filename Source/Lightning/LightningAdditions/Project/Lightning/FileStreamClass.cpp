...
namespace Lightning
{
  ...
  {
    Plasma::FileShare::Enum zeroShare = (Plasma::FileShare::Enum)0;
    Plasma::FileMode::Enum zeroMode = Plasma::FileMode::Read;
    Plasma::FileAccessPattern::Enum zeroAccessPattern = Plasma::FileAccessPattern::Random;
    ...
    if (append)
      zeroMode = Plasma::FileMode::Append;
    else if (read && write)
      zeroMode = Plasma::FileMode::ReadWrite;
    else if (write)
      zeroMode = Plasma::FileMode::Write;
    else
      zeroMode = Plasma::FileMode::Read;

    // Enable any optimizations
    if (mode & FileMode::Sequential)
      zeroAccessPattern = Plasma::FileAccessPattern::Sequential;
    ...
    if (mode & FileMode::ShareRead)
      zeroShare = (Plasma::FileShare::Enum)(zeroShare | Plasma::FileShare::Read);
    if (mode & FileMode::ShareWrite)
      zeroShare = (Plasma::FileShare::Enum)(zeroShare | Plasma::FileShare::Write);
    if (mode & FileMode::ShareDelete)
      zeroShare = (Plasma::FileShare::Enum)(zeroShare | Plasma::FileShare::Delete);
    ...
    if(zeroMode == Plasma::FileMode::Write || zeroMode == Plasma::FileMode::ReadWrite || zeroMode == Plasma::FileMode::Append)
    {
