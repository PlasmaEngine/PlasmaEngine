...
namespace Lightning
{
  ...
  namespace Events
  {
    LightningDefineEvent(ConsoleWrite);
    LightningDefineEvent(ConsoleRead);
  }
  ...
  //***************************************************************************
  LightningDefineType(ConsoleEvent, builder, type)
  {
  }
  ...
  //***************************************************************************
  LightningDefineType(Console, builder, type)
  {
    LightningFullBindMethod(builder, type, &Console::Write, (void (*)(AnyParam)),                                         "Write", nullptr);
    LightningFullBindMethod(builder, type, &Console::Write, (void (*)(AnyParam, AnyParam)),                               "Write", nullptr);
    LightningFullBindMethod(builder, type, &Console::Write, (void (*)(AnyParam, AnyParam, AnyParam)),                     "Write", nullptr);
    LightningFullBindMethod(builder, type, &Console::Write, (void (*)(AnyParam, AnyParam, AnyParam, AnyParam)),           "Write", nullptr);
    LightningFullBindMethod(builder, type, &Console::Write, (void (*)(AnyParam, AnyParam, AnyParam, AnyParam, AnyParam)), "Write", nullptr);
    
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)()),                                                 "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)(AnyParam)),                                         "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)(AnyParam, AnyParam)),                               "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)(AnyParam, AnyParam, AnyParam)),                     "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)(AnyParam, AnyParam, AnyParam, AnyParam)),           "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &Console::WriteLine, (void (*)(AnyParam, AnyParam, AnyParam, AnyParam, AnyParam)), "WriteLine", nullptr);

    LightningFullBindMethod(builder, type, &Console::DumpValue, (void (*)(AnyParam)),          "DumpValue", nullptr);
    LightningFullBindMethod(builder, type, &Console::DumpValue, (void (*)(AnyParam, Integer)), "DumpValue", nullptr);

    LightningFullBindMethod(builder, type, &Console::ReadString,  LightningNoOverload, "ReadString",   nullptr);
    LightningFullBindMethod(builder, type, &Console::ReadInteger, LightningNoOverload, "ReadInteger",  nullptr);
    LightningFullBindMethod(builder, type, &Console::ReadBoolean, LightningNoOverload, "ReadBoolean",  nullptr);
    LightningFullBindMethod(builder, type, &Console::ReadReal,    LightningNoOverload, "ReadReal",     nullptr);
  }
