...
namespace Lightning
{
  ...
  PlasmaNoInline bool LinkerEquals(Boolean                 a, Boolean                 b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Boolean2Param           a, Boolean2Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Boolean3Param           a, Boolean3Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Boolean4Param           a, Boolean4Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Integer                 a, Integer                 b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Integer2Param           a, Integer2Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Integer3Param           a, Integer3Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Integer4Param           a, Integer4Param           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Real                    a, Real                    b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Real2Param              a, Real2Param              b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Real3Param              a, Real3Param              b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(Real4Param              a, Real4Param              b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(QuaternionParam         a, QuaternionParam         b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(DoubleInteger           a, DoubleInteger           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(DoubleReal              a, DoubleReal              b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(const Handle&           a, const Handle&           b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(const Delegate&         a, const Delegate&         b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(const Any&              a, const Any&              b) { return a == b; }
  PlasmaNoInline bool LinkerEquals(const HandleOf<String>& a, const HandleOf<String>& b) { return a == b; }
  ...
  // For all other unknown types (such as structs created in Lightning) we use the 'Any' type
  template <typename T>
  ...
  public:
    ...
    static void ArrayRemoveAll(Call& call, ExceptionReport& report)
    {
      ...
      size_t removeCount = RemoveAll(self->NativeArray, Plasma::EqualTo<T>(testValue));
    ...
    public:
      ...
      bool operator()(T& left, T& right)
      {
        ...
        Lightning::Call call(*this->Comparer, this->State);
  ...
  )
  {
    ...
    PlasmaTodo("The range type must have a valid destructor the decrements the reference count on the 'array' handle");
    ...
    LightningFullBindDestructor(builder, arrayType, ArrayTemplate<T>);
    LightningFullBindConstructor(builder, arrayType, ArrayTemplate<T>, LightningNoNames);
