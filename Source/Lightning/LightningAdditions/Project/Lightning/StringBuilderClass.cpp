...
{
  //***************************************************************************
  LightningDefineType(StringBuilderExtended, builder, type)
  {
    LightningFullBindDestructor(builder, type, StringBuilderExtended);
    LightningFullBindConstructor(builder, type, StringBuilderExtended, nullptr);

    LightningFullBindMethod(builder, type, &StringBuilderExtended::ToString, LightningNoOverload, "ToString", nullptr);

    LightningFullBindMethod(builder, type, &StringBuilderExtended::Clear, LightningNoOverload, "Clear", nullptr);
    
    LightningFullBindMethod(builder, type, &StringBuilderExtended::Write, (void (StringBuilderExtended::*)(AnyParam)), "Write", nullptr);
    
    LightningFullBindMethod(builder, type, &StringBuilderExtended::WriteLine, (void (StringBuilderExtended::*)()), "WriteLine", nullptr);
    LightningFullBindMethod(builder, type, &StringBuilderExtended::WriteLine, (void (StringBuilderExtended::*)(AnyParam)), "WriteLine", nullptr);
  }
  ...
  //***************************************************************************
  void StringBuilderExtended::Write(Plasma::Rune value)
  {
    this->Append(value);
  }
  ...
  //***************************************************************************
  void StringBuilderExtended::WriteLine(Plasma::Rune value)
  {
    this->Write(value);
    this->WriteLine();
  }
  ...
  //***************************************************************************
  LightningDefineType(Rune, builder, type)
  {
    type->ToStringFunction = &Rune::ToString;

    LightningFullBindConstructor(builder, type, Rune, nullptr);
    LightningFullBindConstructor(builder, type, Rune, "value", int);
    LightningFullBindDestructor(builder, type, Rune);
    LightningBindGetterSetter(Value);
  }
  ...
  Rune::Rune(int value)
  {
    mValue = Plasma::Rune(value);
  }
  
  Rune::Rune(const Plasma::Rune zeroRune)
    : mValue(zeroRune)
  {
  ...
  Rune::operator Plasma::Rune() const
  {
    return mValue;
  }

  //***************************************************************************
  LightningDefineType(RuneIterator, builder, type)
  {
    LightningFullBindDestructor(builder, type, RuneIterator);
    LightningFullBindConstructor(builder, type, RuneIterator, nullptr);

    BoundType* boolType = LightningTypeId(Boolean);
    BoundType* integerType = LightningTypeId(int);
    BoundType* voidType = LightningTypeId(void);
  ...
  //***************************************************************************
  LightningDefineType(StringRangeExtended, builder, type)
  {
    LightningFullBindDestructor(builder, type, StringRangeExtended);
    LightningFullBindConstructor(builder, type, StringRangeExtended, nullptr);

    BoundType* booleanType = LightningTypeId(bool);
    BoundType* integerType = LightningTypeId(Integer);
    BoundType* iteratorType = LightningTypeId(RuneIterator);
    BoundType* stringType = LightningTypeId(String);
    ...
    LightningFullBindMethod(builder, type, &StringRangeExtended::MoveNext, LightningNoOverload, "MoveNext", nullptr);
    builder.AddBoundGetterSetter(type, "Current", LightningTypeId(Rune), nullptr, &StringRangeExtended::Current, MemberOptions::None); 
    ...
    builder.AddBoundGetterSetter(type, "Begin", iteratorType, nullptr, &StringRangeExtended::Begin, FunctionOptions::None)
      ->Description = LightningDocumentString("Returns the RuneIterator at the start of this range.");
    LightningFullBindMethod(builder, type, &StringRangeExtended::CompareTo, LightningNoOverload, "CompareTo", nullptr)
      ->Description = LightningDocumentString("Compares this StringRange to the given StringRange and returns an Integer to denote their relative sort order.");
    LightningFullBindMethod(builder, type, &StringRangeExtended::Contains, LightningNoOverload, "Contains", nullptr)
    ...
    builder.AddBoundGetterSetter(type, "End", iteratorType, nullptr, &StringRangeExtended::End, FunctionOptions::None)
      ->Description = LightningDocumentString("Returns the RuneIterator at the end (one past the last Rune) of this range.");
    LightningFullBindMethod(builder, type, &StringRangeExtended::EndsWith, LightningNoOverload, "EndsWith", nullptr)
      ->Description = LightningDocumentString("Returns true if the string ends with the specified substring.");
    ...
    LightningFullBindMethod(builder, type, &StringRangeExtended::Replace, LightningNoOverload, "Replace", "oldValue newValue")
    ...
    builder.AddBoundFunction(type, "SubString", &StringRangeExtended::SubString, TwoParameters(iteratorType, "begin", "end"), type, FunctionOptions::None)
      ->Description = LightningDocumentString("Constructs a StringRange from the given begin and end iterators.");
    ...
    LightningFullBindMethod(builder, type, &StringRangeExtended::StartsWith, LightningNoOverload, "StartsWith", nullptr)
      ->Description = LightningDocumentString("Returns true if the string starts with the specified substring.");
    ...
    LightningFullBindMethod(builder, type, &StringRangeExtended::ToLower, LightningNoOverload, "ToLower", nullptr)
    ...
    builder.AddBoundFunction(type, "ToString", &StringRangeExtended::ConvertToString, ParameterArray(), stringType, FunctionOptions::None)
      ->Description = LightningDocumentString("Returns a new string of the current range.");
    LightningFullBindMethod(builder, type, &StringRangeExtended::ToUpper, LightningNoOverload, "ToUpper", nullptr)
      ->Description = LightningDocumentString("Returns a copy of the string that has been converted to uppercase.");

    builder.AddBoundGetterSetter(type, "OriginalString", stringType, nullptr, &StringRangeExtended::GetOriginalString, FunctionOptions::None)
      ->Description = LightningDocumentString("Returns the entire string that this range was constructed from.");
    ...
    builder.AddBoundFunction(type, "RuneIteratorFromRuneIndex", &StringRangeExtended::RuneIteratorFromRuneIndex, OneParameter(integerType, "runeIndex"), iteratorType, FunctionOptions::None)
      ->Description = LightningDocumentString("Finds the iterator from a rune index (the 'character' index). WARNING: this may be slow as finding an iterator from rune index requires a linear search.");
  }
  ...
  {
    Handle rangeHandle = call.GetState()->AllocateDefaultConstructedHeapObject(LightningTypeId(StringRangeExtended), report, HeapFlags::ReferenceCounted);
  ...
  //***************************************************************************
  void StringRangeExtended::SetResultStringSplitRange(Call& call, ExceptionReport& report, StringParam strRef, const Plasma::StringSplitRange& result)
  {
    Handle rangeHandle = call.GetState()->AllocateHeapObject(LightningTypeId(StringSplitRangeExtended), report, HeapFlags::ReferenceCounted);
  ...
  {
    Handle rangeHandle = call.GetState()->AllocateDefaultConstructedHeapObject(LightningTypeId(RuneIterator), report, HeapFlags::ReferenceCounted);
  ...
  //***************************************************************************
  LightningDefineType(StringSplitRangeExtended, builder, type)
  {
    LightningFullBindDestructor(builder, type, StringRangeExtended);

    // Range interface
    builder.AddBoundGetterSetter(type, "All", type, nullptr, &StringSplitRangeExtended::All, MemberOptions::None);
    builder.AddBoundFunction(type, "MoveNext", &StringSplitRangeExtended::MoveNext, ParameterArray(), LightningTypeId(void), MemberOptions::None);
    builder.AddBoundGetterSetter(type, "Current", LightningTypeId(StringRangeExtended), nullptr, &StringSplitRangeExtended::Current, MemberOptions::None);
    builder.AddBoundGetterSetter(type, "IsNotEmpty", LightningTypeId(Boolean), nullptr, &StringSplitRangeExtended::IsNotEmpty, MemberOptions::None);
  }
