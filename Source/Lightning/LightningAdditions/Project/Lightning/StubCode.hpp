#pragma once
#ifndef LIGHTNING_STUB_CODE_HPP
#define LIGHTNING_STUB_CODE_HPP

namespace Lightning
{
  // A helper for generating Lightning code (without implementation) for natively defined types
