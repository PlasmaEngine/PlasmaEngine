...
namespace Lightning
{
  ...
  Shared::Shared()
  {
    ...
    #define LightningNumericOperators(WithType, ComparisonType)                                                                                                                                                                             \
      LightningCopyOperators(WithType)                                                                                                                                                                                      \
      LightningEqualityOperators(WithType, ComparisonType)                                                                                                                                                                                  \
      {                                                                                                                                                                                                                 \
        BoundType* type =  core.WithType##Type;                                                                                                                                                                         \
    ...
    #define LightningScalarOperators(WithType)                                                                                                                                                                              \
      LightningNumericOperators(WithType, Boolean)                                                                                                                                                                          \
      LightningComparisonOperators(WithType, Boolean)
    ...
    #define LightningVectorOperators(VectorType, ScalarType, ComparisonType)                                                                                                                                                \
      LightningNumericOperators(VectorType, Boolean)                                                                                                                                                                 \
      LightningComparisonOperators(VectorType, ComparisonType)                                                                                                                                                              \
      {                                                                                                                                                                                                                 \
