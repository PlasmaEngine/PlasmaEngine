...
#pragma once
#ifndef LIGHTNING_GRAMMAR_CONSTANTS_HPP
#define LIGHTNING_GRAMMAR_CONSTANTS_HPP
...
namespace Lightning
{
  ...
  namespace Grammar
  {
    ...
    PlasmaShared const String& GetName(Grammar::Enum value);

    // Gets the keyword or symbol associated with a grammar constant, or returns the string 'Invalid'
    PlasmaShared const String& GetKeywordOrSymbol(Grammar::Enum value);

    // Get a list of keywords used by Lightning (typically provided for syntax highlighting)
    // If you need a list of words separated by spaces, you can use Lightning::JoinStrings
    PlasmaShared const Array<String>& GetUsedKeywords();

    // Special keywords that only exist in certain contexts, (eg this, value...)
    // If you need a list of words separated by spaces, you can use Lightning::JoinStrings
    PlasmaShared const Array<String>& GetSpecialKeywords();

    // Get a list of keywords reserved by Lightning (these may not be used, but do nothing)
    PlasmaShared const Array<String>& GetReservedKeywords();
  }
}
