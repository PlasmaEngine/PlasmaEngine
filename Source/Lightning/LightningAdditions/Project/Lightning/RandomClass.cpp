...
namespace Lightning
{
  ...
  LightningDefineType(Random, builder, type)
  {
    ...
    LightningFullBindGetterSetter(builder, type, &Random::GetSeed, LightningNoOverload, &Random::SetSeed, LightningNoOverload, "Seed");
    LightningFullBindGetterSetter(builder, type, &Random::GetMaxInteger, LightningNoOverload, LightningNoSetter, LightningNoOverload, "MaxInteger");
    ...
    LightningFullBindMethod(builder, type, &Random::Variance, (float (Random::*)(float, float)), "Variance", "baseValue, variance");
    LightningFullBindMethod(builder, type, &Random::Variance, (double (Random::*)(double, double)), "Variance", "baseValue, variance");
    ...
    LightningFullBindMethod(builder, type, &Random::BellCurve, (float (Random::*)(float, float)),        "BellCurve", "center, range");
    LightningFullBindMethod(builder, type, &Random::BellCurve, (float (Random::*)(float, float, float)), "BellCurve", "center, range, standardDeviation");
  }
