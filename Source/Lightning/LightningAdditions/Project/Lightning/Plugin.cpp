...
namespace Lightning
{
  ...
  LibraryRef Plugin::LoadFromFile(Status& status, Module& dependencies, StringParam filePath, void* userData)
  {
    ...
    {
      status.SetFailed("The 'CreateLightningPlugin' function was not exported within the dll (did you use the PlasmaExport macro?)");
    ...
    if (plugin == nullptr)
    {
      status.SetFailed("We found the 'CreateLightningPlugin' function and called it, but it returned null so no plugin was created");
  ...
  {
    // Walk through all the files in the directory looking for anything ending with .lightningPlugin
  ...
  Function* NameMangler::FindFunction(GuidType functionHash, const char* functionName, StringParam typeName)
  {
    ...
    ErrorIf
    (
      LightningDebugPluginLinking && function == nullptr,
  ...
  BoundType* FindLibraryType(LibraryRef library, const char* name)
  {
    ...
    ErrorIf
    (
      LightningDebugPluginLinking && type == nullptr,
  ...
  NativeStubCode::NativeStubCode() :
    Libraries(nullptr)
  {
    // Because some of the types that we have bound already exist within the Plasma or Lightning namespace
    ...
    this->TypeToCppName.Insert(LightningTypeId(Delegate), NativeName("Delegate", "const Lightning::Delegate&", "Lightning::Delegate"));

    this->TypeToCppName.Insert(LightningTypeId(Member), NativeName("Member", "Lightning::Member*", "Lightning::HandleOf<Lightning::Member>"));
    this->TypeToCppName.Insert(LightningTypeId(Property), NativeName("Property", "Lightning::Property*", "Lightning::HandleOf<Lightning::Property>"));
    this->TypeToCppName.Insert(LightningTypeId(GetterSetter), NativeName("GetterSetter", "Lightning::GetterSetter*", "Lightning::HandleOf<Lightning::GetterSetter>"));
    this->TypeToCppName.Insert(LightningTypeId(Field), NativeName("Field", "Lightning::Field*", "Lightning::HandleOf<Lightning::Field>"));
    this->TypeToCppName.Insert(LightningTypeId(Function), NativeName("Function", "Lightning::Function*", "Lightning::HandleOf<Lightning::Function>"));
    ...
    this->TypeToCppName.Insert(LightningTypeId(Boolean2), NativeName("Boolean2", "const Lightning::Boolean2&", "Lightning::Boolean2"));
    this->TypeToCppName.Insert(LightningTypeId(Boolean3), NativeName("Boolean3", "const Lightning::Boolean3&", "Lightning::Boolean3"));
    this->TypeToCppName.Insert(LightningTypeId(Boolean4), NativeName("Boolean4", "const Lightning::Boolean4&", "Lightning::Boolean4"));
    ...
    this->TypeToCppName.Insert(LightningTypeId(Integer2), NativeName("Integer2", "const Lightning::Integer2&", "Lightning::Integer2"));
    this->TypeToCppName.Insert(LightningTypeId(Integer3), NativeName("Integer3", "const Lightning::Integer3&", "Lightning::Integer3"));
    this->TypeToCppName.Insert(LightningTypeId(Integer4), NativeName("Integer4", "const Lightning::Integer4&", "Lightning::Integer4"));
    ...
    this->TypeToCppName.Insert(LightningTypeId(Quaternion), NativeName("Quaternion", "const Lightning::Quaternion&", "Lightning::Quaternion"));
    ...
    this->TypeToCppName.Insert(LightningTypeId(Members::Enum), NativeName("Members::Enum", "Lightning::Members::Enum", "Lightning::Members::Enum"));
    this->TypeToCppName.Insert(LightningTypeId(FileMode::Enum), NativeName("FileMode::Enum", "Lightning::FileMode::Enum", "Lightning::FileMode::Enum"));
    this->TypeToCppName.Insert(LightningTypeId(StreamCapabilities::Enum), NativeName("StreamCapabilities::Enum", "Lightning::StreamCapabilities::Enum", "Lightning::StreamCapabilities::Enum"));
    this->TypeToCppName.Insert(LightningTypeId(StreamOrigin::Enum), NativeName("StreamOrigin::Enum", "Lightning::StreamOrigin::Enum", "Lightning::StreamOrigin::Enum"));

    this->TypeToCppName.Insert(LightningTypeId(EventsClass), NativeName("EventsClass", "const Lightning::EventsClass&", "Lightning::EventsClass"));
    this->TypeToCppName.Insert(LightningTypeId(FilePathClass), NativeName("FilePathClass", "const Lightning::FilePathClass&", "Lightning::FilePathClass"));
    this->TypeToCppName.Insert(LightningTypeId(IStreamClass), NativeName("IStreamClass", "const Lightning::IStreamClass&", "Lightning::IStreamClass"));
    this->TypeToCppName.Insert(LightningTypeId(FileStreamClass), NativeName("FileStreamClass", "const Lightning::FileStreamClass&", "Lightning::FileStreamClass"));
    this->TypeToCppName.Insert(LightningTypeId(StringBuilderExtended), NativeName("StringBuilderExtended", "const Lightning::StringBuilderExtended&", "Lightning::StringBuilderExtended"));
    this->TypeToCppName.Insert(LightningTypeId(StringRangeExtended), NativeName("StringRangeExtended", "const Lightning::StringRangeExtended&", "Lightning::StringRangeExtended"));
    this->TypeToCppName.Insert(LightningTypeId(StringSplitRangeExtended), NativeName("StringSplitRangeExtended", "const Lightning::StringSplitRangeExtended&", "Lightning::StringSplitRangeExtended"));

    this->TypeToCppName.Insert(LightningTypeId(ColorClass), NativeName("ColorClass", "const Lightning::ColorClass&", "Lightning::ColorClass"));
    this->TypeToCppName.Insert(LightningTypeId(ColorsClass), NativeName("ColorsClass", "const Lightning::ColorsClass&", "Lightning::ColorsClass"));

    this->TypeToCppName.Insert(LightningTypeId(ParameterArray::range), NativeName("ParameterArray::range", "const Lightning::ParameterArray::range&", "Lightning::ParameterArray::range"));
    this->TypeToCppName.Insert(LightningTypeId(MemberRange<Member>), NativeName("MemberRange<Lightning::Member>", "const Lightning::MemberRange<Lightning::Member>&", "Lightning::MemberRange<Lightning::Member>"));
    this->TypeToCppName.Insert(LightningTypeId(MemberRange<Property>), NativeName("MemberRange<Lightning::Property>", "const Lightning::MemberRange<Lightning::Property>&", "Lightning::MemberRange<Lightning::Property>"));
    this->TypeToCppName.Insert(LightningTypeId(MemberRange<GetterSetter>), NativeName("MemberRange<Lightning::GetterSetter>", "const Lightning::MemberRange<Lightning::GetterSetter>&", "Lightning::MemberRange<Lightning::GetterSetter>"));
    this->TypeToCppName.Insert(LightningTypeId(MemberRange<Field>), NativeName("MemberRange<Lightning::Field>", "const Lightning::MemberRange<Lightning::Field>&", "Lightning::MemberRange<Lightning::Field>"));
    this->TypeToCppName.Insert(LightningTypeId(MemberRange<Function>), NativeName("MemberRange<Lightning::Function>", "const Lightning::MemberRange<Lightning::Function>&", "Lightning::MemberRange<Lightning::Function>"));
  }

  //***************************************************************************
  NativeName NativeStubCode::GetCppTypeName(Type* type)
  {
    // All delegates that we take in just become a Lightning Delegate (not type checked unfortunately)
    ...
    // This also allows us to handle the built in types to Plasma/Lightning, such as 'Any' (see above)
  ...
  String NativeStubCode::GenerateHpp()
  {
    ...
    if (this->Namespace != GetCoreNamespace())
    {
      ...
      LightningForEach(BoundType* type, this->TypesInDependencyOrder)
      {
        ...
        builder.WriteLineIndented();
        builder.Write("Lightning::BoundType* LightningGetDerivedType() const { return LightningTypeId(LightningSelf)->GetBindingVirtualTypeFromInstance(this); }");
        builder.WriteLineIndented();
        builder.WriteLineIndented();
    ...
    if (this->Namespace != GetCoreNamespace())
    {
      ...
      LightningForEach(const LibraryRef& library, *this->Libraries)
      {
        LightningForEach(Function* function, library->OwnedFunctions)
        {
          ...
          builder.WriteLineIndented("Lightning::ExecutableState* __state = Lightning::ExecutableState::GetCallingState();");
          builder.Write("ReturnIf(__state == nullptr,");
          builder.Write(defaultReturn);
          builder.WriteLineIndented(", \"You can only invoke this function when your code is called from Lightning\");");
          builder.WriteLineIndented();
