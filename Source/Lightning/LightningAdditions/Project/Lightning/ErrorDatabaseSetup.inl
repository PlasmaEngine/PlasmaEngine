...
// ParameterTypeNotFound
{
  ...
  error.Reason = "Parameter names must have types associated with them. Ambiguously-typed parameters are not allowed in Lightning.";
...
// ParameterTypeSpecifierNotFound
{
  ...
  error.Reason = "Function parameters must have types associated with them, denoted by the syntax 'parameter : parameterType'. Lightning does not support ambiguously-typed parameters.";
