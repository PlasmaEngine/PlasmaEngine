#pragma once
#ifndef LIGHTNING_FORMATTER_HPP
#define LIGHTNING_FORMATTER_HPP
...
namespace Lightning
{
  ...
  // The default values used here reflect the official coding standard of Lightning
  class PlasmaShared CodeFormat
  {
  public:
  ...
  // This class can be used to directly emit Lightning code as text
  // It's mostly a convenience (handles scoping, formatting, spaces, keywords, etc)
  class PlasmaShared LightningCodeBuilder : public StringBuilderExtended
  {
  public:
    // Constructor
    LightningCodeBuilder();
  ...
  class PlasmaShared ScopeLastNode
  {
  public:
    // Constructor
    ScopeLastNode();
  ...
  class PlasmaShared CodeFormatterContext : public WalkerContext<CodeFormatter, CodeFormatterContext>
  {
  public:
    // Constructor
  ...
  // This is incredibly useful for auto-formatting Lightning code, or translating into other languages
  class PlasmaShared CodeFormatter
  {
  public:
  ...
  private:
    ...
    // Format a class back into Lightning format
    void FormatAttributes(NodeList<AttributeNode>& attributes, LightningCodeBuilder& builder);
