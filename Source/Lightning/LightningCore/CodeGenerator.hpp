...
#pragma once
#ifndef LIGHTNING_CODE_GENERATOR_HPP
#  define LIGHTNING_CODE_GENERATOR_HPP

namespace Lightning
{
// The context we use to generate code
class PlasmaShared GeneratorContext : public WalkerContext<CodeGenerator, GeneratorContext>
{
public:
...
class PlasmaShared CodeGenerator
{
public:
  // Constructor
  CodeGenerator();
