...
// BreakCountMustBeGreaterThanPlasma
{
  ErrorInfo& error = this->Errors.PushBack();
  ...
  error.Name = "BreakCountMustBeGreaterThanPlasma";
  error.Reason = "";
}
...
{
  ErrorInfo& error = this->Errors.PushBack();
  error.Error = "The type '%s' can only be created outside of Lightning.";
...
{
  ErrorInfo& error = this->Errors.PushBack();
  error.Error = "The type '%s' can only be deleted outside of Lightning.";
...
// ParameterTypeNotFound
{
  ...
  error.Reason = "Parameter names must have types associated with them. "
                 "Ambiguously-typed parameters are not allowed in Lightning.";
...
// ParameterTypeSpecifierNotFound
{
  ...
  error.Reason = "Function parameters must have types associated with them, "
                 "denoted by the syntax 'parameter : parameterType'. Lightning "
...
// TimeoutSecondsMustBeNonPlasmaPositive
{
  ErrorInfo& error = this->Errors.PushBack();
  error.Error = "The time in seconds given to the timeout statement must be "
                "positive and non-plasma.";
  error.Name = "TimeoutSecondsMustBeNonPlasmaPositive";
  error.Reason = "";
}
