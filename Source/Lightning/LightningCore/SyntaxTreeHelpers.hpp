...
#pragma once
#ifndef LIGHTNING_SYNTAX_TREE_HELPERS_HPP
#  define LIGHTNING_SYNTAX_TREE_HELPERS_HPP

namespace Lightning
{
// This list is used to hold nodes in the tree
template <typename ValueType>
class PlasmaSharedTemplate DoublePointerArray : public PodArray<ValueType**>
{
public:
  // Type-defines
...
// This list is used to hold nodes in the tree
template <typename ValueType>
class PlasmaSharedTemplate PopulatingPointerArray : public PodBlockArray<ValueType*>
{
public:
  // Type-defines
...
template <typename T>
class PlasmaSharedTemplate NodeList : public PopulatingPointerArray<T>
{
};
...
template <typename TreeOwnerType, typename ContextType>
class PlasmaSharedTemplate WalkerContext
{
public:
...
template <typename TreeOwnerType, typename ContextType>
class PlasmaSharedTemplate BranchWalker
{
public:
  // Constructor
  ...
  {
    RegisterInternal((MemberFn)visitor, LightningTypeId(ChildType), false);
  }
  ...
  {
    RegisterInternal((MemberFn)visitor, LightningTypeId(DerivedChildType), false);
  }
  ...
  {
    RegisterInternal((MemberFn)visitor, LightningTypeId(ChildType), true);
  }
