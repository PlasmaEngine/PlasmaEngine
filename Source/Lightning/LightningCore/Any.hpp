...
T& GetInvalid()
{
  ...
  static MaxAlignmentType InvalidBuffer[PlasmaAlignCount(sizeof(TNonReference))];
...
public:
  ...
  Any(Plasma::MoveReference<Any> rhs)
  {
  ...
  Any(const T& value,
      ...
      P_DISABLE_IF((Plasma::is_base_of<
                    Type,
                    typename Plasma::remove_pointer<typename Plasma::remove_const_and_volatile<T>::type>::type>::value)))
  {
  ...
  bool Is() const
  {
    BoundType* checkType = LightningTypeId(T);
