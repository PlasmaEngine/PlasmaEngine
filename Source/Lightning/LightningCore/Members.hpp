...
#pragma once
#ifndef LIGHTNING_MEMBERS_HPP
#  define LIGHTNING_MEMBERS_HPP
...
public:
  ...
  // The value will be represented as if it were a Lightning token (quotes will be
  ...
  Lightning::Type* TypeValue;
};

// An attribute parameter can be any of the literal types we support
class PlasmaShared AttributeParameter : public Constant
{
public:
  AttributeParameter()
  {
  ...
  AttributeParameter(StringParam name, Lightning::Type* value);
...
class PlasmaShared ReflectionObject : public Composition
{
public:
  LightningDeclareType(ReflectionObject, TypeCopyMode::ReferenceType);
...
// members
class PlasmaShared Member : public ReflectionObject
{
public:
  LightningDeclareType(Member, TypeCopyMode::ReferenceType);
...
// a variable
class PlasmaShared Property : public Member
{
public:
  LightningDeclareType(Property, TypeCopyMode::ReferenceType);
...
class PlasmaShared GetterSetter : public Property
{
public:
  LightningDeclareType(GetterSetter, TypeCopyMode::ReferenceType);
};

// A class field basically consists of the type, as well as the offset into the
// memory block
class PlasmaShared Field : public Property
{
public:
  LightningDeclareType(Field, TypeCopyMode::ReferenceType);
  ...
  // call GenericDefaultConstruct (which will typically just plasma out memory)
...
class PlasmaShared Variable : public ReflectionObject
{
public:
  LightningDeclareType(Variable, TypeCopyMode::ReferenceType);
...
class PlasmaShared SendsEvent : public ReflectionObject
{
public:
  // Constructor
  SendsEvent();
