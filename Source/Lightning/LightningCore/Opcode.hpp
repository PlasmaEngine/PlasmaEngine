...
#pragma once
#ifndef LIGHTNING_THREE_ADDRESS_OPCODE_HPP
#  define LIGHTNING_THREE_ADDRESS_OPCODE_HPP
...
class PlasmaShared TimeoutOpcode : public Opcode
{
public:
...
// Opcode for the creation of a handle from a local
class PlasmaShared ToHandleOpcode : public Opcode
{
public:
  Operand ToHandle;
...
class PlasmaShared CreateDelegateOpcode : public Opcode
{
public:
...
class PlasmaShared CreateStaticDelegateOpcode : public CreateDelegateOpcode
{
public:
};
...
// Note that this opcode always saves to a local
// (anyone that wants to store the value just copies it from a local)
class PlasmaShared CreateInstanceDelegateOpcode : public CreateDelegateOpcode
{
public:
  Operand ThisHandle;
  bool CanBeVirtual;
...
class PlasmaShared IfOpcode : public Opcode
{
public:
  Operand Condition;
...
class PlasmaShared RelativeJumpOpcode : public Opcode
{
public:
  ByteCodeOffset JumpOffset;
};
...
class PlasmaShared PrepForFunctionCallOpcode : public Opcode
{
public:
  Operand Delegate;
...
// strings
class PlasmaShared BeginStringBuilderOpcode : public Opcode
{
public:
};

// Finishes off a string builder and outputs the string to a given stack local
class PlasmaShared EndStringBuilderOpcode : public Opcode
{
public:
...
// Creates a fresh string builder that we use for efficient concatenation of
// strings
class PlasmaShared AddToStringBuilderOpcode : public Opcode
{
public:
...
class PlasmaShared TypeIdOpcode : public Opcode
{
public:
...
class PlasmaShared CreateTypeOpcode : public Opcode
{
public:
...
class PlasmaShared CreateLocalTypeOpcode : public CreateTypeOpcode
{
public:
...
class PlasmaShared CreatePropertyDelegateOpcode : public CreateTypeOpcode
{
public:
...
class PlasmaShared DeleteObjectOpcode : public Opcode
{
public:
  Operand Object;
};
...
class PlasmaShared ThrowExceptionOpcode : public Opcode
{
public:
  Operand Exception;
};
...
class PlasmaShared BinaryRValueOpcode : public Opcode
{
public:
  Operand Left;
  Operand Right;
...
class PlasmaShared BinaryLValueOpcode : public Opcode
{
public:
  Operand Output;
  Operand Right;
...
// and is only used with value types, and therefore the output is always local)
class PlasmaShared UnaryRValueOpcode : public Opcode
{
public:
...
class PlasmaShared UnaryLValueOpcode : public Opcode
{
public:
  Operand SingleOperand;
};
...
class PlasmaShared ConversionOpcode : public Opcode
{
public:
  Operand ToConvert;
  OperandLocal Output;
...
// variant)
class PlasmaShared AnyConversionOpcode : public ConversionOpcode
{
public:
  // For ConvertToAny:
...
class PlasmaShared DowncastConversionOpcode : public ConversionOpcode
{
public:
...
class PlasmaShared AnyDynamicGet : public Opcode
{
public:
...
class PlasmaShared CopyOpcode : public Opcode
{
public:
  Operand Source;
  Operand Destination;
...
class PlasmaShared DebugOperand
{
public:
  DebugOperand();
...
class PlasmaShared DebugInstruction
{
public:
  DebugInstruction();
...
PlasmaShared void GenerateDebugInstructionInfo(Array<DebugInstruction>& debugOut);
} // namespace Lightning
