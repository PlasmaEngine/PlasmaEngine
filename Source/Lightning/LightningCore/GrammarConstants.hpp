...
// Get a list of keywords used by Lightning (typically provided for syntax
// highlighting) If you need a list of words separated by spaces, you can use
// Lightning::JoinStrings
...
// Get a list of keywords reserved by Lightning (these may not be used, but do
// nothing)
