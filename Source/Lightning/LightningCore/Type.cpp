...
LightningDefineType(Type, builder, type)
{
  ...
  LightningFullBindGetterSetter(
      builder, type, &Type::IsHandle, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsHandle");
  ...
  LightningFullBindGetterSetter(
      builder, type, &Type::IsDelegate, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsDelegate");
  ...
  LightningFullBindGetterSetter(
      builder, type, &Type::IsEnumOrFlags, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEnumOrFlags");
...
LightningDefineType(DelegateType, builder, type)
{
  ...
  LightningFullBindGetterSetter(
      builder, type, &DelegateType::GetSignatureString, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Signature");
  LightningFullBindGetterSetter(
      builder, type, &DelegateType::GetParameters, LightningNoOverload, LightningNoSetter, LightningNoOverload, "Parameters");
...
bool Type::BoundIsA(BoundType* type, BoundType* base)
{
  ...
  while (type != nullptr)
  {
    ...
    PlasmaTodo("Using the names of the BoundType to compare isn't technically "
             "correct");
...
{
  // When a BoundType is created via native binding in C++, e.g. LightningTypeId(X),
...
void BoundType::GenericDefaultConstruct(byte* toConstruct) const
{
  ...
  {
    // Otherwise, clear the memory out to plasmas (a valid configuration for all
    // structs)
