...
#pragma once
#ifndef LIGHTNING_WRAPPER_HPP
#  define LIGHTNING_WRAPPER_HPP
...
class PlasmaShared Wrapper : public ILightningObject
{
public:
  LightningDeclareType(Wrapper, TypeCopyMode::ReferenceType);
