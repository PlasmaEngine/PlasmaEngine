...
LightningDefineEvent(DebuggerBreakpointedAdded);
LightningDefineEvent(DebuggerBreakpointedRemoved);
LightningDefineEvent(DebuggerBreakNotAllowed);
} // namespace Events
...
LightningDefineType(DebuggerTextEvent, builder, type)
{
}
...
Any Debugger::QueryExpression(StringParam expression, Array<QueryResult>& results)
{
  ...
  // Temporary space used for traversing object paths and copying Lightning objects
