...
#pragma once
#ifndef LIGHTNING_SYNTAXER_HPP
#  define LIGHTNING_SYNTAXER_HPP

namespace Lightning
{
// A context we use to collect all class types
class PlasmaShared ClassContext : public WalkerContext<Syntaxer, ClassContext>
{
public:
...
class PlasmaShared TypingContext : public WalkerContext<Syntaxer, TypingContext>
{
public:
