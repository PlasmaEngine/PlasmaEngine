...
#pragma once
#ifndef LIGHTNING_ERROR_DATABASE_HPP
#  define LIGHTNING_ERROR_DATABASE_HPP
...
class PlasmaShared ErrorExample
{
public:
...
class PlasmaShared ErrorDatabase
{
public:
...
class PlasmaShared ErrorEvent : public EventData
{
public:
  LightningDeclareType(ErrorEvent, TypeCopyMode::ReferenceType);
