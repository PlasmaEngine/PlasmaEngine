...
namespace Lightning
{
LightningDefineStaticLibrary(Syntax)
{
  LightningInitializeType(SyntaxNode);
  LightningInitializeType(SyntaxType);
  LightningInitializeType(AnySyntaxType);
  LightningInitializeType(IndirectionSyntaxType);
  LightningInitializeType(BoundSyntaxType);
  LightningInitializeType(DelegateSyntaxType);
  LightningInitializeType(RootNode);
  LightningInitializeType(AttributeNode);
  LightningInitializeType(StatementNode);
  LightningInitializeType(ExpressionNode);
  LightningInitializeType(BinaryOperatorNode);
  LightningInitializeType(UnaryOperatorNode);
  LightningInitializeType(PropertyDelegateOperatorNode);
  LightningInitializeType(TypeCastNode);
  LightningInitializeType(PostExpressionNode);
  LightningInitializeType(IndexerCallNode);
  LightningInitializeType(FunctionCallNode);
  LightningInitializeType(MemberAccessNode);
  LightningInitializeType(ExpressionInitializerNode);
  LightningInitializeType(ExpressionInitializerMemberNode);
  LightningInitializeType(ExpressionInitializerAddNode);
  LightningInitializeType(MultiExpressionNode);
  LightningInitializeType(VariableNode);
  LightningInitializeType(LocalVariableNode);
  LightningInitializeType(ParameterNode);
  LightningInitializeType(MemberVariableNode);
  LightningInitializeType(ValueNode);
  LightningInitializeType(StringInterpolantNode);
  LightningInitializeType(DeleteNode);
  LightningInitializeType(ReturnNode);
  LightningInitializeType(ScopeNode);
  LightningInitializeType(StaticTypeNode);
  LightningInitializeType(TimeoutNode);
  LightningInitializeType(IfNode);
  LightningInitializeType(IfRootNode);
  LightningInitializeType(SendsEventNode);
  LightningInitializeType(BreakNode);
  LightningInitializeType(DebugBreakNode);
  LightningInitializeType(ContinueNode);
  LightningInitializeType(LoopScopeNode);
  LightningInitializeType(ConditionalLoopNode);
  LightningInitializeType(WhileNode);
  LightningInitializeType(DoWhileNode);
  LightningInitializeType(ForNode);
  LightningInitializeType(ForEachNode);
  LightningInitializeType(LoopNode);
  LightningInitializeType(GenericFunctionNode);
  LightningInitializeType(FunctionNode);
  LightningInitializeType(InitializerNode);
  LightningInitializeType(ConstructorNode);
  LightningInitializeType(DestructorNode);
  LightningInitializeType(ClassNode);
  LightningInitializeType(TypeDefineNode);
  LightningInitializeType(LocalVariableReferenceNode);
  LightningInitializeType(ThrowNode);
  LightningInitializeType(TypeIdNode);
  LightningInitializeType(MemberIdNode);
  LightningInitializeType(EnumValueNode);
  LightningInitializeType(EnumNode);
}

LightningDefineType(SyntaxType, builder, type)
{
}
LightningDefineType(AnySyntaxType, builder, type)
{
}
LightningDefineType(IndirectionSyntaxType, builder, type)
{
}
LightningDefineType(BoundSyntaxType, builder, type)
{
}
LightningDefineType(DelegateSyntaxType, builder, type)
{
}

LightningDefineType(SyntaxNode, builder, type)
{
}
LightningDefineType(RootNode, builder, type)
{
}
LightningDefineType(AttributeNode, builder, type)
{
}
LightningDefineType(StatementNode, builder, type)
{
}
LightningDefineType(ExpressionNode, builder, type)
{
}
LightningDefineType(BinaryOperatorNode, builder, type)
{
}
LightningDefineType(UnaryOperatorNode, builder, type)
{
}
LightningDefineType(PropertyDelegateOperatorNode, builder, type)
{
}
LightningDefineType(TypeCastNode, builder, type)
{
}
LightningDefineType(PostExpressionNode, builder, type)
{
}
LightningDefineType(IndexerCallNode, builder, type)
{
}
LightningDefineType(FunctionCallNode, builder, type)
{
}
LightningDefineType(MemberAccessNode, builder, type)
{
}
LightningDefineType(ExpressionInitializerNode, builder, type)
{
}
LightningDefineType(ExpressionInitializerMemberNode, builder, type)
{
}
LightningDefineType(ExpressionInitializerAddNode, builder, type)
{
}
LightningDefineType(MultiExpressionNode, builder, type)
{
}
LightningDefineType(VariableNode, builder, type)
{
}
LightningDefineType(LocalVariableNode, builder, type)
{
}
LightningDefineType(ParameterNode, builder, type)
{
}
LightningDefineType(MemberVariableNode, builder, type)
{
}
LightningDefineType(ValueNode, builder, type)
{
}
LightningDefineType(StringInterpolantNode, builder, type)
{
}
LightningDefineType(DeleteNode, builder, type)
{
}
LightningDefineType(ReturnNode, builder, type)
{
}
LightningDefineType(ScopeNode, builder, type)
{
}
LightningDefineType(StaticTypeNode, builder, type)
{
}
LightningDefineType(TimeoutNode, builder, type)
{
}
LightningDefineType(IfNode, builder, type)
{
}
LightningDefineType(IfRootNode, builder, type)
{
}
LightningDefineType(SendsEventNode, builder, type)
{
}
LightningDefineType(BreakNode, builder, type)
{
}
LightningDefineType(DebugBreakNode, builder, type)
{
}
LightningDefineType(ContinueNode, builder, type)
{
}
LightningDefineType(LoopScopeNode, builder, type)
{
}
LightningDefineType(ConditionalLoopNode, builder, type)
{
}
LightningDefineType(WhileNode, builder, type)
{
}
LightningDefineType(DoWhileNode, builder, type)
{
}
LightningDefineType(ForNode, builder, type)
{
}
LightningDefineType(ForEachNode, builder, type)
{
}
LightningDefineType(LoopNode, builder, type)
{
}
LightningDefineType(GenericFunctionNode, builder, type)
{
}
LightningDefineType(FunctionNode, builder, type)
{
}
LightningDefineType(InitializerNode, builder, type)
{
}
LightningDefineType(ConstructorNode, builder, type)
{
}
LightningDefineType(DestructorNode, builder, type)
{
}
LightningDefineType(ClassNode, builder, type)
{
}
LightningDefineType(TypeDefineNode, builder, type)
{
}
LightningDefineType(LocalVariableReferenceNode, builder, type)
{
}
LightningDefineType(ThrowNode, builder, type)
{
}
LightningDefineType(TypeIdNode, builder, type)
{
}
LightningDefineType(MemberIdNode, builder, type)
{
}
LightningDefineType(EnumValueNode, builder, type)
{
}
LightningDefineType(EnumNode, builder, type)
{
}
...
SyntaxTree::~SyntaxTree()
{
  ...
  LightningForEach (const UserToken* token, this->InvalidTokens)
    delete token;
}
...
{
  LightningBase::PopulateChildren(childrenOut);
...
String SyntaxNode::GetMergedComments()
{
  ...
  for (size_t i = 0; i < this->Comments.Size(); ++i)
  {
    ...
    LightningForEach (String line, comment.Split("\n"))
    {
...
Type* ValueNode::PrecomputeType() const
{
  ...
  case Grammar::IntegerLiteral:
    return LightningTypeId(Integer);

  case Grammar::DoubleIntegerLiteral:
    return LightningTypeId(DoubleInteger);

  case Grammar::RealLiteral:
    return LightningTypeId(Real);

  case Grammar::DoubleRealLiteral:
    return LightningTypeId(DoubleReal);

  case Grammar::StringLiteral:
    return LightningTypeId(String);

  case Grammar::True:
  case Grammar::False:
    return LightningTypeId(Boolean);

  case Grammar::Null:
    return LightningTypeId(NullPointerType);
  default:
    break;
  }
