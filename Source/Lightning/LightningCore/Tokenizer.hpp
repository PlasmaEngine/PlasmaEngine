...
#pragma once
#ifndef LIGHTNING_TOKENIZER_HPP
#  define LIGHTNING_TOKENIZER_HPP

namespace Lightning
{
// This class parses the input stream using a grammar
class PlasmaShared Tokenizer
{
public:
  // Constructor
...
private:
  ...
  // Not copyable
  LightningNoCopy(Tokenizer);
};

// Character utilities that we use for tokenizing
class PlasmaShared CharacterUtilities
{
public:
