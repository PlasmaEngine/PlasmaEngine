...
#pragma once
#ifndef LIGHTNING_CODE_LOCATION_HPP
#  define LIGHTNING_CODE_LOCATION_HPP

namespace Lightning
{
// We can print Lightning messages in many different formats
...
enum Enum
{
  // This is the standard format we use to print Lightning error messages
  ...
  // Msvc errors are useful when editing Lightning inside of Visual Studio,
...
class PlasmaShared CodeLocation
{
public:
  // Default constructor
  CodeLocation();
  ...
  // The plasma-based character position from the associated code
...
// UserToken!
template <>
struct PlasmaShared MoveWithoutDestructionOperator<Lightning::CodeLocation>
{
  static inline void MoveWithoutDestruction(Lightning::CodeLocation* dest, Lightning::CodeLocation* source)
  {
