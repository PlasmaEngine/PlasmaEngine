                                    ...
                                    const void* userData)
{
  ...
  BoundType* pairRangeType =
      builder.InstantiateTemplate("HashMapRange", LightningConstants(keyType, valueType), Module()).Type;
  ...
  BoundType* valueRangeType =
      builder.InstantiateTemplate("HashMapValueRange", LightningConstants(valueType), Module()).Type;
                                         ...
                                         const void* userData)
{
  ...
  LightningFullBindGetterSetter(
      builder, rangeType, &AnyHashMapRange::IsEmpty, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsEmpty");
  LightningFullBindGetterSetter(
      builder, rangeType, &AnyHashMapRange::IsNotEmpty, LightningNoOverload, LightningNoSetter, LightningNoOverload, "IsNotEmpty");
