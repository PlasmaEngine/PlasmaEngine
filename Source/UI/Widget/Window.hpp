...
{
public:
  LightningDeclareType(HighlightBorderEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(WindowTabEvent, TypeCopyMode::ReferenceType);
  WindowTabEvent()
  {
...
{
public:
  LightningDeclareType(TabModifiedEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(TabRenamedEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(QueryModifiedSaveEvent, TypeCopyMode::ReferenceType);
...
{
public:
  typedef TabWidget LightningSelf;
...
{
public:
  LightningDeclareType(TabArea, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Window, TypeCopyMode::ReferenceType);
