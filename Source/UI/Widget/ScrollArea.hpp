...
{
public:
  typedef ScrollBar LightningSelf;
...
{
public:
  LightningDeclareType(BaseScrollArea, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ScrollArea, TypeCopyMode::ReferenceType);
