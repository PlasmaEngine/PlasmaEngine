...
LightningDefineType(Layout, builder, type)
{
  LightningBindDestructor();

  LightningBindMethod(Measure);
  LightningBindMethod(DoLayout);

  LightningBindFieldProperty(Padding);
}
...
LightningDefineType(LayoutArea, builder, type)
{
}

LightningDefineType(FillLayout, builder, type)
{
}
...
LightningDefineType(StackLayout, builder, type)
{
}
...
LightningDefineType(EdgeDockLayout, builder, type)
{
}
...
LightningDefineType(DockLayout, builder, type)
{
}
...
LightningDefineType(RatioLayout, builder, type)
{
}
...
LightningDefineType(GridLayout, builder, type)
{
}
