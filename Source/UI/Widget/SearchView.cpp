...
LightningDefineType(SearchViewEvent, builder, type)
{
}

LightningDefineType(AlternateSearchCompletedEvent, builder, type)
{
}
...
{
  Plasma::Sort(Results.All(), SortByPriority());
}
...
LightningDefineType(SearchViewElement, builder, type)
{
}
...
LightningDefineType(SearchView, builder, type)
{
}
