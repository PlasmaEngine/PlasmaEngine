...
{
public:
  LightningDeclareType(ModalConfirmEvent, TypeCopyMode::ReferenceType);
  ModalConfirmEvent();
...
{
public:
  LightningDeclareType(ModalButtonEvent, TypeCopyMode::ReferenceType);
  String mButtonName;
...
{
public:
  LightningDeclareType(Modal, TypeCopyMode::ReferenceType);
...
public:
  /// Typedefs.
  typedef ModalConfirmAction LightningSelf;
...
public:
  /// Typedefs.
  typedef ModalButtonsAction LightningSelf;
