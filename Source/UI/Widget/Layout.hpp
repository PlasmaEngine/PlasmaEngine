...
struct LayoutArea
{
  LightningDeclareType(LayoutArea, TypeCopyMode::ValueType);
...
{
public:
  LightningDeclareType(Layout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(FillLayout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(StackLayout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EdgeDockLayout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(DockLayout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RatioLayout, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GridLayout, TypeCopyMode::ReferenceType);
