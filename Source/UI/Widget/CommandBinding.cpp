...
LightningDefineType(MetaScriptTagAttribute, builder, type)
{
  LightningBindField(mTags);
}
...
LightningDefineType(MetaScriptShortcutAttribute, builder, type)
{
  LightningBindField(mKey);
  LightningBindField(mCtrl)->AddAttribute(PropertyAttributes::cOptional);
  LightningBindField(mAlt)->AddAttribute(PropertyAttributes::cOptional);
  LightningBindField(mShift)->AddAttribute(PropertyAttributes::cOptional);
}
