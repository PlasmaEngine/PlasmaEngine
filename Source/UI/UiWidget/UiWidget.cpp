...
LightningDefineType(UiTransformUpdateEvent, builder, type)
{
  PlasmaBindDocumented();
  LightningBindGetterProperty(RootWidget);
}
...
LightningDefineType(UiWidgetCastResultsRange, builder, type)
{
  PlasmaBindDocumented();
  // METAREFACTOR - range type?
  // BindAsRangeType();
  LightningBindMethod(Empty);
  LightningBindMethod(Front);
  LightningBindMethod(PopFront);
  LightningBindMethod(Size);
}
...
// Widget
LightningDefineType(UiWidget, builder, type)
{
  PlasmaBindDocumented();
  PlasmaBindComponent();
  ...
  LightningBindMethod(MarkAsNeedsUpdate);

  LightningBindGetterSetter(LocalTopLeft);
  LightningBindGetterSetter(WorldTopLeft);
  LightningBindGetterSetter(LocalTopCenter);
  LightningBindGetterSetter(WorldTopCenter);
  LightningBindGetterSetter(LocalTopRight);
  LightningBindGetterSetter(WorldTopRight);

  LightningBindGetterSetter(LocalCenterLeft);
  LightningBindGetterSetter(WorldCenterLeft);
  LightningBindGetterSetter(LocalCenter);
  LightningBindGetterSetter(WorldCenter);
  LightningBindGetterSetter(LocalCenterRight);
  LightningBindGetterSetter(WorldCenterRight);

  LightningBindGetterSetter(LocalBottomLeft);
  LightningBindGetterSetter(WorldBottomLeft);
  LightningBindGetterSetter(LocalBottomCenter);
  LightningBindGetterSetter(WorldBottomCenter);
  LightningBindGetterSetter(LocalBottomRight);
  LightningBindGetterSetter(WorldBottomRight);
  ...
  LightningBindGetterSetterProperty(SizePolicyX)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  LightningBindGetterSetterProperty(SizePolicyY)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  LightningBindFieldProperty(mFlexSize)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();

  LightningBindGetterSetterProperty(VerticalAlignment)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  LightningBindGetterSetterProperty(HorizontalAlignment)
      ->PlasmaSetPropertyGroup(sLayoutGroup)
      ->PlasmaLocalModificationOverride();

  LightningBindGetterSetterProperty(MarginLeft)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  LightningBindGetterSetterProperty(MarginTop)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  LightningBindGetterSetterProperty(MarginRight)->PlasmaSetPropertyGroup(sLayoutGroup)->PlasmaLocalModificationOverride();
  ...
  LightningBindMethod(TakeFocus);
  LightningBindMethod(LoseFocus);
  LightningBindMethod(TabJump);
  LightningBindMethod(TabJumpDirection);
  LightningBindMethod(TransformPoint);
  LightningBindMethod(TransformPointInverse);
  LightningBindMethod(CastPoint);
  LightningBindMethod(CastRect);
...
void UiWidget::OnPropertyModified(PropertyEvent* e)
{
  ...
  if (modifiedType->IsA(LightningTypeId(Transform)))
    SetLocalTranslation(GetLocalTranslation());
  else if (modifiedType->IsA(LightningTypeId(Area)))
    SetSize(GetSize());
}
