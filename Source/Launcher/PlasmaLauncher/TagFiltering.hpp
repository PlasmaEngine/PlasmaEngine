...
/// TagPolicy for PlasmaBuilds
struct PlasmaBuildTagPolicy
{
  ...
  PlasmaBuildTagPolicy(LauncherConfig* launcherConfig)
  {
  ...
  TagSet& GetTagSet(PlasmaBuild* build)
  {
    return build->GetBuildContent(true)->mTagSet;
  }

  String GetName(PlasmaBuild* build)
  {
...
struct TemplatePackageTagPolicy
{
  ...
  {
    return project->GetPlasmaTemplate(true)->mTagSet;
  }
