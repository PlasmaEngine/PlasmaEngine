...
void DiscoverMenu::CreateTiles(Composite* parent)
{
  ...
  mTiles->SetLayout(CreateRowLayout());
  {
    ...
    {
      // Documentation tile
      Composite* plasmaHub = new DiscoverTile(left, "Plasma Website", "TileTitleText", Pixels(74), Urls::cUserPlasmaHub);
      plasmaHub->SetSizing(SizePolicy::Fixed, Pixels(316, 170));
      ...
      bottom->SetLayout(CreateRowLayout());
      {
        ...
        roadmap->SetSizing(SizePolicy::Fixed, Pixels(316, 150));
      }
    }
    ...
    right->SetSizing(SizePolicy::Fixed, Pixels(316, 329));
    right->SetLayout(CreateStackLayout());
    {
      ...
      documentation->SetSizing(SizePolicy::Fixed, Pixels(316, 170));
      ...
      {
        // QA
        Composite* QA = new DiscoverTile(bottom, "Answers", "TileTitleTextMedium", Pixels(44), Urls::cUserQa);
        QA->SetSizing(SizePolicy::Fixed, Pixels(316, 150));
      }
    }
  }
}
