...
public:
  /// Typedefs.
  typedef MenuTextButton LightningSelf;
...
public:
  /// Typedefs.
  typedef MainButton LightningSelf;
  ...
  void SetVersionAndProject(PlasmaBuild* version, Project* project);
...
public:
  /// Typedefs.
  typedef LauncherWindow LightningSelf;
  ...
  void OnMouseDown(MouseEvent* e);
  /// Check for drag and drop of .plasmaproj, plasma builds and templates
  ...
  /// Search for a .plasmaproj when the browse button is pressed.
