...
class PlasmaBuildContent : public Component
{
public:
  LightningDeclareType(PlasmaBuildContent, TypeCopyMode::ReferenceType);
...
class PlasmaBuildReleaseNotes : public Component
{
public:
  LightningDeclareType(PlasmaBuildReleaseNotes, TypeCopyMode::ReferenceType);
...
/// and locally set.
class PlasmaBuildDeprecated : public Component
{
public:
  LightningDeclareType(PlasmaBuildDeprecated, TypeCopyMode::ReferenceType);
...
/// Information about a build being deprecated. This can be both from the server
/// and locally set.
class PlasmaTemplate : public Component
{
public:
  LightningDeclareType(PlasmaTemplate, TypeCopyMode::ReferenceType);
  ...
  /// the 'other' template.
  bool IsMoreExactRangeThan(const BuildId& buildId, PlasmaTemplate* otherTemplate);
