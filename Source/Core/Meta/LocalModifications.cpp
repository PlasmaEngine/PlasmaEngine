...
LightningDefineType(MetaDataInheritance, builder, type)
{
}

LightningDefineType(MetaDataInheritanceRoot, builder, type)
{
}
...
bool ObjectContainsProperty(HandleParam object, Property* property)
{
  ...
  {
    BoundType* propertyType = Lightning::BoundType::GetBoundType(property->PropertyType);
