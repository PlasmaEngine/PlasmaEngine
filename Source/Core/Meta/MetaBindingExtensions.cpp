...
{
  if (Object* plasmaObject = object.Get<Object*>())
  {
    ...
    if (EventDispatcher* dispatcher = plasmaObject->GetDispatcher())
...
// Property Event
LightningDefineType(PropertyEvent, builder, type)
{
  PlasmaBindEvent(Events::PropertyModified, PropertyEvent);
  PlasmaBindEvent(Events::PropertyModifiedIntermediate, PropertyEvent);
}
...
// Type Event
LightningDefineType(TypeEvent, builder, type)
{
}
...
void BindEventSent(LibraryBuilder& builder, BoundType* boundType, StringParam eventName, BoundType* eventType)
{
  ...
  ErrorIf(!eventType->IsA(LightningTypeId(Event)),
...
LightningDefineType(MetaOperations, builder, type)
{
}

LightningDefineType(MetaDisplay, builder, type)
{
}

LightningDefineType(TypeNameDisplay, builder, type)
{
}

LightningDefineType(StringNameDisplay, builder, type)
{
}

LightningDefineType(MetaTransform, builder, type)
{
}
...
// Meta Attribute
LightningDefineType(MetaAttribute, builder, type)
{
}
