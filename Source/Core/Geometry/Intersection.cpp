...
const real cPlanePlanePlanePlasma = real(0.000001);
                   ...
                   Manifold* manifold)
{
  ...
  Plasma::gDebugDraw->Add(Plasma::Debug::LineCross(closestPoint, real(0.5)));
#endif
...
#ifdef VisualizeCapsuleSphere
    Plasma::gDebugDraw->Add(Plasma::Debug::Sphere(v, real(0.1)).Color(Color::Red));
    Plasma::gDebugDraw->Add(Plasma::Debug::Sphere(closestPoint, real(0.1)).Color(Color::Blue));
#endif
                ...
                Manifold* manifold)
{
  ...
  // If direction is the plasma vector, the planes are parallel (and separated) or
...
Type PlanePlanePlane(Vec4Param planeA, Vec4Param planeB, Vec4Param planeC, Manifold* manifold)
{
  ...
  if (Math::Abs(denom) < cPlanePlanePlanePlasma)
  {
    return Other;
  }
