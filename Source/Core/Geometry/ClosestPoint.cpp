...
namespace
{
const real cSegmentSegmentPlasma = real(0.000001);
}
                                ...
                                Vec3Ptr closestPointB)
{
  ...
  if (oneSqLength <= cSegmentSegmentPlasma && twoSqLength <= cSegmentSegmentPlasma)
  {
  ...
  if (oneSqLength <= cSegmentSegmentPlasma)
  {
  ...
  else
  {
    ...
    if (twoSqLength <= cSegmentSegmentPlasma)
    {
