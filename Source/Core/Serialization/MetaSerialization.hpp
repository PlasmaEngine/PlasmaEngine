...
#define PlasmaBindSerializationPrimitive() type->AddAttribute(SerializationAttributes::cSerializationPrimitive)
#define PlasmaBindSerializationPrimitiveExternal(type)                                                                   \
  LightningTypeId(type)->AddAttribute(SerializationAttributes::cSerializationPrimitive)

// Meta Serialization
class MetaSerialization : public ReferenceCountedEventObject
{
public:
  LightningDeclareType(MetaSerialization, TypeCopyMode::ReferenceType);
  ...
  // The default serialize object assumes that the value inherits from Plasma's
  // Object class
...
{
public:
  LightningDeclareType(EnumMetaSerialization, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PrimitiveMetaSerialization, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MetaStringSerialization, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SerializationFilter, TypeCopyMode::ReferenceType);
