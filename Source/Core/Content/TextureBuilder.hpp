...
{
public:
  LightningDeclareType(TextureInfo, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ShowPremultipliedAlphaFilter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ShowGammaCorrectionFilter, TypeCopyMode::ReferenceType);
  bool Filter(Member* prop, HandleParam instance) override;
};
...
{
public:
  LightningDeclareType(TextureBuilder, TypeCopyMode::ReferenceType);
...
//{
// public:
//  PlasmaDeclareType(HeightToNormalBuilder);
