...
#pragma once
#include "Core/Engine/EngineEvents.hpp"
...
{
public:
  LightningDeclareType(ImageOptions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(GeometryOptions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ShowNormalGenerationOptionsFilter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AudioOptions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ConflictOptions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ImportOptions, TypeCopyMode::ReferenceType);
