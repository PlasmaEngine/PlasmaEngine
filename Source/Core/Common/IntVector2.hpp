...
struct PlasmaShared IntVector2
{
  IntVector2(void)
  {
  }
...
/// Binary Operators (integers)
PlasmaShared IntVector2 operator*(int lhs, IntVec2Param rhs);

/// Returns a vector with absolute valued elements of the given vector.
PlasmaShared IntVector2 Abs(IntVec2Param vec);

/// Returns the component-wise minimum vector of the two vectors.
PlasmaShared IntVector2 Min(IntVec2Param lhs, IntVec2Param rhs);

/// Returns the component-wise maximum vector of the two vectors.
PlasmaShared IntVector2 Max(IntVec2Param lhs, IntVec2Param rhs);

/// Compute the dot product of two vectors.
PlasmaShared int Dot(IntVec2Param lhs, IntVec2Param rhs);
