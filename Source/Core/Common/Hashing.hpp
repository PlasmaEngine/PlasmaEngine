...
template <typename T>
struct PlasmaSharedTemplate has_hash_function_helper
{
...
/// as false
template <typename T>
struct PlasmaSharedTemplate has_hash_function : public integral_constant<bool, has_hash_function_helper<T>::value>
{
};
...
struct PlasmaSharedTemplate HashPolicy : public ComparePolicy<T>
{
...
template <typename T>
struct PlasmaSharedTemplate HashPolicy<T, TC_ENABLE_IF(has_hash_function<T>::value)> : public ComparePolicy<T>
{
public:
...
/// HashPolicy for bool
template <>
struct PlasmaShared HashPolicy<bool> : public ComparePolicy<bool>
{
...
template <>
struct PlasmaShared HashPolicy<short> : public ComparePolicy<int>
{
...
/// HashPolicy for int
template <>
struct PlasmaShared HashPolicy<int> : public ComparePolicy<int>
{
...
template <>
struct PlasmaShared HashPolicy<unsigned int> : public ComparePolicy<unsigned int>
{
...
/// HashPolicy for long
template <>
struct PlasmaShared HashPolicy<long> : public ComparePolicy<long>
{
...
template <>
struct PlasmaShared HashPolicy<unsigned long> : public ComparePolicy<unsigned long>
{
...
struct PlasmaSharedTemplate HashPolicy<type*> : public ComparePolicy<type*>
{
...
template <>
struct PlasmaShared HashPolicy<float> : public ComparePolicy<float>
{
...
template <>
struct PlasmaShared HashPolicy<const char*> : public ComparePolicy<const char*>
{
...
/// HashPolicy for u64
template <>
struct PlasmaShared HashPolicy<u64> : public ComparePolicy<u64>
{
...
/// HashPolicy for Guid
template <>
struct PlasmaShared HashPolicy<Guid> : public ComparePolicy<Guid>
{
...
/// HashPolicy for s64
template <>
struct PlasmaShared HashPolicy<s64> : public ComparePolicy<s64>
{
...
template <typename T>
struct PlasmaSharedTemplate has_valid_hash_policy_helper
{
...
template <typename T>
struct PlasmaSharedTemplate has_valid_hash_policy : public integral_constant<bool, has_valid_hash_policy_helper<T>::value>
{
};
