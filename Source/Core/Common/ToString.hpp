...
template <typename T>
struct PlasmaSharedTemplate has_member_to_string_helper
{
...
/// defined as false
template <typename T>
struct PlasmaSharedTemplate has_member_to_string : public integral_constant<bool, has_member_to_string_helper<T>::value>
{
};
...
PlasmaShared inline String ToString(StringParam value, bool shortFormat = false)
{
  return value;
}

PlasmaShared inline String ToString(StringRangeParam value, bool shortFormat = false)
{
  return value;
}

PlasmaShared inline String ToString(cstr value, bool shortFormat = false)
{
  return value;
}
...
PlasmaSharedTemplate String ToString(const T& value, bool shortFormat = false)
{
  return value.ToString(shortFormat);
}
template <typename T, TF_ENABLE_IF(has_member_to_string<T>::value)>
PlasmaSharedTemplate String ToString(T* const value, bool shortFormat = false)
{
  return value->ToString(shortFormat);
}
...
PlasmaSharedTemplate String ToString(const T& value, bool shortFormat = false)
{
  // Create plasmaed character buffer
...
template <typename T>
struct PlasmaSharedTemplate has_global_to_string_helper
{
  template <typename T2>
...
template <typename T>
struct PlasmaSharedTemplate has_global_to_string : public integral_constant<bool, has_global_to_string_helper<T>::value>
{
};
