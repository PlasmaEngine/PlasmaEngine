...
class PlasmaShared StringRange
{
public:
...
class PlasmaShared StringSplitRange
{
public:
...
class PlasmaShared StringIterator
{
public:
...
class PlasmaShared StringTokenRange
{
public:
...
template <>
struct PlasmaShared HashPolicy<StringRange>
{
...
template <>
struct PlasmaShared HashPolicy<String>
{
...
template <>
struct PlasmaShared MoveWithoutDestructionOperator<String>
{
