...
template <typename T>
PlasmaSharedTemplate void DestructObject(void* source)
{
  // Get source object
...
template <typename T>
PlasmaSharedTemplate void DefaultConstructObject(void* destination)
{
...
template <typename T>
PlasmaSharedTemplate void CopyConstructObject(const void* source, void* destination)
{
  // Get source object
...
template <typename T>
PlasmaSharedTemplate void MoveConstructObject(void* source, void* destination)
{
  // Get source object
  T& sourceObject = *reinterpret_cast<T*>(source);
  ...
  // source object
  new (destination) T(PlasmaMove(sourceObject));
}

/// Returns true if the object at lhs is equal to the object at rhs, else false
/// (Requires a valid compare policy for T)
template <typename T>
PlasmaSharedTemplate bool EqualToObject(const void* lhs, const void* rhs)
{
...
template <typename T>
PlasmaSharedTemplate size_t HashObject(const void* source)
{
...
/// function for T)
template <typename T>
PlasmaSharedTemplate String ObjectToString(const void* source, bool shortFormat)
{
  // Get source object
  const T& sourceObject = *reinterpret_cast<const T*>(source);
...
template <typename T>
PlasmaSharedTemplate void StringToObject(StringRange source, void* destination)
{
...
PlasmaSharedTemplate DestructObjectFn GetDestructObjectFn()
{
...
PlasmaSharedTemplate DefaultConstructObjectFn GetDefaultConstructObjectFn()
{
...
PlasmaSharedTemplate CopyConstructObjectFn GetCopyConstructObjectFn()
{
...
PlasmaSharedTemplate MoveConstructObjectFn GetMoveConstructObjectFn()
{
...
PlasmaSharedTemplate EqualToObjectFn GetEqualToObjectFn()
{
...
PlasmaSharedTemplate HashObjectFn GetHashObjectFn()
{
  return HashObject<T>;
}
...
PlasmaSharedTemplate ObjectToStringFn GetObjectToStringFn()
{
...
PlasmaSharedTemplate StringToObjectFn GetStringToObjectFn()
{
