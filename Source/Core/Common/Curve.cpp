...
Vec3 BakedCurve::SampleTable(float distance, Vec3* tangent) const
{
  ...
  // value wasn't plasma then instead use the total arc-length.
...
void PiecewiseFunction::SetControlPoints(Plasma::Array<ControlPoint>& controlPoints)
{
