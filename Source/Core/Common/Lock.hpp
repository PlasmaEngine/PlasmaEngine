...
template <typename T>
struct PlasmaSharedTemplate Locked
{
...
class PlasmaSharedTemplate LockedRange
{
public:
  /// Typedefs
  ...
  LockedRange(MoveReference<LockedRange> rhs) :
      mContainer(PlasmaMove(rhs->mContainer)),
