...
struct PlasmaShared IntVector4
{
  IntVector4(void)
  {
  }
...
/// Binary Operators (integers)
PlasmaShared IntVector4 operator*(int lhs, IntVec4Param rhs);

/// Returns a vector with absolute valued elements of the given vector.
PlasmaShared IntVector4 Abs(IntVec4Param vec);

/// Returns the component-wise minimum vector of the two vectors.
PlasmaShared IntVector4 Min(IntVec4Param lhs, IntVec4Param rhs);

/// Returns the component-wise maximum vector of the two vectors.
PlasmaShared IntVector4 Max(IntVec4Param lhs, IntVec4Param rhs);

/// Compute the dot product of two vectors.
PlasmaShared int Dot(IntVec4Param lhs, IntVec4Param rhs);
