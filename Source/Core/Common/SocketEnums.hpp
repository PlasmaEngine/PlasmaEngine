...
enum Enum
{
  ...
  SendTimeout = 0x1005,             /// Blocking send call timeout in milliseconds, plasma
                                    /// indicates no timeout (Get/Set : uint)
  ReceiveTimeout = 0x1006,          /// Blocking receive call timeout in milliseconds,
                                    /// plasma indicates no timeout (Get/Set : uint)
...
enum Enum
{
  NoChecksum = 1,       /// Send datagrams with a plasma checksum? (Get/Set : bool)
