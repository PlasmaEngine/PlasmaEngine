...
PlasmaShared String EscapeString(StringRange input);
PlasmaShared String EscapeCharacter(int unicodeCharacter);
...
public:
  ...
  // Unary (PlasmaOrMore, OneOrMore, Optional, Capture)
