...
/// template argument
#define PlasmaDeclareHasMemberTrait(TypeTraitName, MemberName)                                                           \
  template <typename LightningT>                                                                                           \
  static ::Plasma::TrueType check_##TypeTraitName(decltype(&LightningT::MemberName)*);                                       \
  template <typename LightningT>                                                                                           \
  static ::Plasma::FalseType check_##TypeTraitName(...);                                                                 \
  template <typename LightningT>                                                                                           \
  struct TypeTraitName : public decltype(check_##TypeTraitName<LightningT>(nullptr))                                       \
  {                                                                                                                    \
  };
...
#define TC_ENABLE_IF(Condition) typename Plasma::enable_if<(Condition)>::type
#define TC_ENABLE_IF_IS_SAME(TypeA, TypeB) typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type
#define TC_DISABLE_IF(Condition) typename Plasma::disable_if<(Condition)>::type
#define TC_DISABLE_IF_IS_SAME(TypeA, TypeB) typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type

/// Enable If via Function Template Parameter (Declaration)
#define TF_ENABLE_IF(Condition) typename Plasma::enable_if<(Condition)>::type* = nullptr
#define TF_ENABLE_IF_IS_SAME(TypeA, TypeB)                                                                             \
  typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = nullptr
#define TF_DISABLE_IF(Condition) typename Plasma::disable_if<(Condition)>::type* = nullptr
#define TF_DISABLE_IF_IS_SAME(TypeA, TypeB)                                                                            \
  typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = nullptr

/// Enable If via Function Template Parameter (Definition)
#define TF_ENABLE_IF_DEF(Condition) typename Plasma::enable_if<(Condition)>::type*
#define TF_ENABLE_IF_IS_SAME_DEF(TypeA, TypeB) typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type*
#define TF_DISABLE_IF_DEF(Condition) typename Plasma::disable_if<(Condition)>::type*
#define TF_DISABLE_IF_IS_SAME_DEF(TypeA, TypeB) typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type*

/// Enable If via Function Return Type
#define R_ENABLE_IF(Condition, ReturnType) typename Plasma::enable_if<(Condition), ReturnType>::type
#define R_DISABLE_IF(Condition, ReturnType) typename Plasma::disable_if<(Condition), ReturnType>::type

/// Enable If via Function Parameter (Declaration)
#define P_ENABLE_IF(Condition) typename Plasma::enable_if<(Condition)>::type* = nullptr
#define P_ENABLE_IF_IS_SAME(TypeA, TypeB)                                                                              \
  typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = nullptr
#define P_DISABLE_IF(Condition) typename Plasma::disable_if<(Condition)>::type* = nullptr
#define P_DISABLE_IF_IS_SAME(TypeA, TypeB)                                                                             \
  typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type* = nullptr

/// Enable If via Function Parameter (Definition)
#define P_ENABLE_IF_DEF(Condition) typename Plasma::enable_if<(Condition)>::type*
#define P_ENABLE_IF_IS_SAME_DEF(TypeA, TypeB) typename Plasma::enable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type*
#define P_DISABLE_IF_DEF(Condition) typename Plasma::disable_if<(Condition)>::type*
#define P_DISABLE_IF_IS_SAME_DEF(TypeA, TypeB) typename Plasma::disable_if<(Plasma::is_same<TypeA, TypeB>::value)>::type*
...
/// Determines how PlasmaMove is applied to types
template <typename T, typename Enable = void>
struct PlasmaMoveHelper;

// Is built-in type?
template <typename T>
struct PlasmaMoveHelper<T, TC_ENABLE_IF(is_scalar<typename remove_const_and_volatile<T>::type>::value)>
{
  typedef T type;
};
...
template <typename T>
typename PlasmaMoveHelper<T>::type PlasmaMove(T& value)
{
  return (typename PlasmaMoveHelper<T>::type)(value);
}
