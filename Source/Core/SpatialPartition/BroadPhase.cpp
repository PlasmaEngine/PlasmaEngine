...
LightningDefineType(IBroadPhase, builder, type)
{
}
...
{
  ErrorIf(true, "CreateProxy function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CreateProxies(BroadPhaseObjectArray& objects)
{
  ErrorIf(true, "CreateProxies function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::RemoveProxy(BroadPhaseProxy& proxy)
{
  ErrorIf(true, "RemoveProxy function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::RemoveProxies(ProxyHandleArray& proxies)
{
  ErrorIf(true, "RemoveProxies function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::UpdateProxy(BroadPhaseProxy& proxy, BroadPhaseData& data)
{
  ErrorIf(true, "UpdateProxy function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::UpdateProxies(BroadPhaseObjectArray& objects)
{
  ErrorIf(true, "UpdateProxies function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::SelfQuery(ClientPairArray& results)
{
  ErrorIf(true, "SelfQuery function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::Query(BroadPhaseData& data, ClientPairArray& results)
{
  ErrorIf(true, "Query function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::BatchQuery(BroadPhaseDataArray& data, ClientPairArray& results)
{
  ErrorIf(true, "BatchQuery function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::Construct()
{
  ErrorIf(true, "Construct function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CastRay(CastDataParam data, ProxyCastResults& results)
{
  ErrorIf(true, "CastRay function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CastSegment(CastDataParam data, ProxyCastResults& results)
{
  ErrorIf(true, "CastSegment function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CastAabb(CastDataParam data, ProxyCastResults& results)
{
  ErrorIf(true, "CastAabb function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CastSphere(CastDataParam data, ProxyCastResults& results)
{
  ErrorIf(true, "CastSphere function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::CastFrustum(CastDataParam data, ProxyCastResults& results)
{
  ErrorIf(true, "CastFrustum function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::RegisterCollisions()
{
  ErrorIf(true, "RegisterCollisions function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}

void IBroadPhase::Cleanup()
{
  ErrorIf(true, "Cleanup function not implemented on BroadPhase %s", LightningGetDerivedType()->Name.c_str());
}
