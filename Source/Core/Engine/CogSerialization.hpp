...
public:
  /// Meta Initialization.
  LightningDeclareType(LinkId, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Named, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Archetyped, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EditorFlags, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpaceObjects, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ArchetypeInstance, TypeCopyMode::ReferenceType);
  String Name;
  uint Version;
};
