...
{
public:
  LightningDeclareType(ResourceEvent, TypeCopyMode::ReferenceType);
  ResourceEvent();
...
#define DeclareResourceManager(ManagerType, ManagerResourceType)                                                       \
  typedef ResourceManager LightningBase;                                                                                   \
  typedef ManagerType LightningSelf;                                                                                       \
...
#define ImplementResourceManager(ManagerType, ManagerResourceType)                                                     \
  ...
  {                                                                                                                    \
    BoundType* metaType = LightningTypeId(ManagerResourceType);                                                            \
