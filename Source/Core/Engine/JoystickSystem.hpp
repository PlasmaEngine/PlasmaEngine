...
{
public:
  LightningDeclareType(RawControlMapping, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(JoystickEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Joystick, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Joysticks, TypeCopyMode::ReferenceType);
