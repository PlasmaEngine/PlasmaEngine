...
{
public:
  LightningDeclareType(RaycastProvider, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Raycaster, TypeCopyMode::ReferenceType);
  ~Raycaster();
...
{
public:
  LightningDeclareType(RaycasterMetaComposition, TypeCopyMode::ReferenceType);
