...
/// method passed in
MethodDoc* MethodDocWithSameParams(Array<MethodDoc*>& methodList, Lightning::Function* metaMeth);

/// Loads from lightning, saves to data file, then safe deletes
...
/// Contains the name, description, shortcut, and list of tags for a plasma
/// command
...
/// class for documenting all the attributes usable in plasma
