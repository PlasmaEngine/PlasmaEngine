...
{
public:
  LightningDeclareType(AnimationGraph, TypeCopyMode::ReferenceType);
  ...
  BlendSpace1D* CreateBlendSpace1D();
  BlendSpace2D* CreateBlendSpace2D();
...
{
public:
  LightningDeclareType(SimpleAnimation, TypeCopyMode::ReferenceType);
