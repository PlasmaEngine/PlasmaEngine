...
class LightningLibraryResource : public Resource
{
public:
  LightningDeclareType(LightningLibraryResource, TypeCopyMode::ReferenceType);
...
// Lightning Document
class LightningDocumentResource : public DocumentResource, public ICodeInspector
{
public:
  LightningDeclareType(LightningDocumentResource, TypeCopyMode::ReferenceType);

  LightningDocumentResource();
  ...
  bool SupportsPlasmaConnect() override;
