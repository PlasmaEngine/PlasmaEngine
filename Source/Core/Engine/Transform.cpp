...
LightningDefineType(TransformMetaTransform, builder, type)
{
}
...
MetaTransformInstance TransformMetaTransform::BuildInstance(Transform* transform)
{
  ...
  BoundType* t = LightningTypeId(Transform);
...
LightningDefineType(Transform, builder, type)
{
  ...
  LightningBindMethod(TransformNormalLocal);
  LightningBindMethod(TransformPointLocal);
  LightningBindMethod(TransformNormalInverse);
  LightningBindMethod(TransformPointInverse);

  LightningBindMethod(RotateLocal);
  LightningBindMethod(RotateWorld);
  LightningBindMethod(RotateAround);

  LightningBindMethod(RotateAnglesLocal);
  LightningBindMethod(RotateAnglesWorld);
  ...
  LightningBindGetterSetter(LocalRotation);
  LightningBindGetterSetter(LocalTranslation);

  LightningBindGetterSetter(WorldScale);
  LightningBindGetterSetter(WorldRotation);
  LightningBindGetterSetter(WorldTranslation);

  LightningBindGetter(WorldMatrix);
