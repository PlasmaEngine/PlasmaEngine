...
LightningDefineType(Action, builder, type)
{
  PlasmaBindDocumented();
  LightningBindMethod(Cancel);
  LightningBindGetterProperty(Completed);
  LightningBindGetterProperty(Active);
  LightningBindGetterProperty(Started);
}
...
LightningDefineType(ActionSet, builder, type)
{
  PlasmaBindDocumented();
}

LightningDefineType(Actions, builder, type)
{
  PlasmaBindDocumented();
}
...
LightningDefineType(ActionGroup, builder, type)
{
  PlasmaBindDocumented();
}
...
LightningDefineType(ActionSequence, builder, type)
{
  PlasmaBindDocumented();
}
