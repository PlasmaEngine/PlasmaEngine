...
{
public:
  LightningDeclareType(ProjectDescription, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(WindowLaunchSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(FrameRateSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(LauncherProjectInfoProxy, TypeCopyMode::ReferenceType);
};

class DebugSettings : public Component
{
public:
  LightningDeclareType(DebugSettings, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ExportSettings, TypeCopyMode::ReferenceType);
