...
{
public:
  LightningDeclareType(CogPath, TypeCopyMode::ReferenceType);
...
{
  return (type*)QueryComponentId(LightningTypeId(type));
}

class CogPathEvent : public Event
{
public:
  LightningDeclareType(CogPathEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogPathMetaComposition, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CogPathMetaSerialization, TypeCopyMode::ReferenceType);
