...
{
public:
  LightningDeclareType(Action, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ActionSet, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Actions, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ActionGroup, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ActionSequence, TypeCopyMode::ReferenceType);
