...
{
public:
  LightningDeclareType(ObjectLinkEdge, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectLinkAnchor, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectLink, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectLinkEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ObjectLinkPointChangedEvent, TypeCopyMode::ReferenceType);
