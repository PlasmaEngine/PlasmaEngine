...
namespace Plasma
{
LightningDefineType(DataSource, builder, type)
{
}
...
LightningDefineType(DataEvent, builder, type)
{
}

LightningDefineType(DataReplaceEvent, builder, type)
{
}
...
void EnumSource::FillOutDescriptions()
{
  ...
  EnumDoc* enumDoc = PL::gDocumentation->mEnumAndFlagMap.FindValue(enumName, nullptr);
  if (enumDoc == nullptr)
  {
