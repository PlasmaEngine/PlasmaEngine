...
{
public:
  LightningDeclareType(Engine, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(EngineMetaComposition, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(InputDeviceEvent, TypeCopyMode::ReferenceType);
