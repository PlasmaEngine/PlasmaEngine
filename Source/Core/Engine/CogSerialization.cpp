...
void CogSerialization::LoadHierarchy(Serializer& serializer, CogCreationContext* context, Hierarchy* hierarchy)
{
  ...
  {
    Cog* cog = PL::gFactory->BuildFromStream(context, serializer);
    if (cog == nullptr)
      continue;
...
LightningDefineType(LinkId, builder, type)
{
}
...
LightningDefineType(Named, builder, type)
{
}
...
LightningDefineType(Archetyped, builder, type)
{
}
...
LightningDefineType(EditorFlags, builder, type)
{
}
...
LightningDefineType(ArchetypeInstance, builder, type)
{
}
...
LightningDefineType(SpaceObjects, builder, type)
{
}
...
CogCreationContext::CogCreationContext(Plasma::Space* space, StringParam source)
{
  mCurrentSubContextId = 0;
  mSubIdCounter = 0;
  Flags = 0;
