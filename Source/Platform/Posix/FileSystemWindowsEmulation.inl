...
#define PlasmaAllPermissions (0777)
...
DIR* opendir(const char* dirPath)
{
  ...
  Plasma::WString wpath = Plasma::Widen(dirPath);
...
dirent* readdir(DIR* dir)
{
  ...
  dir->mCurrent = Plasma::Narrow(dir->mFindData.cFileName);
...
{
  Plasma::String normalizedPath = Plasma::FilePath::Normalize(path);
  size_t copySize = Math::Min(normalizedPath.SizeInBytes(), (size_t)Plasma::File::MaxPath);
