...
{
public:
  LightningDeclareType(BaseSprite, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(Sprite, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SpriteText, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MultiSpriteEntry, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MultiSprite, TypeCopyMode::ReferenceType);
