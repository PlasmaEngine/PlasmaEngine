...
{
public:
  LightningDeclareType(ResourceListEvent, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(RenderGroupList, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ChildRenderGroupList, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(MaterialList, TypeCopyMode::ReferenceType);
