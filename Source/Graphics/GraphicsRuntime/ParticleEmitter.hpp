...
{
public:
  LightningDeclareType(ParticleEmitter, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ParticleEmitterShared, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(HideBaseFilter, TypeCopyMode::ReferenceType);
...
#define HideOnDerivedType(type) Add(new HideBaseFilter(LightningTypeId(type)))
