...
LightningDefineTemplateType(ProxyObject<MaterialBlock>, builder, type)
{
  type->AddAttribute(ObjectAttributes::cHidden);
}

LightningDefineType(MaterialBlock, builder, type)
{
...
IndexRange MaterialBlock::AddShaderInputs(Array<ShaderInput>& shaderInputs)
{
  ...
  BoundType* materialType = LightningVirtualTypeId(this);
