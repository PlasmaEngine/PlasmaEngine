...
{
public:
  LightningDeclareType(DefinitionSet, TypeCopyMode::ReferenceType);
...
public:
  ...
  {
    CreatorMap.Insert(LightningTypeId(definitionType)->Name, new DefinitionCreatorType<definitionType>);
  }
};
