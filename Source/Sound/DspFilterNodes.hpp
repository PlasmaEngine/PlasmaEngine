...
{
public:
  LightningDeclareType(VolumeNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PanningNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(PitchNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(LowPassNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<ListenerNode*, LowPassFilter*> FilterMapType;
...
{
public:
  LightningDeclareType(HighPassNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<ListenerNode*, HighPassFilter*> FilterMapType;
  FilterMapType FiltersPerListener;
};
...
{
public:
  LightningDeclareType(BandPassNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  // The filter used for calculations
  typedef Plasma::HashMap<ListenerNode*, BandPassFilter*> FilterMapType;
  FilterMapType FiltersPerListener;
};
...
{
public:
  LightningDeclareType(EqualizerNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<ListenerNode*, Equalizer*> FilterMapType;
  FilterMapType FiltersPerListener;
};
...
{
public:
  LightningDeclareType(ReverbNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  // The filter used for calculations
  typedef Plasma::HashMap<ListenerNode*, Reverb*> FilterMapType;
  FilterMapType FiltersPerListener;
};
...
{
public:
  LightningDeclareType(DelayNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  // The filter used for calculations
  typedef Plasma::HashMap<ListenerNode*, DelayLine*> FilterMapType;
  FilterMapType FiltersPerListener;
};
...
{
public:
  LightningDeclareType(FlangerNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<ListenerNode*, Data*> FilterMapType;
  FilterMapType FiltersPerListener;
...
{
public:
  LightningDeclareType(ChorusNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(CompressorNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ExpanderNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(AddNoiseNode, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(ModulationNode, TypeCopyMode::ReferenceType);
...
private:
  ...
  typedef Plasma::HashMap<ListenerNode*, Oscillator*> OscMapType;
