...
{
public:
  LightningDeclareType(SoundEntry, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(SoundEntryDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SoundTagEntry, TypeCopyMode::ReferenceType);
...
{
  LightningDeclareType(SoundTagEntryDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SoundCueDisplay, TypeCopyMode::ReferenceType);
...
{
public:
  LightningDeclareType(SoundCue, TypeCopyMode::ReferenceType);
