...
{
public:
  DecompressedDecoder(Plasma::Status& status,
                      const Plasma::String& fileName,
...
private:
  ...
  void OpenAndReadFile(Plasma::Status& status, const Plasma::String& fileName);
